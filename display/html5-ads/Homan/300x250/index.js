...
lib.ssMetadata = [
		{name:"index_atlas_P_1", frames: [[452,742,202,30],[0,0,600,500],[602,0,292,260],[0,502,240,240],[242,502,202,236],[602,262,242,260],[446,524,208,216],[656,524,208,216],[242,742,208,216]]},
		{name:"index_atlas_NP_1", frames: [[0,0,150,125]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.food1_300x250();
	this.instance.setTransform(0,0,0.5,0.5);
...
}).prototype = getMCSymbolPrototype(lib.food, new cjs.Rectangle(0,0,300,250), null);
...
(lib.dish3 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.instance = new lib.food4_300x250();
	this.instance.setTransform(0,0,0.5,0.5);
...
}).prototype = getMCSymbolPrototype(lib.dish3, new cjs.Rectangle(0,0,101,118), null);
...
(lib.copyright_1 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
}).prototype = getMCSymbolPrototype(lib.copyright_1, new cjs.Rectangle(0,0,101,15), null);
...
if (reversed == null) { reversed = false; }
	...
	this.logo.name = "logo";
	this.logo.setTransform(150,26.5,1,1,0,0,0,48,16.5);
	...
	this.copy1_1.setTransform(150,125,1,1,0,0,0,150,125);

	this.copy1_2 = new lib.copy12();
	this.copy1_2.name = "copy1_2";
	this.copy1_2.setTransform(150,125,1,1,0,0,0,150,125);

	this.note2 = new lib.copy13();
	this.note2.name = "note2";
	this.note2.setTransform(39.2,59.4,1,1,0,0,0,39.2,59.4);
	...
	this.copy3_1.setTransform(150,125,1,1,0,0,0,150,125);
	...
	this.dish4.setTransform(509.5,172,1,1,0,0,0,60.5,65);

	this.dish3 = new lib.dish3();
	this.dish3.name = "dish3";
	this.dish3.setTransform(492.5,164,1,1,0,0,0,50.5,59);

	this.dish2 = new lib.dish2();
	this.dish2.name = "dish2";
	this.dish2.setTransform(513,168,1,1,0,0,0,63,63);

	this.dish1 = new lib.dish1();
	this.dish1.name = "dish1";
	this.dish1.setTransform(450,125,1,1,0,0,0,150,125);

	this.food = new lib.food();
	this.food.name = "food";
	this.food.setTransform(205,167,1,1,0,0,0,205,167);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.food},{t:this.dish1},{t:this.dish2},{t:this.dish3},{t:this.dish4}]}).wait(1));

	// girl_over
	this.over = new lib.guy();
	this.over.name = "over";
	this.over.setTransform(70.95,147.45,0.55,0.55,0,0,0,67.2,77.2);
	...
	this.copy2_2.setTransform(136.8,137.8,1,1,0,0,0,136.8,137.8);

	this.copy2_1 = new lib.copy21();
	this.copy2_1.name = "copy2_1";
	this.copy2_1.setTransform(64.2,137.8,1,1,0,0,0,64.2,137.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.copy2_1},{t:this.copy2_2}]}).wait(1));

	// copyright
	this.copyr = new lib.copyright_1();
	this.copyr.name = "copyr";
	this.copyr.setTransform(100,228);

	this.timeline.addTween(cjs.Tween.get(this.copyr).wait(1));

	// bgr
	this.instance = new lib.bgr_300x250();
...
p.nominalBounds = new cjs.Rectangle(150,125,441,125);
// library properties:
lib.properties = {
