...
lib.ssMetadata = [
		...
		{name:"index_atlas_NP_1", frames: [[0,0,160,600]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(270.3219,84.0737);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	// titel
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#E00917").s().p("");
	this.shape_1.setTransform(271.3468,84.2737);
...
}).prototype = getMCSymbolPrototype(lib.dish1, new cjs.Rectangle(0,0,146,130), null);
...
if (reversed == null) { reversed = false; }
	...
	// titel
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(60.9286,34.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#E00917").s().p("");
	this.shape_1.setTransform(61.6111,35.25);
	...
	this.ns = new lib.emp();
	this.ns.name = "ns";
	this.ns.setTransform(113.65,37.55);

	this.note = new lib.note();
	this.note.name = "note";
	this.note.setTransform(133.75,12.55,1,1,0,0,0,271.1,85.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.note},{t:this.ns}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.copy31, new cjs.Rectangle(0,0,144.7,47.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		*/
		...
		function an() {
			...
			d += 0.5
			tl.from(self.logo, {duration: 1.0, scale: W == 160 ? 1.4 : 2.1, ease: "expo.inOut"}, d);
			var ly = self.logo.y;
			self.logo.y = H / 2;
			...
			var fsc = self.food.scale;
			tl.to(self.food, {duration: 0.3, scale: fsc * 1.11, ease: "quint"}, "bump+=0.0");
			tl.to(self.food, {duration: 0.3, scale: fsc * 1.0, ease: "back"}, "bump+=0.4");
			tl.to(self.food, {duration: 0.3, scale: fsc * 1.11, ease: "quint"},"bump+=1.0");
			tl.to(self.food, {duration: 0.3, scale: fsc * 1.0, ease: "back"}, "bump+=1.4");
			...
			if (H == 600) {
				...
				var spa = W == 160 ? 250 : W;
				tl.to(self.dish1, {duration: 1.2, x: d1_x - spa, ease: "expo"}, "dish1");
				tl.to(self.dish1, {duration: 0.7, x: d1_x - spa * 2, ease: "expo.in"}, tl.labels.dish1 + diff - 0.6);
			
				tl.to(self.dish2, {duration: 1.2, x: d2_x - spa, ease: "expo"}, "dish2");
				tl.to(self.dish2, {duration: 0.7, x: d2_x - spa * 2, ease: "expo.in"}, tl.labels.dish2 + diff - 0.6);
			
				tl.to(self.dish3, {duration: 1.2, x: d3_x - spa, ease: "expo"}, "dish3");
				tl.to(self.dish3, {duration: 0.7, x: d3_x - spa * 2, ease: "expo.in"}, tl.labels.dish3 + diff - 0.6);
			
				tl.to(self.dish4, {duration: 1.2, x: d4_x - spa, ease: "expo"}, "dish4");
			} else {
	...
	this.logo.name = "logo";
	this.logo.setTransform(80.1,28.45,0.8125,0.8109,0,0,0,48.1,16.6);
	...
	this.copy1_1.setTransform(84.05,389.35,0.587,0.587,0,0,0,150,125);

	this.copy1_2 = new lib.copy12();
	this.copy1_2.name = "copy1_2";
	this.copy1_2.setTransform(84.05,389.35,0.587,0.587,0,0,0,150,125);

	this.note2 = new lib.copy13();
	this.note2.name = "note2";
	this.note2.setTransform(19,350.85,0.587,0.587,0,0,0,39.2,59.4);
	...
	this.copy3_1.setTransform(94,449.7,0.7052,0.7043,0,0,0,72.3,23.7);
	...
	this.over.name = "over";
	this.over.setTransform(57,418,0.4906,0.4909,0,0,0,67.3,77.4);
	...
	this.copy2_2.setTransform(115.05,408.95,0.885,0.885,0,0,0,136.8,137.8);

	this.copy2_1 = new lib.copy21();
	this.copy2_1.name = "copy2_1";
	this.copy2_1.setTransform(50.8,408.95,0.885,0.885,0,0,0,64.2,137.8);
	...
	this.dish2.setTransform(339.25,208,2.3333,2.3333,0,0,0,63.1,63);

	this.food = new lib.food();
	this.food.name = "food";
	this.food.setTransform(82,510.8,0.5872,0.5869,0,0,0,126,90);

	this.dish3 = new lib.dish3_1();
	this.dish3.name = "dish3";
	this.dish3.setTransform(321.8,196.3,2.5006,2.4877,-4.2229,0,0,50.5,59.1);

	this.dish1 = new lib.dish1();
	this.dish1.name = "dish1";
	this.dish1.setTransform(322.6,195.65,1.7802,1.7847,-29.9843,0,0,73,65.1);

	this.dish4 = new lib.dish4();
	this.dish4.name = "dish4";
	this.dish4.setTransform(322.7,200.7,2.2226,2.2335,88.788,0,0,60.6,65);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.dish4},{t:this.dish1},{t:this.dish3},{t:this.food},{t:this.dish2}]}).wait(1));

	// copyright
	this.copyr = new lib.copyright();
	this.copyr.name = "copyr";
	this.copyr.setTransform(37,570,0.6923,0.7);

	this.timeline.addTween(cjs.Tween.get(this.copyr).wait(1));

	// bgr
	this.instance = new lib.bgr_160x600();
...
p.nominalBounds = new cjs.Rectangle(81,300,412,300);
// library properties:
lib.properties = {
