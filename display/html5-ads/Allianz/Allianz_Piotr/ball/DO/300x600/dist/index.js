...
if (reversed == null) { reversed = false; }
	...
	this.instance_7.setTransform(0,0,4.64,4.64);
...
if (reversed == null) { reversed = false; }
	...
	this.logoWhite.setTransform(-26.8,196.25,0.9994,1,0,0,0,1.4,0.9);
...
p.nominalBounds = new cjs.Rectangle(-28.2,0,150.4,218);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		*/
		function animateInFrame1(){
			...
			gsap.set(self.crowbarMC,{scale:0.35});
			var d = 0.1;
	...
	this.copyDo.setTransform(157.65,83.95,1,1,0,0,0,0,19.1);
	...
	this.ctaDo.setTransform(74.7,488.35,0.9525,0.9531,0,0,0,50.1,16.1);

	this.cta = new lib.ctanew();
	this.cta.name = "cta";
	this.cta.setTransform(-74.45,488.2,1,1,0,0,0,58.1,15.2);
	...
	this.promo.setTransform(29.9,421.3,1,1,0,0,0,-59,58.6);
	...
	this.crowbarMC.setTransform(139.75,327.85,0.225,0.225,0,0,0,903,540.8);
...
p.nominalBounds = new cjs.Rectangle(-22.9,300,749.6,300);
// library properties:
lib.properties = {
