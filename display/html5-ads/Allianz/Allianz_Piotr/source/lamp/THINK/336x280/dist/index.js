...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgqA6IAHgTQAGAEAIADQAJACAHAAQAPAAAJgIQAHgHABgPIAAgFQgMAPgSAAQgMAAgKgGQgLgGgFgLQgGgKAAgOQAAgOAGgKQAFgLALgGQAKgGAMAAQATAAAMAQIAAgOIAUAAIAABUQgBAWgNANQgNAMgYAAQgVAAgSgJgAgSgnQgIAIAAAMQAAANAIAHQAHAIAMAAQALAAAIgIQAGgGABgOQgBgNgGgHQgIgIgLAAQgMAAgHAIg");
	this.shape.setTransform(6.05,12.625);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AAWAxIAAgzQAAgNgFgHQgGgGgKAAQgKAAgGAGQgGAHAAAMIAAA0IgVAAIAAhfIATAAIAAAPQAFgIAIgFQAIgEAJAAQARAAAJALQAKALAAAUIAAA3g");
	this.shape_1.setTransform(-4.85,10.775);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgJBGIAAheIAUAAIAABegAgIgvQgFgDAAgGQAAgGAFgEQADgDAFAAQAGAAAEADQADAEAAAGQAAAGgDADQgEAEgGAAQgFAAgDgEg");
	this.shape_2.setTransform(-12.85,8.65);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgbAxIAAhfIATAAIAAAQQAIgRAQgBQAHABAFACIgDAVQgFgCgFgBQgKABgFAGQgGAIAAANIAAAwg");
	this.shape_3.setTransform(-18.275,10.8);
	...
	this.shape_9.setTransform(-75.475,10.875);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgKAwIgmhfIAWAAIAaBHIAbhHIAWAAIgnBfg");
	this.shape_10.setTransform(-85.7,10.875);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#FFFFFF").s().p("AgYAsQgLgHgGgLQgGgLAAgPQAAgOAGgLQAGgLALgHQALgGANAAQAOAAALAGQALAHAGALQAGALAAAOQAAAPgGALQgGALgLAHQgLAGgOAAQgNAAgLgGgAgTgVQgIAJAAAMQAAANAIAJQAIAIALAAQAMAAAIgIQAHgJAAgNQAAgMgHgJQgIgIgMAAQgLAAgIAIg");
	this.shape_11.setTransform(-96.225,10.875);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#FFFFFF").s().p("AgJA2QgHgIAAgOIAAguIgNAAIAAgUIANAAIAAgXIATgEIAAAbIAaAAIAAAUIgaAAIAAArQAAAOANAAQAGAAAFgCIADASQgIADgKAAQgNAAgIgIg");
	this.shape_12.setTransform(-105.125,9.575);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#FFFFFF").s().p("AggAmQgKgLAAgUIAAg3IAVAAIAAAzQAAANAFAHQAGAGAKAAQAKAAAGgHQAGgGABgMIAAg0IAUAAIAABfIgTAAIAAgPQgFAJgIAEQgIAEgJAAQgRAAgJgLg");
	this.shape_13.setTransform(-114.05,10.975);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#FFFFFF").s().p("AgZArQgKgGgGgLQgFgLgBgPQABgOAFgLQAGgLAKgHQAJgGANAAQATAAAMARIAAgPIAUAAIAABfIgUAAIAAgPQgMARgTAAQgNAAgJgHgAgTgVQgHAJAAAMQAAAOAHAIQAJAIALAAQALAAAIgIQAGgIAAgOQAAgNgGgIQgIgIgLAAQgLAAgJAIg");
	this.shape_14.setTransform(-125.55,10.875);
...
if (reversed == null) { reversed = false; }
	...
	this.lamp.name = "lamp";
	this.lamp.setTransform(175.4,180.8,0.4294,0.4299,0,0,0,0.2,0.4);
	...
	this.crowbar.setTransform(153.2,126.1,0.1079,0.1081,0,0,0,546.5,529.2);
	...
	this.ctaDo.setTransform(-166.05,473,0.7185,0.7188);
	...
	this.cta.name = "cta";
	this.cta.setTransform(61.8,213.45,0.7538,0.7541,0,0,0,58.1,15.2);
...
}).prototype = getMCSymbolPrototype(lib.master_mc, new cjs.Rectangle(-177.9,-199.6,546.6,799.6), null);
...
p.nominalBounds = new cjs.Rectangle(-31.2,-83.6,444.2,639.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"./Bitmap16.png?1610613779041", id:"Bitmap16"},
		{src:"./crowbar.png?1610613779041", id:"crowbar"},
		{src:"./lamppost.png?1610613779041", id:"lamppost"},
		{src:"./lightglass.png?1610613779041", id:"lightglass"},
		{src:"./shadow2.jpg?1610613779041", id:"shadow2"},
		{src:"./tiretrack.png?1610613779041", id:"tiretrack"}
	],
	preloads: []
};
