...
p.nominalBounds = new cjs.Rectangle(0,0,235,140);// helper functions:
...
p.nominalBounds = new cjs.Rectangle(-77,-105.5,235,140);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.logoWhite).wait(41).to({regY:0.8,scaleX:1.0001,scaleY:1,x:-26.8,y:196.25},0).wait(65));
...
if (reversed == null) { reversed = false; }
	...
	this.whiteLogo.setTransform(40,120);
	...
	this.plugMC.setTransform(200.2,187,0.4949,0.4926,0,0,0,-43.6,-29.8);
	...
	this.crowbar.setTransform(110,152.55,0.1046,0.1046,0,0,0,902.4,540.7);
	...
	this.cta.name = "cta";
	this.cta.setTransform(63.8,213.55,0.7538,0.7541,0,0,0,58.1,15.3);
...
p.nominalBounds = new cjs.Rectangle(-33.4,27,354,573);
// library properties:
lib.properties = {
