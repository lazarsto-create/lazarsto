...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#F86200").beginStroke().moveTo(-540,540).lineTo(-540,-540).lineTo(540,-540).lineTo(540,540).closePath();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#F86200").beginStroke().moveTo(-1.7,3.5).curveTo(-2.6,3,-3.1,2.1).curveTo(-3.6,1.2,-3.6,0).curveTo(-3.6,-1.2,-3.2,-2.1).curveTo(-2.7,-3,-1.9,-3.5).curveTo(-1.1,-4,0,-4).curveTo(1.1,-4,1.9,-3.5).curveTo(2.7,-3.1,3.2,-2.1).curveTo(3.6,-1.3,3.6,-0.2).lineTo(3.6,0.5).lineTo(-1.9,0.5).curveTo(-1.8,1.4,-1.2,2).curveTo(-0.5,2.4,0.5,2.4).curveTo(1.1,2.4,1.8,2.3).lineTo(2.9,1.7).lineTo(3.4,3.2).curveTo(2.8,3.5,2,3.8).curveTo(1.3,4,0.4,4).curveTo(-0.8,4,-1.7,3.5).closePath().moveTo(2,-0.8).curveTo(1.9,-1.6,1.4,-2.1).curveTo(0.8,-2.5,0,-2.5).curveTo(-0.8,-2.6,-1.3,-2.1).curveTo(-1.8,-1.6,-1.9,-0.8).lineTo(2,-0.8).lineTo(2,-0.8).closePath();
	this.shape.setTransform(108.175,13.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#F86200").beginStroke().moveTo(-0.8,5.6).lineTo(-0.8,-2.1).lineTo(0.8,-2.1).lineTo(0.8,5.6).closePath().moveTo(-0.8,-3.8).curveTo(-1.1,-4.1,-1.1,-4.6).curveTo(-1.1,-5.1,-0.8,-5.4).curveTo(-0.5,-5.6,-0,-5.6).curveTo(0.5,-5.6,0.8,-5.3).curveTo(1.1,-5,1.1,-4.6).curveTo(1.1,-4.2,0.8,-3.9).curveTo(0.5,-3.6,-0,-3.6).curveTo(-0.5,-3.6,-0.8,-3.8).closePath();
	this.shape_1.setTransform(102.125,11.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#F86200").beginStroke().moveTo(4,3.9).lineTo(4,-0.3).curveTo(4,-2.4,2.4,-2.3).curveTo(1.6,-2.3,1.2,-1.9).curveTo(0.8,-1.3,0.8,-0.5).lineTo(0.8,3.9).lineTo(-0.8,3.9).lineTo(-0.8,-0.3).curveTo(-0.8,-1.3,-1.3,-1.9).curveTo(-1.6,-2.3,-2.4,-2.3).curveTo(-3.1,-2.3,-3.5,-1.9).curveTo(-4,-1.3,-4,-0.5).lineTo(-4,3.9).lineTo(-5.6,3.9).lineTo(-5.6,-3.8).lineTo(-4.1,-3.8).lineTo(-4.1,-2.7).curveTo(-3.7,-3.3,-3.2,-3.6).curveTo(-2.5,-3.9,-1.8,-3.9).curveTo(-1.1,-3.9,-0.5,-3.6).curveTo(0.1,-3.2,0.4,-2.6).curveTo(0.7,-3.2,1.4,-3.6).curveTo(2,-3.9,2.9,-3.9).curveTo(4.1,-3.9,4.8,-3).curveTo(5.6,-2.2,5.6,-0.7).lineTo(5.6,3.9).closePath();
	this.shape_2.setTransform(93.7,13.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#F86200").beginStroke().moveTo(-1.7,3.5).curveTo(-2.6,3,-3.1,2.1).curveTo(-3.6,1.2,-3.6,0).curveTo(-3.6,-1.2,-3.2,-2.1).curveTo(-2.7,-3,-1.9,-3.5).curveTo(-1.1,-4,0,-4).curveTo(1.1,-4,1.9,-3.5).curveTo(2.7,-3.1,3.2,-2.1).curveTo(3.6,-1.3,3.6,-0.2).lineTo(3.6,0.5).lineTo(-1.9,0.5).curveTo(-1.8,1.4,-1.2,2).curveTo(-0.5,2.4,0.5,2.4).curveTo(1.1,2.4,1.8,2.3).lineTo(2.9,1.7).lineTo(3.4,3.2).curveTo(2.8,3.5,2,3.8).curveTo(1.3,4,0.4,4).curveTo(-0.8,4,-1.7,3.5).closePath().moveTo(2,-0.8).curveTo(1.9,-1.6,1.4,-2.1).curveTo(0.8,-2.5,0,-2.5).curveTo(-0.8,-2.6,-1.3,-2.1).curveTo(-1.8,-1.6,-1.9,-0.8).lineTo(2,-0.8).lineTo(2,-0.8).closePath();
	this.shape_3.setTransform(82.825,13.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#F86200").beginStroke().moveTo(-2.3,3.9).lineTo(-2.3,-3.8).lineTo(-0.7,-3.8).lineTo(-0.7,-2.4).curveTo(-0.1,-3.9,1.3,-3.9).curveTo(1.8,-3.9,2.2,-3.7).lineTo(2,-2.1).curveTo(1.6,-2.2,1.2,-2.2).curveTo(0.3,-2.2,-0.1,-1.6).curveTo(-0.6,-1.1,-0.6,0).lineTo(-0.6,3.9).closePath();
	this.shape_4.setTransform(76.25,13.325);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#F86200").beginStroke().moveTo(-3.8,5.3).lineTo(-3.8,-5.2).lineTo(-2.3,-5.2).lineTo(-2.3,-4).curveTo(-1.3,-5.3,0.3,-5.3).curveTo(1.3,-5.3,2.1,-4.8).curveTo(2.9,-4.3,3.3,-3.4).curveTo(3.8,-2.5,3.8,-1.3).curveTo(3.8,-0.1,3.3,0.8).curveTo(2.9,1.6,2.1,2.1).curveTo(1.3,2.7,0.3,2.7).curveTo(-1.2,2.7,-2.2,1.5).lineTo(-2.2,5.3).closePath().moveTo(-1.6,-3.1).curveTo(-2.2,-2.5,-2.2,-1.3).curveTo(-2.2,-0.2,-1.6,0.4).curveTo(-1,1.1,-0,1.1).curveTo(0.9,1.1,1.5,0.4).curveTo(2.1,-0.3,2.1,-1.3).curveTo(2.1,-2.4,1.5,-3.1).curveTo(0.9,-3.7,-0,-3.7).curveTo(-1,-3.8,-1.6,-3.1).closePath();
	this.shape_5.setTransform(68.6,14.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#F86200").beginStroke().moveTo(1.8,3.9).lineTo(1.8,-0.2).curveTo(1.8,-1.3,1.3,-1.8).curveTo(0.9,-2.4,0.1,-2.3).curveTo(-0.8,-2.4,-1.3,-1.8).curveTo(-1.8,-1.2,-1.8,-0.3).lineTo(-1.8,3.9).lineTo(-3.4,3.9).lineTo(-3.4,-3.8).lineTo(-1.9,-3.8).lineTo(-1.9,-2.6).curveTo(-1.5,-3.2,-0.9,-3.6).curveTo(-0.3,-3.9,0.5,-3.9).curveTo(1.9,-3.9,2.7,-3).curveTo(3.4,-2.2,3.4,-0.5).lineTo(3.4,3.9).closePath();
	this.shape_6.setTransform(55.825,13.3);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#F86200").beginStroke().moveTo(-1.7,3.5).curveTo(-2.6,3,-3.1,2.1).curveTo(-3.6,1.2,-3.6,0).curveTo(-3.6,-1.2,-3.2,-2.1).curveTo(-2.7,-3,-1.9,-3.5).curveTo(-1.1,-4,0,-4).curveTo(1.1,-4,1.9,-3.5).curveTo(2.7,-3.1,3.2,-2.1).curveTo(3.6,-1.3,3.6,-0.2).lineTo(3.6,0.5).lineTo(-1.9,0.5).curveTo(-1.8,1.4,-1.2,2).curveTo(-0.5,2.4,0.5,2.4).curveTo(1.1,2.4,1.8,2.3).lineTo(2.9,1.7).lineTo(3.4,3.2).curveTo(2.8,3.5,2,3.8).curveTo(1.3,4,0.4,4).curveTo(-0.8,4,-1.7,3.5).closePath().moveTo(2,-0.8).curveTo(1.9,-1.6,1.4,-2.1).curveTo(0.8,-2.5,0,-2.5).curveTo(-0.8,-2.6,-1.3,-2.1).curveTo(-1.8,-1.6,-1.9,-0.8).lineTo(2,-0.8).lineTo(2,-0.8).closePath();
	this.shape_7.setTransform(47.125,13.4);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#F86200").beginStroke().moveTo(1.5,5.6).lineTo(-1.1,2.6).lineTo(-1.9,3.4).lineTo(-1.9,5.6).lineTo(-3.6,5.6).lineTo(-3.6,-5.6).lineTo(-1.9,-5.6).lineTo(-1.9,1.3).lineTo(1.3,-2).lineTo(3.4,-2).lineTo(0,1.4).lineTo(3.6,5.6).closePath();
	this.shape_8.setTransform(39.325,11.575);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#F86200").beginStroke().moveTo(-1.7,3.5).curveTo(-2.6,3,-3.1,2.1).curveTo(-3.6,1.2,-3.6,0).curveTo(-3.6,-1.2,-3.2,-2.1).curveTo(-2.7,-3,-1.9,-3.5).curveTo(-1.1,-4,0,-4).curveTo(1.1,-4,1.9,-3.5).curveTo(2.7,-3.1,3.2,-2.1).curveTo(3.6,-1.3,3.6,-0.2).lineTo(3.6,0.5).lineTo(-1.9,0.5).curveTo(-1.8,1.4,-1.2,2).curveTo(-0.5,2.4,0.5,2.4).curveTo(1.1,2.4,1.8,2.3).lineTo(2.9,1.7).lineTo(3.4,3.2).curveTo(2.8,3.5,2,3.8).curveTo(1.3,4,0.4,4).curveTo(-0.8,4,-1.7,3.5).closePath().moveTo(2,-0.8).curveTo(1.9,-1.6,1.4,-2.1).curveTo(0.8,-2.5,0,-2.5).curveTo(-0.8,-2.6,-1.3,-2.1).curveTo(-1.8,-1.6,-1.9,-0.8).lineTo(2,-0.8).lineTo(2,-0.8).closePath();
	this.shape_9.setTransform(30.475,13.4);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#F86200").beginStroke().moveTo(-2.2,3.9).lineTo(-2.2,-3.8).lineTo(-0.7,-3.8).lineTo(-0.7,-2.4).curveTo(-0.1,-3.9,1.3,-3.9).curveTo(1.8,-3.9,2.3,-3.7).lineTo(2,-2.1).curveTo(1.7,-2.2,1.2,-2.2).curveTo(0.4,-2.2,-0.1,-1.6).curveTo(-0.6,-1.1,-0.6,0).lineTo(-0.6,3.9).closePath();
	this.shape_10.setTransform(23.9,13.325);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("#F86200").beginStroke().moveTo(-1.7,3.5).curveTo(-2.6,3,-3.1,2.1).curveTo(-3.6,1.2,-3.6,0).curveTo(-3.6,-1.2,-3.2,-2.1).curveTo(-2.7,-3,-1.9,-3.5).curveTo(-1.1,-4,0,-4).curveTo(1.1,-4,1.9,-3.5).curveTo(2.7,-3.1,3.2,-2.1).curveTo(3.6,-1.3,3.6,-0.2).lineTo(3.6,0.5).lineTo(-1.9,0.5).curveTo(-1.8,1.4,-1.2,2).curveTo(-0.5,2.4,0.5,2.4).curveTo(1.1,2.4,1.8,2.3).lineTo(2.9,1.7).lineTo(3.4,3.2).curveTo(2.8,3.5,2,3.8).curveTo(1.3,4,0.4,4).curveTo(-0.8,4,-1.7,3.5).closePath().moveTo(2,-0.8).curveTo(1.9,-1.6,1.4,-2.1).curveTo(0.8,-2.5,0,-2.5).curveTo(-0.8,-2.6,-1.3,-2.1).curveTo(-1.8,-1.6,-1.9,-0.8).lineTo(2,-0.8).lineTo(2,-0.8).closePath();
	this.shape_11.setTransform(16.375,13.4);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#F86200").beginStroke().moveTo(-4.1,5.3).lineTo(-4.1,-5.3).lineTo(0.1,-5.3).curveTo(1.2,-5.3,2.1,-5).curveTo(2.9,-4.6,3.3,-4).curveTo(3.7,-3.3,3.7,-2.5).curveTo(3.7,-1.8,3.4,-1.2).curveTo(3,-0.6,2.4,-0.2).curveTo(3.3,0.1,3.7,0.8).curveTo(4.1,1.5,4.2,2.3).curveTo(4.2,3.2,3.7,3.9).curveTo(3.3,4.6,2.4,5).curveTo(1.6,5.3,0.5,5.3).closePath().moveTo(-2.4,3.7).lineTo(0.5,3.7).curveTo(1.4,3.7,1.9,3.3).curveTo(2.3,2.8,2.4,2.2).curveTo(2.3,1.5,1.9,1.1).curveTo(1.4,0.7,0.5,0.7).lineTo(-2.4,0.7).closePath().moveTo(-2.4,-0.9).lineTo(0.1,-0.9).curveTo(1,-0.9,1.5,-1.3).curveTo(1.9,-1.7,1.9,-2.3).curveTo(1.9,-2.9,1.5,-3.3).curveTo(1,-3.7,0.1,-3.7).lineTo(-2.4,-3.7).closePath();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FDD25C").beginStroke().moveTo(-4,9.7).curveTo(-5.5,8.8,-6.3,7.1).curveTo(-7.1,5.4,-7.1,3.2).curveTo(-7.1,1,-6.3,-0.7).curveTo(-5.5,-2.4,-4,-3.3).curveTo(-2.5,-4.3,-0.6,-4.3).curveTo(2.2,-4.3,4,-2).lineTo(4,-10.7).lineTo(7.1,-10.7).lineTo(7.1,10.4).lineTo(4.2,10.4).lineTo(4.2,8.2).curveTo(2.4,10.7,-0.6,10.7).curveTo(-2.5,10.7,-4,9.7).closePath().moveTo(-2.9,-0.1).curveTo(-4,1.2,-4,3.2).curveTo(-4,5.2,-2.9,6.5).curveTo(-1.8,7.7,0.1,7.7).curveTo(1.9,7.7,2.9,6.5).curveTo(4,5.3,4,3.2).curveTo(4,1.1,2.9,-0.1).curveTo(1.9,-1.3,0.1,-1.3).curveTo(-1.8,-1.3,-2.9,-0.1).closePath();
	this.shape.setTransform(-9.475,-0.475);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FDD25C").beginStroke().moveTo(-4.2,7.3).lineTo(-4.2,-7.1).lineTo(-1.3,-7.1).lineTo(-1.3,-4.6).curveTo(-0.2,-7.3,2.4,-7.3).curveTo(3.4,-7.3,4.2,-6.9).lineTo(3.8,-3.9).curveTo(3.1,-4.1,2.3,-4.1).curveTo(0.7,-4.1,-0.2,-3.1).curveTo(-1.1,-2,-1.1,0.1).lineTo(-1.1,7.3).closePath();
	this.shape_1.setTransform(-22.175,2.625);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#FDD25C").beginStroke().moveTo(-3.2,6.6).curveTo(-4.9,5.7,-5.8,4).curveTo(-6.8,2.3,-6.8,0).curveTo(-6.8,-2.2,-5.9,-3.9).curveTo(-5.1,-5.6,-3.5,-6.5).curveTo(-2,-7.5,0,-7.5).curveTo(2,-7.5,3.5,-6.6).curveTo(5.1,-5.7,5.9,-4).curveTo(6.8,-2.4,6.8,-0.3).lineTo(6.7,1).lineTo(-3.7,1).curveTo(-3.4,2.7,-2.2,3.7).curveTo(-1,4.6,0.9,4.6).curveTo(2.1,4.6,3.3,4.3).curveTo(4.5,3.9,5.4,3.3).lineTo(6.3,5.9).curveTo(5.3,6.7,3.8,7.1).curveTo(2.4,7.5,0.8,7.5).curveTo(-1.4,7.5,-3.2,6.6).closePath().moveTo(3.7,-1.5).curveTo(3.5,-3,2.6,-3.8).curveTo(1.6,-4.8,0.1,-4.7).curveTo(-1.4,-4.7,-2.4,-3.9).curveTo(-3.4,-3,-3.6,-1.5).lineTo(3.7,-1.5).lineTo(3.7,-1.5).closePath();
	this.shape_2.setTransform(-36.325,2.75);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FDD25C").beginStroke().moveTo(2.7,10.5).lineTo(-2.1,4.8).lineTo(-3.6,6.4).lineTo(-3.6,10.5).lineTo(-6.7,10.5).lineTo(-6.7,-10.5).lineTo(-3.6,-10.5).lineTo(-3.6,2.5).lineTo(2.4,-3.8).lineTo(6.3,-3.8).lineTo(0,2.6).lineTo(6.7,10.5).closePath();
	this.shape_3.setTransform(-50.975,-0.625);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#FDD25C").beginStroke().moveTo(-3.2,6.6).curveTo(-4.9,5.7,-5.8,4).curveTo(-6.8,2.3,-6.8,0).curveTo(-6.8,-2.2,-5.9,-3.9).curveTo(-5.1,-5.6,-3.5,-6.5).curveTo(-2,-7.5,0,-7.5).curveTo(2,-7.5,3.5,-6.6).curveTo(5.1,-5.7,5.9,-4).curveTo(6.8,-2.4,6.8,-0.3).lineTo(6.7,1).lineTo(-3.7,1).curveTo(-3.4,2.7,-2.2,3.7).curveTo(-1,4.6,0.9,4.6).curveTo(2.1,4.6,3.3,4.3).curveTo(4.5,3.9,5.4,3.3).lineTo(6.3,5.9).curveTo(5.3,6.7,3.8,7.1).curveTo(2.4,7.5,0.8,7.5).curveTo(-1.4,7.5,-3.2,6.6).closePath().moveTo(3.7,-1.5).curveTo(3.5,-3,2.6,-3.8).curveTo(1.6,-4.8,0.1,-4.7).curveTo(-1.4,-4.7,-2.4,-3.9).curveTo(-3.4,-3,-3.6,-1.5).lineTo(3.7,-1.5).lineTo(3.7,-1.5).closePath();
	this.shape_4.setTransform(-67.625,2.75);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FDD25C").beginStroke().moveTo(-5.9,7.2).lineTo(-5.9,4.7).lineTo(1.3,-4.3).lineTo(-5.6,-4.3).lineTo(-5.6,-7.2).lineTo(5.6,-7.2).lineTo(5.6,-4.7).lineTo(-1.6,4.3).lineTo(5.9,4.3).lineTo(5.9,7.2).closePath();
	this.shape_5.setTransform(-82.425,2.725);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#FDD25C").beginStroke().moveTo(-4.2,7.3).lineTo(-4.2,-7.1).lineTo(-1.3,-7.1).lineTo(-1.3,-4.6).curveTo(-0.2,-7.3,2.4,-7.3).curveTo(3.4,-7.3,4.2,-6.9).lineTo(3.8,-3.9).curveTo(3.1,-4.1,2.3,-4.1).curveTo(0.7,-4.1,-0.2,-3.1).curveTo(-1.1,-2,-1.1,0.1).lineTo(-1.1,7.3).closePath();
	this.shape_6.setTransform(-93.925,2.625);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#FDD25C").beginStroke().moveTo(-3.2,6.6).curveTo(-4.9,5.7,-5.8,4).curveTo(-6.8,2.3,-6.8,0).curveTo(-6.8,-2.2,-5.9,-3.9).curveTo(-5.1,-5.6,-3.5,-6.5).curveTo(-2,-7.5,0,-7.5).curveTo(2,-7.5,3.5,-6.6).curveTo(5.1,-5.7,5.9,-4).curveTo(6.8,-2.4,6.8,-0.3).lineTo(6.7,1).lineTo(-3.7,1).curveTo(-3.4,2.7,-2.2,3.7).curveTo(-1,4.6,0.9,4.6).curveTo(2.1,4.6,3.3,4.3).curveTo(4.5,3.9,5.4,3.3).lineTo(6.3,5.9).curveTo(5.3,6.7,3.8,7.1).curveTo(2.4,7.5,0.8,7.5).curveTo(-1.4,7.5,-3.2,6.6).closePath().moveTo(3.7,-1.5).curveTo(3.5,-3,2.6,-3.8).curveTo(1.6,-4.8,0.1,-4.7).curveTo(-1.4,-4.7,-2.4,-3.9).curveTo(-3.4,-3,-3.6,-1.5).lineTo(3.7,-1.5).lineTo(3.7,-1.5).closePath();
	this.shape_7.setTransform(-108.075,2.75);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#FDD25C").beginStroke().moveTo(-1.6,7.2).lineTo(-7.4,-7.2).lineTo(-4,-7.2).lineTo(-0,3.6).lineTo(4,-7.2).lineTo(7.4,-7.2).lineTo(1.6,7.2).closePath();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.3,7.3).lineTo(3.3,-0.4).curveTo(3.3,-2.4,2.5,-3.4).curveTo(1.6,-4.4,0.1,-4.4).curveTo(-1.5,-4.4,-2.4,-3.4).curveTo(-3.3,-2.4,-3.3,-0.5).lineTo(-3.3,7.3).lineTo(-6.5,7.3).lineTo(-6.5,-7).lineTo(-3.5,-7).lineTo(-3.5,-4.8).curveTo(-2.9,-6,-1.6,-6.7).curveTo(-0.5,-7.3,1,-7.3).curveTo(3.5,-7.3,5,-5.7).curveTo(6.5,-4,6.5,-1).lineTo(6.5,7.3).closePath();
	this.shape.setTransform(46.35,-27.675);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.2,6.6).curveTo(-4.9,5.7,-5.8,4).curveTo(-6.8,2.3,-6.8,-0).curveTo(-6.8,-2.2,-5.9,-3.9).curveTo(-5.1,-5.6,-3.5,-6.5).curveTo(-2,-7.5,0,-7.5).curveTo(2,-7.5,3.5,-6.6).curveTo(5.1,-5.6,5.9,-4.1).curveTo(6.8,-2.4,6.8,-0.3).lineTo(6.7,1).lineTo(-3.7,1).curveTo(-3.4,2.7,-2.2,3.7).curveTo(-1,4.6,0.9,4.6).curveTo(2.1,4.6,3.3,4.3).curveTo(4.5,3.9,5.4,3.3).lineTo(6.3,5.9).curveTo(5.3,6.7,3.8,7.1).curveTo(2.4,7.5,0.8,7.5).curveTo(-1.4,7.5,-3.2,6.6).closePath().moveTo(3.7,-1.5).curveTo(3.5,-3,2.6,-3.8).curveTo(1.6,-4.7,0.1,-4.7).curveTo(-1.4,-4.8,-2.4,-3.9).curveTo(-3.4,-3,-3.6,-1.5).lineTo(3.7,-1.5).lineTo(3.7,-1.5).closePath();
	this.shape_1.setTransform(29.975,-27.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.3,8.7).lineTo(-5.5,6).curveTo(-4.5,6.6,-3.3,6.9).curveTo(-2.1,7.2,-0.8,7.2).curveTo(1.6,7.2,2.8,6.1).curveTo(4,5,4,2.7).lineTo(4,2.1).curveTo(2.2,4.3,-0.6,4.3).curveTo(-2.5,4.3,-4,3.4).curveTo(-5.5,2.5,-6.3,0.8).curveTo(-7.1,-0.8,-7.1,-2.9).curveTo(-7.1,-5,-6.3,-6.6).curveTo(-5.5,-8.2,-4,-9.2).curveTo(-2.5,-10.1,-0.6,-10.1).curveTo(2.4,-10.1,4.2,-7.6).lineTo(4.2,-9.8).lineTo(7.1,-9.8).lineTo(7.1,3).curveTo(7.1,6.4,5.1,8.2).curveTo(3.1,10.1,-0.6,10.1).curveTo(-3.7,10.1,-6.3,8.7).closePath().moveTo(-2.9,-6).curveTo(-4,-4.8,-4,-2.9).curveTo(-4,-1,-2.9,0.2).curveTo(-1.8,1.4,0.1,1.4).curveTo(1.9,1.4,2.9,0.2).curveTo(4,-0.9,4,-2.9).curveTo(4,-4.9,2.9,-6).curveTo(1.9,-7.2,0.1,-7.2).curveTo(-1.8,-7.2,-2.9,-6).closePath();
	this.shape_2.setTransform(6.375,-24.925);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.6,10.5).lineTo(-1.6,-3.8).lineTo(1.6,-3.8).lineTo(1.6,10.5).closePath().moveTo(-1.5,-7.1).curveTo(-2,-7.7,-2,-8.6).curveTo(-2,-9.4,-1.5,-10).curveTo(-0.9,-10.5,0,-10.5).curveTo(0.8,-10.5,1.5,-10).curveTo(2,-9.4,2,-8.6).curveTo(2,-7.7,1.5,-7.2).curveTo(0.8,-6.6,0,-6.6).curveTo(-0.9,-6.6,-1.5,-7.1).closePath();
	this.shape_3.setTransform(-5.35,-30.875);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2.1,9.6).curveTo(-2.9,8.7,-2.9,6.7).lineTo(-2.9,-10.6).lineTo(0.2,-10.6).lineTo(0.2,6.1).curveTo(0.2,6.9,0.5,7.3).curveTo(0.9,7.8,1.6,7.8).curveTo(2.2,7.8,2.6,7.6).lineTo(2.9,10.3).curveTo(2.1,10.6,0.7,10.6).curveTo(-1.2,10.6,-2.1,9.6).closePath();
	this.shape_4.setTransform(-12.125,-30.8);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.6,10.5).lineTo(-1.6,-3.8).lineTo(1.6,-3.8).lineTo(1.6,10.5).closePath().moveTo(-1.5,-7.1).curveTo(-2,-7.7,-2,-8.6).curveTo(-2,-9.4,-1.5,-10).curveTo(-0.9,-10.5,0,-10.5).curveTo(0.8,-10.5,1.5,-10).curveTo(2,-9.4,2,-8.6).curveTo(2,-7.7,1.5,-7.2).curveTo(0.8,-6.6,0,-6.6).curveTo(-0.9,-6.6,-1.5,-7.1).closePath();
	this.shape_5.setTransform(-20.65,-30.875);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.2,6.6).curveTo(-4.9,5.7,-5.8,4).curveTo(-6.8,2.3,-6.8,-0).curveTo(-6.8,-2.2,-5.9,-3.9).curveTo(-5.1,-5.6,-3.5,-6.5).curveTo(-2,-7.5,0,-7.5).curveTo(2,-7.5,3.5,-6.6).curveTo(5.1,-5.6,5.9,-4.1).curveTo(6.8,-2.4,6.8,-0.3).lineTo(6.7,1).lineTo(-3.7,1).curveTo(-3.4,2.7,-2.2,3.7).curveTo(-1,4.6,0.9,4.6).curveTo(2.1,4.6,3.3,4.3).curveTo(4.5,3.9,5.4,3.3).lineTo(6.3,5.9).curveTo(5.3,6.7,3.8,7.1).curveTo(2.4,7.5,0.8,7.5).curveTo(-1.4,7.5,-3.2,6.6).closePath().moveTo(3.7,-1.5).curveTo(3.5,-3,2.6,-3.8).curveTo(1.6,-4.7,0.1,-4.7).curveTo(-1.4,-4.8,-2.4,-3.9).curveTo(-3.4,-3,-3.6,-1.5).lineTo(3.7,-1.5).lineTo(3.7,-1.5).closePath();
	this.shape_6.setTransform(-32.125,-27.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.6,7.2).lineTo(-7.4,-7.2).lineTo(-4,-7.2).lineTo(-0,3.6).lineTo(4,-7.2).lineTo(7.4,-7.2).lineTo(1.6,7.2).closePath();
	this.shape_7.setTransform(-47.475,-27.525);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4,9.7).curveTo(-5.5,8.8,-6.3,7.1).curveTo(-7.1,5.4,-7.1,3.2).curveTo(-7.1,1,-6.3,-0.7).curveTo(-5.5,-2.4,-4,-3.3).curveTo(-2.5,-4.3,-0.6,-4.3).curveTo(2.2,-4.3,4,-2).lineTo(4,-10.7).lineTo(7.1,-10.7).lineTo(7.1,10.4).lineTo(4.2,10.4).lineTo(4.2,8.2).curveTo(2.4,10.7,-0.6,10.7).curveTo(-2.5,10.7,-4,9.7).closePath().moveTo(-2.9,-0.1).curveTo(-4,1.2,-4,3.2).curveTo(-4,5.2,-2.9,6.5).curveTo(-1.8,7.7,0.1,7.7).curveTo(1.9,7.7,2.9,6.5).curveTo(4,5.3,4,3.2).curveTo(4,1.1,2.9,-0.1).curveTo(1.9,-1.3,0.1,-1.3).curveTo(-1.8,-1.3,-2.9,-0.1).closePath();
	this.shape_8.setTransform(-70.825,-30.725);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.5,13).lineTo(-3.2,10.2).lineTo(-2.4,10.3).curveTo(-1.3,10.3,-0.7,9.6).curveTo(-0.1,8.9,-0.1,7.3).lineTo(-0.1,-6.5).lineTo(3,-6.5).lineTo(3,7.6).curveTo(3,10.3,1.7,11.8).curveTo(0.5,13.2,-2,13.2).curveTo(-2.9,13.2,-3.5,13).closePath().moveTo(0,-9.8).curveTo(-0.6,-10.4,-0.5,-11.3).curveTo(-0.6,-12.1,0,-12.7).curveTo(0.5,-13.2,1.5,-13.2).curveTo(2.3,-13.2,2.9,-12.7).curveTo(3.4,-12.1,3.4,-11.3).curveTo(3.4,-10.4,2.9,-9.9).curveTo(2.3,-9.3,1.5,-9.3).curveTo(0.5,-9.3,0,-9.8).closePath();
	this.shape_9.setTransform(-84,-28.175);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.6,10.5).lineTo(-1.6,-3.8).lineTo(1.6,-3.8).lineTo(1.6,10.5).closePath().moveTo(-1.5,-7.1).curveTo(-2,-7.7,-2,-8.6).curveTo(-2,-9.4,-1.5,-10).curveTo(-0.9,-10.5,-0,-10.5).curveTo(0.9,-10.5,1.4,-10).curveTo(2,-9.4,2,-8.6).curveTo(2,-7.7,1.4,-7.2).curveTo(0.9,-6.6,-0,-6.6).curveTo(-0.9,-6.6,-1.5,-7.1).closePath();
	this.shape_10.setTransform(-89.7,-30.875);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.5,8.1).curveTo(-2.6,6.9,-2.6,4.8).lineTo(-2.6,-2.3).lineTo(-4.5,-2.3).lineTo(-4.5,-5.3).lineTo(-2.6,-5.3).lineTo(-2.6,-8.7).lineTo(0.5,-9.3).lineTo(0.5,-5.3).lineTo(4.3,-5.3).lineTo(4.3,-2.3).lineTo(0.5,-2.3).lineTo(0.5,4.3).curveTo(0.5,6.4,2.4,6.4).curveTo(3.2,6.4,4.1,6).lineTo(4.5,8.8).curveTo(3.3,9.3,1.8,9.3).curveTo(-0.3,9.3,-1.5,8.1).closePath();
	this.shape_11.setTransform(-98.375,-29.45);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2.1,9.6).curveTo(-2.9,8.7,-2.9,6.7).lineTo(-2.9,-10.6).lineTo(0.2,-10.6).lineTo(0.2,6.1).curveTo(0.2,6.9,0.5,7.3).curveTo(0.9,7.8,1.6,7.8).curveTo(2.2,7.8,2.6,7.6).lineTo(2.9,10.3).curveTo(2.1,10.6,0.7,10.6).curveTo(-1.2,10.6,-2.1,9.6).closePath();
	this.shape_12.setTransform(-106.475,-30.8);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.beginFill("#FFFFFF").beginStroke().moveTo(6.3,10).lineTo(4.3,4.9).lineTo(-4.3,4.9).lineTo(-6.3,10).lineTo(-9.8,10).lineTo(-1.9,-10).lineTo(1.9,-10).lineTo(9.8,10).closePath().moveTo(3.1,1.7).lineTo(0,-6.3).lineTo(-3.1,1.7).lineTo(3.1,1.7).closePath();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.9,8.1).lineTo(-5.1,5.6).curveTo(-4.2,6.1,-3,6.4).curveTo(-1.9,6.7,-0.7,6.7).curveTo(1.5,6.7,2.7,5.7).curveTo(3.7,4.6,3.8,2.5).lineTo(3.8,1.9).curveTo(2.1,4,-0.6,4).curveTo(-2.3,4,-3.7,3.1).curveTo(-5.1,2.3,-5.9,0.7).curveTo(-6.6,-0.7,-6.7,-2.7).curveTo(-6.6,-4.7,-5.9,-6.2).curveTo(-5.1,-7.7,-3.7,-8.6).curveTo(-2.3,-9.4,-0.6,-9.4).curveTo(2.3,-9.4,3.9,-7.1).lineTo(3.9,-9.2).lineTo(6.6,-9.2).lineTo(6.6,2.8).curveTo(6.6,6,4.8,7.6).curveTo(2.9,9.4,-0.6,9.4).curveTo(-3.5,9.4,-5.9,8.1).closePath().moveTo(-2.7,-5.6).curveTo(-3.8,-4.5,-3.7,-2.7).curveTo(-3.8,-1,-2.7,0.2).curveTo(-1.6,1.3,0.1,1.3).curveTo(1.8,1.2,2.8,0.2).curveTo(3.8,-0.9,3.8,-2.7).curveTo(3.8,-4.5,2.8,-5.7).curveTo(1.8,-6.7,0.1,-6.8).curveTo(-1.6,-6.8,-2.7,-5.6).closePath();
	this.shape.setTransform(111.35,44.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.1,6.8).lineTo(3.1,-0.4).curveTo(3.1,-2.3,2.3,-3.2).curveTo(1.6,-4.1,0.1,-4.1).curveTo(-1.4,-4.1,-2.3,-3.2).curveTo(-3.1,-2.2,-3.1,-0.5).lineTo(-3.1,6.8).lineTo(-6,6.8).lineTo(-6,-6.6).lineTo(-3.3,-6.6).lineTo(-3.3,-4.5).curveTo(-2.7,-5.7,-1.6,-6.2).curveTo(-0.4,-6.8,0.9,-6.8).curveTo(3.3,-6.8,4.7,-5.3).curveTo(6,-3.7,6,-1).lineTo(6,6.8).closePath();
	this.shape_1.setTransform(96.125,41.625);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.5,9.8).lineTo(-1.5,-3.6).lineTo(1.4,-3.6).lineTo(1.4,9.8).closePath().moveTo(-1.4,-6.7).curveTo(-1.9,-7.2,-1.9,-8).curveTo(-1.9,-8.8,-1.4,-9.3).curveTo(-0.9,-9.8,-0,-9.8).curveTo(0.8,-9.8,1.3,-9.3).curveTo(1.9,-8.8,1.9,-8).curveTo(1.9,-7.2,1.3,-6.7).curveTo(0.8,-6.2,-0,-6.2).curveTo(-0.9,-6.2,-1.4,-6.7).closePath();
	this.shape_2.setTransform(84.925,38.625);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.9,6.8).lineTo(-3.9,-6.6).lineTo(-1.2,-6.6).lineTo(-1.2,-4.2).curveTo(-0.2,-6.8,2.2,-6.8).curveTo(3.2,-6.8,3.9,-6.5).lineTo(3.6,-3.6).curveTo(2.8,-3.8,2.1,-3.9).curveTo(0.7,-3.9,-0.2,-2.9).curveTo(-1,-1.9,-1,0).lineTo(-1,6.8).closePath();
	this.shape_3.setTransform(77.35,41.65);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2.9,6.1).curveTo(-4.5,5.3,-5.5,3.7).curveTo(-6.3,2.1,-6.4,-0).curveTo(-6.3,-2.1,-5.6,-3.6).curveTo(-4.7,-5.2,-3.3,-6.1).curveTo(-1.9,-7,0,-7).curveTo(1.8,-7,3.3,-6.1).curveTo(4.8,-5.3,5.5,-3.8).curveTo(6.3,-2.2,6.3,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(2,4.3,3.1,4).curveTo(4.2,3.7,5.1,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.2,7,0.7,7).curveTo(-1.3,7,-2.9,6.1).closePath().moveTo(3.4,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.1,-2.8,-3.4,-1.3).lineTo(3.4,-1.3).lineTo(3.4,-1.3).closePath();
	this.shape_4.setTransform(64.15,41.775);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FFFFFF").beginStroke().moveTo(2.5,9.8).lineTo(-1.9,4.5).lineTo(-3.4,6).lineTo(-3.4,9.8).lineTo(-6.3,9.8).lineTo(-6.3,-9.8).lineTo(-3.4,-9.8).lineTo(-3.4,2.3).lineTo(2.2,-3.6).lineTo(5.9,-3.6).lineTo(0.1,2.5).lineTo(6.3,9.8).closePath();
	this.shape_5.setTransform(50.475,38.625);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2.9,6.1).curveTo(-4.6,5.3,-5.4,3.7).curveTo(-6.4,2.1,-6.3,-0).curveTo(-6.4,-2.1,-5.5,-3.6).curveTo(-4.8,-5.2,-3.3,-6.1).curveTo(-1.8,-7,-0,-7).curveTo(1.9,-7,3.3,-6.1).curveTo(4.7,-5.3,5.5,-3.8).curveTo(6.4,-2.2,6.4,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(1.9,4.3,3.1,4).curveTo(4.2,3.7,5,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.2,7,0.8,7).curveTo(-1.4,7,-2.9,6.1).closePath().moveTo(3.5,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0.1,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.2,-2.8,-3.4,-1.3).lineTo(3.5,-1.3).lineTo(3.5,-1.3).closePath();
	this.shape_6.setTransform(34.95,41.775);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.5,6.7).lineTo(-5.5,4.4).lineTo(1.2,-4).lineTo(-5.2,-4).lineTo(-5.2,-6.7).lineTo(5.2,-6.7).lineTo(5.2,-4.4).lineTo(-1.5,4).lineTo(5.5,4).lineTo(5.5,6.7).closePath();
	this.shape_7.setTransform(21.175,41.75);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4,6.8).lineTo(-4,-6.6).lineTo(-1.3,-6.6).lineTo(-1.3,-4.2).curveTo(-0.2,-6.8,2.2,-6.8).curveTo(3.1,-6.8,3.9,-6.5).lineTo(3.6,-3.6).curveTo(2.9,-3.8,2.1,-3.9).curveTo(0.7,-3.9,-0.2,-2.9).curveTo(-1.1,-1.9,-1.1,0).lineTo(-1.1,6.8).closePath();
	this.shape_8.setTransform(10.45,41.65);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2.9,6.1).curveTo(-4.6,5.3,-5.4,3.7).curveTo(-6.4,2.1,-6.3,-0).curveTo(-6.4,-2.1,-5.5,-3.6).curveTo(-4.8,-5.2,-3.3,-6.1).curveTo(-1.8,-7,-0,-7).curveTo(1.9,-7,3.3,-6.1).curveTo(4.8,-5.3,5.5,-3.8).curveTo(6.4,-2.2,6.3,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(1.9,4.3,3.1,4).curveTo(4.2,3.7,5.1,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.2,7,0.8,7).curveTo(-1.4,7,-2.9,6.1).closePath().moveTo(3.5,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.2,-2.8,-3.4,-1.3).lineTo(3.5,-1.3).lineTo(3.5,-1.3).closePath();
	this.shape_9.setTransform(-2.75,41.775);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.5,6.7).lineTo(-6.9,-6.7).lineTo(-3.8,-6.7).lineTo(-0,3.4).lineTo(3.8,-6.7).lineTo(6.9,-6.7).lineTo(1.5,6.7).closePath();
	this.shape_10.setTransform(-17.075,41.75);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.9,9.1).curveTo(-2.7,8.1,-2.7,6.2).lineTo(-2.7,-9.9).lineTo(0.2,-9.9).lineTo(0.2,5.7).curveTo(0.2,6.5,0.5,6.8).curveTo(0.8,7.2,1.5,7.2).curveTo(2.1,7.2,2.4,7).lineTo(2.7,9.6).curveTo(2,9.9,0.7,9.9).curveTo(-1.1,9.9,-1.9,9.1).closePath();
	this.shape_11.setTransform(-27.125,38.7);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2.9,6.1).curveTo(-4.5,5.3,-5.5,3.7).curveTo(-6.4,2.1,-6.4,-0).curveTo(-6.4,-2.1,-5.5,-3.6).curveTo(-4.8,-5.2,-3.3,-6.1).curveTo(-1.9,-7,0,-7).curveTo(1.8,-7,3.3,-6.1).curveTo(4.8,-5.3,5.5,-3.8).curveTo(6.4,-2.2,6.3,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(1.9,4.3,3.1,4).curveTo(4.2,3.7,5.1,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.3,7,0.8,7).curveTo(-1.4,7,-2.9,6.1).closePath().moveTo(3.5,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.2,-2.8,-3.4,-1.3).lineTo(3.5,-1.3).lineTo(3.5,-1.3).closePath();
	this.shape_12.setTransform(-39.1,41.775);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.7,9.1).curveTo(-5.1,8.2,-5.9,6.6).curveTo(-6.7,5,-6.6,3).curveTo(-6.6,0.9,-5.9,-0.6).curveTo(-5.1,-2.2,-3.7,-3.1).curveTo(-2.3,-4,-0.6,-3.9).curveTo(2.1,-3.9,3.7,-1.9).lineTo(3.7,-10).lineTo(6.6,-10).lineTo(6.6,9.7).lineTo(3.9,9.7).lineTo(3.9,7.7).curveTo(2.3,10,-0.6,9.9).curveTo(-2.3,9.9,-3.7,9.1).closePath().moveTo(-2.7,-0).curveTo(-3.7,1.2,-3.7,3).curveTo(-3.7,4.9,-2.7,6.1).curveTo(-1.6,7.2,0.1,7.2).curveTo(1.8,7.2,2.8,6.1).curveTo(3.7,4.9,3.7,3).curveTo(3.7,1,2.8,-0.1).curveTo(1.8,-1.2,0.1,-1.2).curveTo(-1.6,-1.2,-2.7,-0).closePath();
	this.shape_13.setTransform(-54.95,38.75);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2.9,6.1).curveTo(-4.6,5.3,-5.4,3.7).curveTo(-6.4,2.1,-6.3,-0).curveTo(-6.4,-2.1,-5.5,-3.6).curveTo(-4.8,-5.2,-3.3,-6.1).curveTo(-1.8,-7,-0,-7).curveTo(1.9,-7,3.3,-6.1).curveTo(4.7,-5.3,5.5,-3.8).curveTo(6.4,-2.2,6.4,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(1.9,4.3,3.1,4).curveTo(4.2,3.7,5,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.2,7,0.8,7).curveTo(-1.4,7,-2.9,6.1).closePath().moveTo(3.5,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0.1,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.2,-2.8,-3.4,-1.3).lineTo(3.5,-1.3).lineTo(3.5,-1.3).closePath();
	this.shape_14.setTransform(-69.9,41.775);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.5,6.1).curveTo(-5.1,5.2,-5.9,3.6).curveTo(-6.8,2,-6.8,-0).curveTo(-6.8,-2.1,-5.9,-3.6).curveTo(-5.1,-5.2,-3.5,-6.1).curveTo(-2,-7,-0,-7).curveTo(2,-7,3.5,-6.1).curveTo(5,-5.2,5.9,-3.6).curveTo(6.8,-2.1,6.8,-0).curveTo(6.8,2,5.9,3.6).curveTo(5,5.2,3.5,6.1).curveTo(2,7,-0,7).curveTo(-2,7,-3.5,6.1).closePath().moveTo(-2.8,-3.1).curveTo(-3.9,-1.9,-3.9,-0).curveTo(-3.9,1.9,-2.8,3).curveTo(-1.7,4.2,-0,4.2).curveTo(1.7,4.2,2.8,3).curveTo(3.8,1.9,3.8,-0).curveTo(3.8,-1.9,2.8,-3.1).curveTo(1.7,-4.2,-0,-4.2).curveTo(-1.7,-4.2,-2.8,-3.1).closePath();
	this.shape_15.setTransform(-84.925,41.775);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4,7.7).lineTo(-4,9.7).lineTo(-6.7,9.7).lineTo(-6.7,-10).lineTo(-3.8,-10).lineTo(-3.8,-1.9).curveTo(-2,-3.9,0.6,-3.9).curveTo(2.4,-4,3.8,-3.1).curveTo(5.1,-2.2,5.9,-0.6).curveTo(6.6,0.9,6.6,3).curveTo(6.6,5,5.9,6.6).curveTo(5.1,8.2,3.8,9.1).curveTo(2.4,9.9,0.6,9.9).curveTo(-2.3,10,-4,7.7).closePath().moveTo(-2.7,-0.1).curveTo(-3.8,1,-3.8,3).curveTo(-3.8,4.9,-2.7,6.1).curveTo(-1.8,7.2,-0,7.2).curveTo(1.6,7.3,2.7,6.1).curveTo(3.8,4.9,3.8,3).curveTo(3.8,1.2,2.7,-0).curveTo(1.6,-1.2,-0,-1.2).curveTo(-1.8,-1.2,-2.7,-0.1).closePath();
	this.shape_16.setTransform(-100.25,38.75);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.1,6.8).lineTo(3.1,-0.4).curveTo(3.1,-2.3,2.3,-3.2).curveTo(1.6,-4.1,0.1,-4.1).curveTo(-1.4,-4.1,-2.3,-3.2).curveTo(-3.1,-2.2,-3.1,-0.5).lineTo(-3.1,6.8).lineTo(-6,6.8).lineTo(-6,-6.6).lineTo(-3.3,-6.6).lineTo(-3.3,-4.5).curveTo(-2.7,-5.7,-1.6,-6.2).curveTo(-0.4,-6.8,0.9,-6.8).curveTo(3.3,-6.8,4.7,-5.3).curveTo(6,-3.7,6,-1).lineTo(6,6.8).closePath();
	this.shape_17.setTransform(-116.425,41.625);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.5,9.8).lineTo(-1.5,-3.6).lineTo(1.4,-3.6).lineTo(1.4,9.8).closePath().moveTo(-1.4,-6.7).curveTo(-1.9,-7.2,-1.9,-8).curveTo(-1.9,-8.8,-1.4,-9.3).curveTo(-0.9,-9.8,-0,-9.8).curveTo(0.8,-9.8,1.3,-9.3).curveTo(1.9,-8.8,1.9,-8).curveTo(1.9,-7.2,1.3,-6.7).curveTo(0.8,-6.2,-0,-6.2).curveTo(-0.9,-6.2,-1.4,-6.7).closePath();
	this.shape_18.setTransform(-127.625,38.625);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#003781").beginStroke().moveTo(-2.9,6.1).curveTo(-4.5,5.3,-5.5,3.7).curveTo(-6.4,2.1,-6.4,-0).curveTo(-6.4,-2.1,-5.5,-3.6).curveTo(-4.8,-5.2,-3.3,-6.1).curveTo(-1.9,-7,0,-7).curveTo(1.8,-7,3.3,-6.1).curveTo(4.8,-5.3,5.5,-3.8).curveTo(6.4,-2.2,6.3,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(1.9,4.3,3.1,4).curveTo(4.2,3.7,5.1,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.3,7,0.8,7).curveTo(-1.4,7,-2.9,6.1).closePath().moveTo(3.5,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.2,-2.8,-3.4,-1.3).lineTo(3.5,-1.3).lineTo(3.5,-1.3).closePath();
	this.shape.setTransform(73.4,13.975);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#003781").beginStroke().moveTo(-3.7,9.1).curveTo(-5.1,8.2,-5.9,6.7).curveTo(-6.7,5,-6.6,3).curveTo(-6.6,0.9,-5.9,-0.6).curveTo(-5.1,-2.2,-3.7,-3.1).curveTo(-2.3,-3.9,-0.6,-3.9).curveTo(2.1,-4,3.7,-1.9).lineTo(3.7,-10).lineTo(6.6,-10).lineTo(6.6,9.7).lineTo(3.9,9.7).lineTo(3.9,7.7).curveTo(2.3,10,-0.6,9.9).curveTo(-2.3,9.9,-3.7,9.1).closePath().moveTo(-2.7,-0.1).curveTo(-3.7,1.2,-3.7,3).curveTo(-3.7,4.9,-2.7,6.1).curveTo(-1.6,7.2,0.1,7.2).curveTo(1.8,7.2,2.8,6.1).curveTo(3.7,5,3.7,3).curveTo(3.7,1,2.8,-0.1).curveTo(1.8,-1.2,0.1,-1.2).curveTo(-1.6,-1.2,-2.7,-0.1).closePath();
	this.shape_1.setTransform(57.55,10.95);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#003781").beginStroke().moveTo(3.1,6.8).lineTo(3.1,-0.4).curveTo(3.1,-2.3,2.3,-3.2).curveTo(1.6,-4.1,0.1,-4.1).curveTo(-1.4,-4.1,-2.3,-3.2).curveTo(-3.1,-2.2,-3.1,-0.5).lineTo(-3.1,6.8).lineTo(-6,6.8).lineTo(-6,-6.6).lineTo(-3.3,-6.6).lineTo(-3.3,-4.5).curveTo(-2.7,-5.7,-1.6,-6.2).curveTo(-0.4,-6.8,0.9,-6.8).curveTo(3.3,-6.8,4.7,-5.3).curveTo(6,-3.7,6,-1).lineTo(6,6.8).closePath();
	this.shape_2.setTransform(42.325,13.825);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#003781").beginStroke().moveTo(-2.9,6.1).curveTo(-4.5,5.3,-5.4,3.7).curveTo(-6.4,2.1,-6.4,-0).curveTo(-6.4,-2.1,-5.5,-3.6).curveTo(-4.8,-5.2,-3.3,-6.1).curveTo(-1.9,-7,0,-7).curveTo(1.8,-7,3.3,-6.1).curveTo(4.8,-5.3,5.5,-3.8).curveTo(6.4,-2.2,6.3,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(1.9,4.3,3.1,4).curveTo(4.2,3.7,5.1,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.3,7,0.8,7).curveTo(-1.4,7,-2.9,6.1).closePath().moveTo(3.5,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.2,-2.8,-3.4,-1.3).lineTo(3.5,-1.3).lineTo(3.5,-1.3).closePath();
	this.shape_3.setTransform(27.05,13.975);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#003781").beginStroke().moveTo(-5.1,6).lineTo(-4.4,3.3).curveTo(-2.6,4.3,-0.6,4.3).curveTo(0.7,4.3,1.4,3.9).curveTo(2.2,3.5,2.1,2.8).curveTo(2.1,2.2,1.6,1.9).curveTo(0.9,1.6,-0.3,1.2).lineTo(-2.6,0.5).curveTo(-3.5,0.1,-4.1,-0.8).curveTo(-4.8,-1.6,-4.7,-3).curveTo(-4.7,-4.9,-3.5,-6).curveTo(-2.2,-7,0.2,-7).curveTo(1.4,-7,2.6,-6.7).curveTo(3.6,-6.5,4.6,-6.1).lineTo(3.8,-3.5).curveTo(2.2,-4.4,0.3,-4.4).curveTo(-0.8,-4.4,-1.3,-4).curveTo(-1.9,-3.7,-1.8,-3).curveTo(-1.8,-2.3,-1.2,-2).curveTo(-0.6,-1.7,0.8,-1.3).curveTo(2.1,-0.9,2.9,-0.5).curveTo(3.8,-0.2,4.5,0.6).curveTo(5,1.4,5,2.7).curveTo(5,4.7,3.6,5.9).curveTo(2.1,7,-0.6,7).curveTo(-3.1,7,-5.1,6).closePath();
	this.shape_4.setTransform(13.8,13.975);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#003781").beginStroke().moveTo(-5.1,6).lineTo(-4.4,3.3).curveTo(-2.6,4.3,-0.6,4.3).curveTo(0.7,4.3,1.4,3.9).curveTo(2.2,3.5,2.1,2.8).curveTo(2.1,2.2,1.6,1.9).curveTo(0.9,1.6,-0.3,1.2).lineTo(-2.6,0.5).curveTo(-3.5,0.1,-4.1,-0.8).curveTo(-4.8,-1.6,-4.7,-3).curveTo(-4.7,-4.9,-3.5,-6).curveTo(-2.2,-7,0.2,-7).curveTo(1.4,-7,2.6,-6.7).curveTo(3.6,-6.5,4.6,-6.1).lineTo(3.8,-3.5).curveTo(2.2,-4.4,0.3,-4.4).curveTo(-0.8,-4.4,-1.3,-4).curveTo(-1.9,-3.7,-1.8,-3).curveTo(-1.8,-2.3,-1.2,-2).curveTo(-0.6,-1.7,0.8,-1.3).curveTo(2.1,-0.9,2.9,-0.5).curveTo(3.8,-0.2,4.5,0.6).curveTo(5,1.4,5,2.7).curveTo(5,4.7,3.6,5.9).curveTo(2.1,7,-0.6,7).curveTo(-3.1,7,-5.1,6).closePath();
	this.shape_5.setTransform(2.1,13.975);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#003781").beginStroke().moveTo(-3.7,6.1).curveTo(-5.1,5.2,-5.9,3.7).curveTo(-6.7,2,-6.6,-0).curveTo(-6.6,-2.1,-5.9,-3.6).curveTo(-5.1,-5.2,-3.7,-6.1).curveTo(-2.3,-6.9,-0.6,-6.9).curveTo(2.3,-6.9,3.9,-4.7).lineTo(3.9,-6.7).lineTo(6.6,-6.7).lineTo(6.6,6.7).lineTo(3.9,6.7).lineTo(3.9,4.7).curveTo(2.3,7,-0.6,6.9).curveTo(-2.3,6.9,-3.7,6.1).closePath().moveTo(-2.7,-3.1).curveTo(-3.7,-1.8,-3.7,-0).curveTo(-3.7,1.9,-2.7,3.1).curveTo(-1.6,4.2,0.1,4.2).curveTo(1.8,4.2,2.8,3.1).curveTo(3.7,2,3.7,-0).curveTo(3.7,-2,2.8,-3.1).curveTo(1.8,-4.2,0.1,-4.2).curveTo(-1.6,-4.2,-2.7,-3.1).closePath();
	this.shape_6.setTransform(-12.2,13.95);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#003781").beginStroke().moveTo(-6.6,9.3).lineTo(-6.6,-9).lineTo(-3.9,-9).lineTo(-3.9,-7).curveTo(-2.3,-9.3,0.6,-9.3).curveTo(2.4,-9.3,3.7,-8.4).curveTo(5.1,-7.5,5.9,-5.9).curveTo(6.7,-4.4,6.6,-2.3).curveTo(6.7,-0.3,5.9,1.3).curveTo(5.1,2.9,3.7,3.8).curveTo(2.4,4.6,0.6,4.6).curveTo(-2.1,4.6,-3.7,2.6).lineTo(-3.7,9.3).closePath().moveTo(-2.8,-5.4).curveTo(-3.8,-4.3,-3.7,-2.3).curveTo(-3.8,-0.4,-2.8,0.8).curveTo(-1.7,1.9,-0.1,1.9).curveTo(1.6,1.9,2.7,0.7).curveTo(3.7,-0.4,3.7,-2.3).curveTo(3.7,-4.2,2.7,-5.4).curveTo(1.6,-6.5,-0.1,-6.5).curveTo(-1.7,-6.5,-2.8,-5.4).closePath();
	this.shape_7.setTransform(-27.4,16.275);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#003781").beginStroke().moveTo(-1.3,7.6).curveTo(-2.4,6.5,-2.4,4.4).lineTo(-2.4,-2.2).lineTo(-4.2,-2.2).lineTo(-4.2,-4.9).lineTo(-2.4,-4.9).lineTo(-2.4,-8.1).lineTo(0.5,-8.6).lineTo(0.5,-4.9).lineTo(4.1,-4.9).lineTo(4.1,-2.2).lineTo(0.5,-2.2).lineTo(0.5,4).curveTo(0.5,6,2.3,5.9).curveTo(3,5.9,3.8,5.7).lineTo(4.2,8.3).curveTo(3.1,8.6,1.7,8.6).curveTo(-0.3,8.7,-1.3,7.6).closePath();
	this.shape_8.setTransform(-46.925,12.15);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#003781").beginStroke().moveTo(-5,6).lineTo(-4.4,3.3).curveTo(-2.6,4.3,-0.5,4.3).curveTo(0.7,4.3,1.5,3.9).curveTo(2.1,3.5,2.2,2.8).curveTo(2.1,2.2,1.6,1.9).curveTo(0.9,1.6,-0.3,1.2).lineTo(-2.6,0.5).curveTo(-3.5,0.1,-4.1,-0.8).curveTo(-4.7,-1.6,-4.7,-3).curveTo(-4.8,-4.9,-3.5,-6).curveTo(-2.1,-7,0.2,-7).curveTo(1.4,-7,2.5,-6.7).curveTo(3.7,-6.5,4.5,-6.1).lineTo(3.8,-3.5).curveTo(2.2,-4.4,0.3,-4.4).curveTo(-0.7,-4.4,-1.3,-4).curveTo(-1.8,-3.7,-1.9,-3).curveTo(-1.8,-2.3,-1.2,-2).curveTo(-0.6,-1.7,0.7,-1.3).curveTo(2.1,-0.9,2.9,-0.5).curveTo(3.8,-0.2,4.4,0.6).curveTo(5.1,1.4,5.1,2.7).curveTo(5,4.7,3.5,5.9).curveTo(2,7,-0.5,7).curveTo(-3.1,7,-5,6).closePath();
	this.shape_9.setTransform(-57.45,13.975);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#003781").beginStroke().moveTo(-3,6.1).curveTo(-4.6,5.3,-5.4,3.7).curveTo(-6.3,2.1,-6.3,-0).curveTo(-6.3,-2.1,-5.6,-3.6).curveTo(-4.8,-5.2,-3.3,-6.1).curveTo(-1.8,-7,-0,-7).curveTo(1.8,-7,3.3,-6.1).curveTo(4.7,-5.3,5.6,-3.8).curveTo(6.3,-2.2,6.4,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.1,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(2,4.3,3.1,4).curveTo(4.2,3.7,5,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.3,7,0.7,7).curveTo(-1.3,7,-3,6.1).closePath().moveTo(3.4,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0.1,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.1,-2.8,-3.4,-1.3).lineTo(3.4,-1.3).lineTo(3.4,-1.3).closePath();
	this.shape_10.setTransform(-70.55,13.975);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("#003781").beginStroke().moveTo(-3.9,7.7).lineTo(-3.9,9.7).lineTo(-6.6,9.7).lineTo(-6.6,-10).lineTo(-3.7,-10).lineTo(-3.7,-1.9).curveTo(-2.1,-4,0.6,-3.9).curveTo(2.4,-3.9,3.7,-3.1).curveTo(5.1,-2.2,5.9,-0.6).curveTo(6.7,0.9,6.6,3).curveTo(6.7,5,5.9,6.7).curveTo(5.1,8.2,3.7,9.1).curveTo(2.4,9.9,0.6,9.9).curveTo(-2.3,10,-3.9,7.7).closePath().moveTo(-2.8,-0.1).curveTo(-3.8,1,-3.7,3).curveTo(-3.8,5,-2.8,6.1).curveTo(-1.7,7.2,-0.1,7.2).curveTo(1.6,7.3,2.7,6.1).curveTo(3.7,4.9,3.7,3).curveTo(3.7,1.2,2.7,-0.1).curveTo(1.6,-1.2,-0.1,-1.2).curveTo(-1.7,-1.2,-2.8,-0.1).closePath();
	this.shape_11.setTransform(-85.45,10.95);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#003781").beginStroke().moveTo(-3,6.1).curveTo(-4.5,5.3,-5.5,3.7).curveTo(-6.3,2.1,-6.4,-0).curveTo(-6.3,-2.1,-5.6,-3.6).curveTo(-4.7,-5.2,-3.3,-6.1).curveTo(-1.8,-7,-0,-7).curveTo(1.8,-7,3.3,-6.1).curveTo(4.7,-5.3,5.6,-3.8).curveTo(6.3,-2.2,6.4,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(2,4.3,3.1,4).curveTo(4.2,3.7,5,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.2,7,0.7,7).curveTo(-1.4,7,-3,6.1).closePath().moveTo(3.4,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0.1,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.2,-2.8,-3.4,-1.3).lineTo(3.4,-1.3).lineTo(3.4,-1.3).closePath();
	this.shape_12.setTransform(-107.55,13.975);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.beginFill("#003781").beginStroke().moveTo(-3.7,9.1).curveTo(-5.1,8.2,-5.9,6.7).curveTo(-6.6,5,-6.7,3).curveTo(-6.7,0.9,-5.8,-0.6).curveTo(-5.1,-2.2,-3.7,-3.1).curveTo(-2.3,-3.9,-0.5,-3.9).curveTo(2.1,-4,3.8,-1.9).lineTo(3.8,-10).lineTo(6.7,-10).lineTo(6.7,9.7).lineTo(4,9.7).lineTo(4,7.7).curveTo(2.3,10,-0.5,9.9).curveTo(-2.3,9.9,-3.7,9.1).closePath().moveTo(-2.7,-0.1).curveTo(-3.8,1.2,-3.8,3).curveTo(-3.8,4.9,-2.7,6.1).curveTo(-1.6,7.2,0.1,7.2).curveTo(1.8,7.2,2.8,6.1).curveTo(3.8,5,3.8,3).curveTo(3.8,1,2.8,-0.1).curveTo(1.8,-1.2,0.1,-1.2).curveTo(-1.6,-1.2,-2.7,-0.1).closePath();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#003781").beginStroke().moveTo(-4.7,5.3).curveTo(-6,3.7,-6,1).lineTo(-6,-6.8).lineTo(-3.1,-6.8).lineTo(-3.1,0.4).curveTo(-3.1,2.3,-2.3,3.2).curveTo(-1.6,4.1,-0.1,4.1).curveTo(1.4,4.1,2.2,3.2).curveTo(3.1,2.2,3.1,0.5).lineTo(3.1,-6.8).lineTo(6,-6.8).lineTo(6,6.6).lineTo(3.2,6.6).lineTo(3.2,4.5).curveTo(2.7,5.7,1.5,6.3).curveTo(0.4,6.8,-1,6.8).curveTo(-3.4,6.8,-4.7,5.3).closePath();
	this.shape.setTransform(-35.1,-13.725);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#003781").beginStroke().moveTo(-3.5,6.1).curveTo(-5.1,5.2,-5.9,3.6).curveTo(-6.8,2,-6.8,-0).curveTo(-6.8,-2.1,-5.9,-3.6).curveTo(-5.1,-5.2,-3.5,-6.1).curveTo(-2,-7,-0,-7).curveTo(2,-7,3.5,-6.1).curveTo(5,-5.2,5.9,-3.6).curveTo(6.8,-2.1,6.8,-0).curveTo(6.8,2,5.9,3.6).curveTo(5,5.2,3.5,6.1).curveTo(2,7,-0,7).curveTo(-2,7,-3.5,6.1).closePath().moveTo(-2.8,-3.1).curveTo(-3.9,-1.9,-3.9,-0).curveTo(-3.9,1.9,-2.8,3).curveTo(-1.7,4.2,-0,4.2).curveTo(1.7,4.2,2.8,3).curveTo(3.8,1.9,3.8,-0).curveTo(3.8,-1.9,2.8,-3.1).curveTo(1.7,-4.2,-0,-4.2).curveTo(-1.7,-4.2,-2.8,-3.1).closePath();
	this.shape_1.setTransform(-50.475,-13.825);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#003781").beginStroke().moveTo(-3.2,12.2).lineTo(-3,9.6).lineTo(-2.2,9.6).curveTo(-1.2,9.6,-0.7,9).curveTo(-0.1,8.4,-0.1,6.9).lineTo(-0.1,-6.1).lineTo(2.8,-6.1).lineTo(2.8,7.2).curveTo(2.8,9.6,1.6,11).curveTo(0.5,12.3,-1.8,12.3).curveTo(-2.7,12.3,-3.2,12.2).closePath().moveTo(0,-9.2).curveTo(-0.5,-9.7,-0.5,-10.5).curveTo(-0.5,-11.3,0,-11.8).curveTo(0.5,-12.3,1.4,-12.3).curveTo(2.1,-12.3,2.7,-11.8).curveTo(3.2,-11.3,3.3,-10.5).curveTo(3.2,-9.7,2.7,-9.2).curveTo(2.1,-8.7,1.4,-8.7).curveTo(0.5,-8.7,0,-9.2).closePath();
	this.shape_2.setTransform(-62.85,-14.475);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#003781").beginStroke().moveTo(-4,6.8).lineTo(-4,-6.6).lineTo(-1.3,-6.6).lineTo(-1.3,-4.2).curveTo(-0.2,-6.8,2.3,-6.8).curveTo(3.2,-6.8,4,-6.5).lineTo(3.5,-3.6).curveTo(2.8,-3.8,2.2,-3.9).curveTo(0.6,-3.8,-0.2,-2.9).curveTo(-1.1,-1.9,-1.1,0.1).lineTo(-1.1,6.8).closePath();
	this.shape_3.setTransform(-75.25,-13.95);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#003781").beginStroke().moveTo(-3.5,6.1).curveTo(-5.1,5.2,-5.9,3.6).curveTo(-6.8,2,-6.8,-0).curveTo(-6.8,-2.1,-5.9,-3.6).curveTo(-5.1,-5.2,-3.5,-6.1).curveTo(-2,-7,-0,-7).curveTo(2,-7,3.5,-6.1).curveTo(5,-5.2,5.9,-3.6).curveTo(6.8,-2.1,6.8,-0).curveTo(6.8,2,5.9,3.6).curveTo(5,5.2,3.5,6.1).curveTo(2,7,-0,7).curveTo(-2,7,-3.5,6.1).closePath().moveTo(-2.8,-3.1).curveTo(-3.9,-1.9,-3.9,-0).curveTo(-3.9,1.9,-2.8,3).curveTo(-1.7,4.2,-0,4.2).curveTo(1.7,4.2,2.8,3).curveTo(3.8,1.9,3.8,-0).curveTo(3.8,-1.9,2.8,-3.1).curveTo(1.7,-4.2,-0,-4.2).curveTo(-1.7,-4.2,-2.8,-3.1).closePath();
	this.shape_4.setTransform(-88.825,-13.825);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#003781").beginStroke().moveTo(-3.5,6.1).curveTo(-5.1,5.2,-5.9,3.6).curveTo(-6.8,2,-6.8,-0).curveTo(-6.8,-2.1,-5.9,-3.6).curveTo(-5.1,-5.2,-3.5,-6.1).curveTo(-2,-7,-0,-7).curveTo(2,-7,3.5,-6.1).curveTo(5,-5.2,5.9,-3.6).curveTo(6.8,-2.1,6.8,-0).curveTo(6.8,2,5.9,3.6).curveTo(5,5.2,3.5,6.1).curveTo(2,7,-0,7).curveTo(-2,7,-3.5,6.1).closePath().moveTo(-2.8,-3.1).curveTo(-3.9,-1.9,-3.9,-0).curveTo(-3.9,1.9,-2.8,3).curveTo(-1.7,4.2,-0,4.2).curveTo(1.7,4.2,2.8,3).curveTo(3.8,1.9,3.8,-0).curveTo(3.8,-1.9,2.8,-3.1).curveTo(1.7,-4.2,-0,-4.2).curveTo(-1.7,-4.2,-2.8,-3.1).closePath();
	this.shape_5.setTransform(-104.275,-13.825);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#003781").beginStroke().moveTo(-1.6,9.4).lineTo(-9.4,-9.3).lineTo(-5.9,-9.3).lineTo(-0,5.9).lineTo(5.9,-9.3).lineTo(9.4,-9.3).lineTo(1.6,9.4).closePath();
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#003781").beginStroke().moveTo(-2.6,9.1).curveTo(-3.2,8.6,-3.2,7.6).curveTo(-3.2,6.8,-2.6,6.3).curveTo(-2.1,5.7,-1.2,5.7).curveTo(-0.4,5.7,0.2,6.3).curveTo(0.8,6.8,0.8,7.6).curveTo(0.8,8.6,0.2,9.1).curveTo(-0.4,9.7,-1.2,9.7).curveTo(-2.1,9.7,-2.6,9.1).closePath().moveTo(-2.7,3.7).lineTo(-2.7,3.4).curveTo(-2.7,2.3,-2.3,1.4).curveTo(-1.9,0.6,-1.3,-0).lineTo(0.3,-1.3).curveTo(1.5,-2.1,2,-2.6).curveTo(2.6,-3.3,2.6,-4.2).curveTo(2.6,-5.3,1.7,-6).curveTo(0.7,-6.7,-0.8,-6.7).curveTo(-2,-6.7,-3,-6.3).curveTo(-4,-5.9,-4.8,-5.3).lineTo(-5.7,-8).curveTo(-4.7,-8.8,-3.4,-9.2).curveTo(-2,-9.6,-0.5,-9.7).curveTo(1.3,-9.7,2.7,-8.9).curveTo(4.1,-8.3,4.9,-7.1).curveTo(5.7,-5.9,5.7,-4.3).curveTo(5.7,-3.1,5.3,-2.2).curveTo(4.8,-1.3,4.2,-0.8).lineTo(2.5,0.5).curveTo(1.4,1.3,0.8,1.9).curveTo(0.3,2.5,0.3,3.4).lineTo(0.3,3.7).closePath();
	this.shape.setTransform(-41.275,42.6);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#003781").beginStroke().moveTo(3.1,6.8).lineTo(3.1,-0.4).curveTo(3.1,-2.3,2.3,-3.2).curveTo(1.6,-4.1,0.1,-4.1).curveTo(-1.4,-4.1,-2.3,-3.2).curveTo(-3.1,-2.2,-3.1,-0.5).lineTo(-3.1,6.8).lineTo(-6,6.8).lineTo(-6,-6.6).lineTo(-3.3,-6.6).lineTo(-3.3,-4.5).curveTo(-2.7,-5.7,-1.6,-6.2).curveTo(-0.4,-6.8,0.9,-6.8).curveTo(3.3,-6.8,4.7,-5.3).curveTo(6,-3.7,6,-1).lineTo(6,6.8).closePath();
	this.shape_1.setTransform(-55.075,45.125);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#003781").beginStroke().moveTo(-2.9,6.1).curveTo(-4.6,5.3,-5.4,3.7).curveTo(-6.4,2.1,-6.3,-0).curveTo(-6.4,-2.1,-5.5,-3.6).curveTo(-4.8,-5.2,-3.3,-6.1).curveTo(-1.8,-7,-0,-7).curveTo(1.9,-7,3.3,-6.1).curveTo(4.7,-5.3,5.5,-3.8).curveTo(6.4,-2.2,6.4,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(1.9,4.3,3.1,4).curveTo(4.2,3.7,5,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.2,7,0.8,7).curveTo(-1.4,7,-2.9,6.1).closePath().moveTo(3.5,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0.1,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.2,-2.8,-3.4,-1.3).lineTo(3.5,-1.3).lineTo(3.5,-1.3).closePath();
	this.shape_2.setTransform(-70.35,45.275);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#003781").beginStroke().moveTo(-1.3,7.6).curveTo(-2.4,6.5,-2.4,4.4).lineTo(-2.4,-2.1).lineTo(-4.2,-2.1).lineTo(-4.2,-4.9).lineTo(-2.4,-4.9).lineTo(-2.4,-8.1).lineTo(0.5,-8.6).lineTo(0.5,-4.9).lineTo(4.1,-4.9).lineTo(4.1,-2.1).lineTo(0.5,-2.1).lineTo(0.5,4).curveTo(0.5,6,2.3,6).curveTo(3,6,3.8,5.7).lineTo(4.2,8.2).curveTo(3.1,8.7,1.7,8.7).curveTo(-0.3,8.6,-1.3,7.6).closePath();
	this.shape_3.setTransform(-82.425,43.45);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#003781").beginStroke().moveTo(-5.1,6).lineTo(-4.3,3.3).curveTo(-2.6,4.3,-0.6,4.3).curveTo(0.7,4.3,1.4,3.9).curveTo(2.2,3.5,2.1,2.8).curveTo(2.2,2.2,1.5,1.9).curveTo(1,1.6,-0.3,1.2).lineTo(-2.6,0.5).curveTo(-3.5,0.1,-4.1,-0.8).curveTo(-4.8,-1.6,-4.8,-3).curveTo(-4.8,-4.9,-3.4,-6).curveTo(-2.2,-7,0.2,-7).curveTo(1.4,-7,2.6,-6.7).curveTo(3.6,-6.5,4.6,-6.1).lineTo(3.8,-3.5).curveTo(2.2,-4.4,0.3,-4.4).curveTo(-0.8,-4.4,-1.3,-4).curveTo(-1.9,-3.7,-1.8,-3).curveTo(-1.9,-2.3,-1.2,-2).curveTo(-0.6,-1.7,0.8,-1.3).curveTo(2.1,-0.9,2.9,-0.5).curveTo(3.8,-0.2,4.5,0.6).curveTo(5,1.4,5,2.7).curveTo(5,4.7,3.6,5.9).curveTo(2.1,7,-0.6,7).curveTo(-3.1,7,-5.1,6).closePath();
	this.shape_4.setTransform(-92.95,45.275);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#003781").beginStroke().moveTo(-3.7,6.1).curveTo(-5.1,5.2,-5.9,3.6).curveTo(-6.7,2,-6.7,0).curveTo(-6.6,-2.1,-5.9,-3.6).curveTo(-5.1,-5.2,-3.7,-6.1).curveTo(-2.3,-7,-0.6,-6.9).curveTo(2.3,-7,3.9,-4.7).lineTo(3.9,-6.7).lineTo(6.6,-6.7).lineTo(6.6,6.7).lineTo(3.9,6.7).lineTo(3.9,4.7).curveTo(2.3,7,-0.6,7).curveTo(-2.3,6.9,-3.7,6.1).closePath().moveTo(-2.7,-3).curveTo(-3.7,-1.9,-3.7,0).curveTo(-3.7,1.9,-2.7,3.1).curveTo(-1.6,4.2,0.1,4.2).curveTo(1.8,4.2,2.8,3.1).curveTo(3.7,1.9,3.7,0).curveTo(3.7,-2,2.8,-3.1).curveTo(1.8,-4.2,0.1,-4.2).curveTo(-1.6,-4.2,-2.7,-3).closePath();
	this.shape_5.setTransform(-107.25,45.25);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#003781").beginStroke().moveTo(-5.9,8.1).lineTo(-5.1,5.6).curveTo(-4.1,6.1,-3,6.4).curveTo(-1.9,6.7,-0.7,6.7).curveTo(1.5,6.7,2.6,5.7).curveTo(3.8,4.6,3.8,2.5).lineTo(3.8,1.9).curveTo(2.1,4,-0.5,4).curveTo(-2.3,4,-3.7,3.1).curveTo(-5.1,2.2,-5.8,0.7).curveTo(-6.7,-0.8,-6.7,-2.7).curveTo(-6.7,-4.7,-5.8,-6.2).curveTo(-5.1,-7.7,-3.7,-8.6).curveTo(-2.3,-9.4,-0.5,-9.4).curveTo(2.3,-9.4,4,-7.1).lineTo(4,-9.2).lineTo(6.7,-9.2).lineTo(6.7,2.8).curveTo(6.7,6,4.8,7.6).curveTo(2.9,9.4,-0.5,9.4).curveTo(-3.4,9.4,-5.9,8.1).closePath().moveTo(-2.7,-5.6).curveTo(-3.8,-4.5,-3.8,-2.7).curveTo(-3.8,-1,-2.7,0.2).curveTo(-1.6,1.2,0.1,1.3).curveTo(1.8,1.3,2.8,0.2).curveTo(3.8,-0.9,3.8,-2.7).curveTo(3.8,-4.5,2.8,-5.7).curveTo(1.8,-6.8,0.1,-6.7).curveTo(-1.6,-6.7,-2.7,-5.6).closePath();
	this.shape_6.setTransform(-123.4,47.7);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#003781").beginStroke().moveTo(-2.9,6.1).curveTo(-4.6,5.3,-5.4,3.7).curveTo(-6.4,2.1,-6.3,-0).curveTo(-6.4,-2.1,-5.5,-3.6).curveTo(-4.8,-5.2,-3.3,-6.1).curveTo(-1.8,-7,-0,-7).curveTo(1.9,-7,3.3,-6.1).curveTo(4.7,-5.3,5.6,-3.8).curveTo(6.4,-2.2,6.4,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(1.9,4.3,3.1,4).curveTo(4.2,3.7,5,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.2,7,0.8,7).curveTo(-1.4,7,-2.9,6.1).closePath().moveTo(3.5,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0.1,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.2,-2.8,-3.4,-1.3).lineTo(3.5,-1.3).lineTo(3.5,-1.3).closePath();
	this.shape.setTransform(62.85,15.475);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#003781").beginStroke().moveTo(-1.3,7.6).curveTo(-2.4,6.5,-2.4,4.4).lineTo(-2.4,-2.1).lineTo(-4.2,-2.1).lineTo(-4.2,-4.9).lineTo(-2.4,-4.9).lineTo(-2.4,-8.1).lineTo(0.5,-8.6).lineTo(0.5,-4.9).lineTo(4.1,-4.9).lineTo(4.1,-2.1).lineTo(0.5,-2.1).lineTo(0.5,4).curveTo(0.5,6,2.3,6).curveTo(3,6,3.8,5.6).lineTo(4.2,8.2).curveTo(3.1,8.7,1.7,8.7).curveTo(-0.3,8.6,-1.3,7.6).closePath();
	this.shape_1.setTransform(50.775,13.65);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#003781").beginStroke().moveTo(-5.1,6).lineTo(-4.3,3.3).curveTo(-2.6,4.3,-0.6,4.3).curveTo(0.7,4.3,1.4,3.9).curveTo(2.2,3.5,2.1,2.8).curveTo(2.2,2.2,1.5,1.9).curveTo(1,1.6,-0.3,1.2).lineTo(-2.6,0.5).curveTo(-3.5,0.1,-4.1,-0.8).curveTo(-4.8,-1.6,-4.8,-3).curveTo(-4.8,-4.9,-3.4,-6).curveTo(-2.2,-7,0.2,-7).curveTo(1.4,-7,2.6,-6.7).curveTo(3.6,-6.5,4.6,-6.1).lineTo(3.8,-3.5).curveTo(2.2,-4.4,0.3,-4.4).curveTo(-0.8,-4.4,-1.3,-4).curveTo(-1.9,-3.7,-1.8,-3).curveTo(-1.9,-2.3,-1.2,-2).curveTo(-0.6,-1.7,0.8,-1.3).curveTo(2.1,-0.9,3,-0.5).curveTo(3.8,-0.2,4.5,0.6).curveTo(5,1.4,5,2.7).curveTo(5,4.7,3.6,5.9).curveTo(2.1,7,-0.6,7).curveTo(-3.1,7,-5.1,6).closePath();
	this.shape_2.setTransform(40.25,15.475);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#003781").beginStroke().moveTo(3.1,6.8).lineTo(3.1,-0.4).curveTo(3.1,-2.3,2.3,-3.2).curveTo(1.6,-4.1,0.1,-4.1).curveTo(-1.4,-4.1,-2.3,-3.2).curveTo(-3.1,-2.2,-3.1,-0.5).lineTo(-3.1,6.8).lineTo(-6,6.8).lineTo(-6,-6.6).lineTo(-3.3,-6.6).lineTo(-3.3,-4.5).curveTo(-2.7,-5.7,-1.6,-6.2).curveTo(-0.4,-6.8,0.9,-6.8).curveTo(3.3,-6.8,4.7,-5.3).curveTo(6,-3.7,6,-1).lineTo(6,6.8).closePath();
	this.shape_3.setTransform(26.875,15.325);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#003781").beginStroke().moveTo(-3,6.1).curveTo(-4.5,5.3,-5.5,3.7).curveTo(-6.3,2.1,-6.4,-0).curveTo(-6.3,-2.1,-5.6,-3.6).curveTo(-4.7,-5.2,-3.3,-6.1).curveTo(-1.8,-7,0,-7).curveTo(1.8,-7,3.3,-6.1).curveTo(4.8,-5.3,5.6,-3.8).curveTo(6.3,-2.2,6.3,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(1.9,4.3,3.1,4).curveTo(4.2,3.7,5,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.2,7,0.7,7).curveTo(-1.3,7,-3,6.1).closePath().moveTo(3.4,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.1,-2.8,-3.4,-1.3).lineTo(3.4,-1.3).lineTo(3.4,-1.3).closePath();
	this.shape_4.setTransform(11.6,15.475);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#003781").beginStroke().moveTo(3.1,6.7).lineTo(-0,-2.9).lineTo(-3.2,6.7).lineTo(-6.5,6.7).lineTo(-10.4,-6.7).lineTo(-7.5,-6.7).lineTo(-4.8,3.2).lineTo(-1.5,-6.7).lineTo(1.5,-6.7).lineTo(4.8,3.2).lineTo(7.5,-6.7).lineTo(10.4,-6.7).lineTo(6.5,6.7).closePath();
	this.shape_5.setTransform(-6.425,15.45);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#003781").beginStroke().moveTo(-3,6.1).curveTo(-4.6,5.3,-5.4,3.7).curveTo(-6.3,2.1,-6.3,-0).curveTo(-6.3,-2.1,-5.5,-3.6).curveTo(-4.8,-5.2,-3.3,-6.1).curveTo(-1.8,-7,-0,-7).curveTo(1.9,-7,3.3,-6.1).curveTo(4.7,-5.3,5.6,-3.8).curveTo(6.3,-2.2,6.4,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.1,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(2,4.3,3.1,4).curveTo(4.2,3.7,5,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.3,7,0.8,7).curveTo(-1.3,7,-3,6.1).closePath().moveTo(3.5,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0.1,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.1,-2.8,-3.4,-1.3).lineTo(3.5,-1.3).lineTo(3.5,-1.3).closePath();
	this.shape_6.setTransform(-24.55,15.475);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#003781").beginStroke().moveTo(-5.9,8.1).lineTo(-5.1,5.6).curveTo(-4.2,6.1,-3,6.4).curveTo(-1.9,6.7,-0.7,6.7).curveTo(1.5,6.7,2.7,5.7).curveTo(3.7,4.6,3.8,2.5).lineTo(3.8,1.9).curveTo(2.1,4,-0.6,4).curveTo(-2.3,4,-3.7,3.1).curveTo(-5.1,2.3,-5.9,0.7).curveTo(-6.6,-0.8,-6.7,-2.7).curveTo(-6.6,-4.7,-5.9,-6.2).curveTo(-5.1,-7.7,-3.7,-8.5).curveTo(-2.3,-9.4,-0.6,-9.4).curveTo(2.3,-9.4,3.9,-7.1).lineTo(3.9,-9.2).lineTo(6.6,-9.2).lineTo(6.6,2.7).curveTo(6.7,6,4.8,7.7).curveTo(2.9,9.4,-0.6,9.4).curveTo(-3.5,9.4,-5.9,8.1).closePath().moveTo(-2.7,-5.6).curveTo(-3.8,-4.5,-3.8,-2.7).curveTo(-3.8,-1,-2.7,0.2).curveTo(-1.6,1.2,0.1,1.3).curveTo(1.8,1.3,2.8,0.2).curveTo(3.8,-0.9,3.8,-2.7).curveTo(3.8,-4.5,2.8,-5.7).curveTo(1.8,-6.8,0.1,-6.7).curveTo(-1.6,-6.7,-2.7,-5.6).closePath();
	this.shape_7.setTransform(-40.4,17.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#003781").beginStroke().moveTo(3.1,6.8).lineTo(3.1,-0.4).curveTo(3.1,-2.3,2.3,-3.2).curveTo(1.6,-4.1,0.1,-4.1).curveTo(-1.4,-4.1,-2.3,-3.2).curveTo(-3.1,-2.2,-3.1,-0.5).lineTo(-3.1,6.8).lineTo(-6,6.8).lineTo(-6,-6.6).lineTo(-3.3,-6.6).lineTo(-3.3,-4.5).curveTo(-2.7,-5.7,-1.6,-6.2).curveTo(-0.4,-6.8,0.9,-6.8).curveTo(3.3,-6.8,4.7,-5.3).curveTo(6,-3.7,6,-1).lineTo(6,6.8).closePath();
	this.shape_8.setTransform(-55.625,15.325);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#003781").beginStroke().moveTo(-3.5,6.1).curveTo(-5.1,5.2,-5.9,3.6).curveTo(-6.8,2,-6.8,-0).curveTo(-6.8,-2.1,-5.9,-3.6).curveTo(-5.1,-5.2,-3.5,-6.1).curveTo(-2,-7,-0,-7).curveTo(2,-7,3.5,-6.1).curveTo(5,-5.2,5.9,-3.6).curveTo(6.8,-2.1,6.8,-0).curveTo(6.8,2,5.9,3.6).curveTo(5,5.2,3.5,6.1).curveTo(2,7,-0,7).curveTo(-2,7,-3.5,6.1).closePath().moveTo(-2.8,-3.1).curveTo(-3.9,-1.9,-3.9,-0).curveTo(-3.9,1.9,-2.8,3).curveTo(-1.7,4.2,-0,4.2).curveTo(1.7,4.2,2.8,3).curveTo(3.8,1.9,3.8,-0).curveTo(3.8,-1.9,2.8,-3.1).curveTo(1.7,-4.2,-0,-4.2).curveTo(-1.7,-4.2,-2.8,-3.1).closePath();
	this.shape_9.setTransform(-71.275,15.475);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#003781").beginStroke().moveTo(3.1,6.8).lineTo(3.1,-0.4).curveTo(3.1,-2.3,2.3,-3.2).curveTo(1.6,-4.1,0.1,-4.1).curveTo(-1.4,-4.1,-2.3,-3.2).curveTo(-3.1,-2.2,-3.1,-0.5).lineTo(-3.1,6.8).lineTo(-6,6.8).lineTo(-6,-6.6).lineTo(-3.3,-6.6).lineTo(-3.3,-4.5).curveTo(-2.7,-5.7,-1.6,-6.2).curveTo(-0.4,-6.8,0.9,-6.8).curveTo(3.3,-6.8,4.7,-5.3).curveTo(6,-3.7,6,-1).lineTo(6,6.8).closePath();
	this.shape_10.setTransform(-92.825,15.325);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("#003781").beginStroke().moveTo(-3.7,6.1).curveTo(-5.1,5.2,-5.9,3.6).curveTo(-6.7,2,-6.6,0).curveTo(-6.6,-2.1,-5.8,-3.6).curveTo(-5.1,-5.2,-3.7,-6.1).curveTo(-2.3,-7,-0.6,-7).curveTo(2.3,-7,3.9,-4.6).lineTo(3.9,-6.7).lineTo(6.6,-6.7).lineTo(6.6,6.7).lineTo(3.9,6.7).lineTo(3.9,4.7).curveTo(2.3,7,-0.6,7).curveTo(-2.3,7,-3.7,6.1).closePath().moveTo(-2.7,-3).curveTo(-3.7,-1.9,-3.7,0).curveTo(-3.7,1.9,-2.7,3.1).curveTo(-1.6,4.3,0.1,4.3).curveTo(1.8,4.3,2.8,3.1).curveTo(3.7,1.9,3.7,0).curveTo(3.7,-2,2.8,-3.1).curveTo(1.8,-4.2,0.1,-4.2).curveTo(-1.6,-4.2,-2.7,-3).closePath();
	this.shape_11.setTransform(-109.3,15.45);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#003781").beginStroke().moveTo(-1.5,6.7).lineTo(-6.9,-6.7).lineTo(-3.8,-6.7).lineTo(-0,3.4).lineTo(3.8,-6.7).lineTo(6.9,-6.7).lineTo(1.5,6.7).closePath();
	this.shape_12.setTransform(-123.925,15.45);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#003781").beginStroke().moveTo(-3.7,9.1).curveTo(-5.1,8.2,-5.9,6.7).curveTo(-6.6,5,-6.6,3).curveTo(-6.7,1,-5.8,-0.6).curveTo(-5.1,-2.2,-3.7,-3.1).curveTo(-2.3,-3.9,-0.5,-3.9).curveTo(2.1,-4,3.7,-1.9).lineTo(3.7,-10).lineTo(6.7,-10).lineTo(6.7,9.7).lineTo(4,9.7).lineTo(4,7.7).curveTo(2.3,9.9,-0.5,9.9).curveTo(-2.3,10,-3.7,9.1).closePath().moveTo(-2.7,-0.1).curveTo(-3.8,1.2,-3.8,3).curveTo(-3.8,4.9,-2.7,6.1).curveTo(-1.6,7.2,0.1,7.2).curveTo(1.8,7.2,2.8,6.1).curveTo(3.8,5,3.7,3).curveTo(3.8,1.1,2.8,-0.1).curveTo(1.8,-1.2,0.1,-1.2).curveTo(-1.6,-1.2,-2.7,-0.1).closePath();
	this.shape.setTransform(-3.8,-16.85);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#003781").beginStroke().moveTo(-3.7,6.1).curveTo(-5.1,5.2,-5.9,3.7).curveTo(-6.7,2,-6.7,-0).curveTo(-6.6,-2,-5.9,-3.6).curveTo(-5.1,-5.2,-3.7,-6.1).curveTo(-2.3,-6.9,-0.6,-6.9).curveTo(2.3,-6.9,3.9,-4.7).lineTo(3.9,-6.7).lineTo(6.6,-6.7).lineTo(6.6,6.7).lineTo(3.9,6.7).lineTo(3.9,4.7).curveTo(2.3,6.9,-0.6,6.9).curveTo(-2.3,7,-3.7,6.1).closePath().moveTo(-2.7,-3.1).curveTo(-3.7,-1.8,-3.7,-0).curveTo(-3.7,1.9,-2.7,3.1).curveTo(-1.6,4.2,0.1,4.2).curveTo(1.8,4.2,2.8,3.1).curveTo(3.7,2,3.7,-0).curveTo(3.7,-1.9,2.8,-3.1).curveTo(1.8,-4.2,0.1,-4.2).curveTo(-1.6,-4.2,-2.7,-3.1).closePath();
	this.shape_1.setTransform(-19.95,-13.85);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#003781").beginStroke().moveTo(3.1,9.8).lineTo(3.1,2.6).curveTo(3.1,0.7,2.3,-0.2).curveTo(1.6,-1.1,0.1,-1.1).curveTo(-1.4,-1.1,-2.3,-0.2).curveTo(-3.1,0.8,-3.1,2.5).lineTo(-3.1,9.8).lineTo(-6,9.8).lineTo(-6,-9.8).lineTo(-3.1,-9.8).lineTo(-3.1,-1.8).curveTo(-2.4,-2.8,-1.4,-3.3).curveTo(-0.3,-3.8,0.9,-3.8).curveTo(3.3,-3.8,4.7,-2.3).curveTo(6,-0.7,6,2).lineTo(6,9.8).closePath();
	this.shape_2.setTransform(-35.175,-16.975);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#003781").beginStroke().moveTo(-2.9,6.1).curveTo(-4.6,5.3,-5.4,3.7).curveTo(-6.4,2.1,-6.3,-0).curveTo(-6.4,-2.1,-5.5,-3.6).curveTo(-4.8,-5.2,-3.3,-6.1).curveTo(-1.8,-7,-0,-7).curveTo(1.9,-7,3.3,-6.1).curveTo(4.8,-5.3,5.5,-3.8).curveTo(6.4,-2.2,6.3,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(1.9,4.3,3.1,4).curveTo(4.2,3.7,5.1,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.2,7,0.8,7).curveTo(-1.4,7,-2.9,6.1).closePath().moveTo(3.5,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.2,-2.8,-3.4,-1.3).lineTo(3.5,-1.3).lineTo(3.5,-1.3).closePath();
	this.shape_3.setTransform(-50.45,-13.825);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#003781").beginStroke().moveTo(-5.9,8.1).lineTo(-5.1,5.5).curveTo(-4.2,6.1,-3,6.4).curveTo(-1.9,6.7,-0.8,6.7).curveTo(1.5,6.7,2.7,5.6).curveTo(3.8,4.6,3.7,2.6).lineTo(3.7,1.9).curveTo(2.1,4,-0.6,4).curveTo(-2.3,4,-3.7,3.1).curveTo(-5.1,2.2,-5.9,0.8).curveTo(-6.6,-0.7,-6.7,-2.7).curveTo(-6.6,-4.7,-5.9,-6.2).curveTo(-5.1,-7.7,-3.7,-8.6).curveTo(-2.3,-9.4,-0.6,-9.4).curveTo(2.3,-9.4,3.9,-7.1).lineTo(3.9,-9.1).lineTo(6.6,-9.1).lineTo(6.6,2.8).curveTo(6.6,5.9,4.8,7.6).curveTo(2.9,9.4,-0.6,9.4).curveTo(-3.4,9.4,-5.9,8.1).closePath().moveTo(-2.7,-5.6).curveTo(-3.7,-4.5,-3.7,-2.7).curveTo(-3.7,-0.9,-2.7,0.1).curveTo(-1.6,1.3,0.1,1.2).curveTo(1.8,1.2,2.8,0.2).curveTo(3.7,-0.9,3.7,-2.7).curveTo(3.7,-4.6,2.8,-5.6).curveTo(1.8,-6.8,0.1,-6.8).curveTo(-1.6,-6.8,-2.7,-5.6).closePath();
	this.shape_4.setTransform(-66.3,-11.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#003781").beginStroke().moveTo(-1.3,7.5).curveTo(-2.4,6.4,-2.4,4.5).lineTo(-2.4,-2.2).lineTo(-4.2,-2.2).lineTo(-4.2,-4.9).lineTo(-2.4,-4.9).lineTo(-2.4,-8.1).lineTo(0.5,-8.7).lineTo(0.5,-4.9).lineTo(4.1,-4.9).lineTo(4.1,-2.2).lineTo(0.5,-2.2).lineTo(0.5,4).curveTo(0.5,5.9,2.3,5.9).curveTo(3,5.9,3.8,5.7).lineTo(4.2,8.3).curveTo(3.1,8.6,1.7,8.6).curveTo(-0.3,8.7,-1.3,7.5).closePath();
	this.shape_5.setTransform(-84.875,-15.65);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#003781").beginStroke().moveTo(-5,6).lineTo(-4.3,3.3).curveTo(-2.6,4.3,-0.5,4.3).curveTo(0.7,4.3,1.4,3.9).curveTo(2.2,3.5,2.2,2.8).curveTo(2.2,2.2,1.5,1.9).curveTo(1,1.6,-0.3,1.2).lineTo(-2.6,0.5).curveTo(-3.5,0.1,-4.1,-0.8).curveTo(-4.7,-1.6,-4.8,-3).curveTo(-4.7,-4.9,-3.4,-6).curveTo(-2.1,-7,0.3,-7).curveTo(1.4,-7,2.5,-6.7).curveTo(3.6,-6.5,4.6,-6.1).lineTo(3.8,-3.5).curveTo(2.3,-4.4,0.3,-4.4).curveTo(-0.7,-4.4,-1.3,-4).curveTo(-1.9,-3.7,-1.9,-3).curveTo(-1.9,-2.3,-1.2,-2).curveTo(-0.6,-1.7,0.7,-1.3).curveTo(2.1,-0.9,3,-0.5).curveTo(3.8,-0.2,4.4,0.6).curveTo(5.1,1.4,5,2.7).curveTo(5.1,4.7,3.5,5.9).curveTo(2,7,-0.5,7).curveTo(-3.2,7,-5,6).closePath();
	this.shape_6.setTransform(-95.4,-13.825);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#003781").beginStroke().moveTo(-3.7,6.1).curveTo(-5.1,5.2,-5.9,3.7).curveTo(-6.7,2,-6.7,-0).curveTo(-6.6,-2,-5.9,-3.6).curveTo(-5.1,-5.2,-3.7,-6.1).curveTo(-2.3,-6.9,-0.6,-6.9).curveTo(2.3,-6.9,3.9,-4.7).lineTo(3.9,-6.7).lineTo(6.6,-6.7).lineTo(6.6,6.7).lineTo(3.9,6.7).lineTo(3.9,4.7).curveTo(2.3,6.9,-0.6,6.9).curveTo(-2.3,7,-3.7,6.1).closePath().moveTo(-2.7,-3.1).curveTo(-3.8,-1.8,-3.8,-0).curveTo(-3.8,1.9,-2.7,3.1).curveTo(-1.6,4.2,0.1,4.2).curveTo(1.8,4.2,2.8,3.1).curveTo(3.8,2,3.8,-0).curveTo(3.8,-1.9,2.8,-3.1).curveTo(1.8,-4.2,0.1,-4.2).curveTo(-1.6,-4.2,-2.7,-3.1).closePath();
	this.shape_7.setTransform(-109.7,-13.85);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#003781").beginStroke().moveTo(-5.6,9.4).lineTo(-5.6,-9.3).lineTo(-2.4,-9.3).lineTo(-2.4,6.4).lineTo(5.6,6.4).lineTo(5.6,9.4).closePath();
	this.shape_8.setTransform(-123.2,-16.5);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.moveTo(-81,16).lineTo(-81,-16).lineTo(81,-16).lineTo(81,16).closePath();
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-81,16).lineTo(-81,-16).lineTo(81,-16).lineTo(81,16).closePath();
...
if (reversed == null) { reversed = false; }
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.moveTo(-133,20).lineTo(-133,-16).lineTo(133,-16).lineTo(133,20).closePath();
	...
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	mask_2.graphics.moveTo(-144,20.5).lineTo(-144,-20.5).lineTo(144,-20.5).lineTo(144,20.5).closePath();
...
if (reversed == null) { reversed = false; }
	...
	this.copy1_2.setTransform(0,39.5);
	...
	this.copy1_3.setTransform(0,35);
...
}).prototype = getMCSymbolPrototype(lib.copy1, new cjs.Rectangle(-133,5.3,266,58.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1791.65,463.25,2.9999,2.9999,19.2486,0,0,-114,37.6);

	this.instance_1 = new lib.crowbar_front("synched",0);
	this.instance_1.setTransform(-358.7,115,2.9999,2.9999,-2.9509,0,0,-114,33);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:0,regY:0,scaleY:3,rotation:18.4717,x:-1373.6332,y:451.0065},0).wait(1).to({scaleY:2.9999,rotation:17.71,x:-1316.9053,y:432.8832},0).wait(1).to({rotation:16.9645,x:-1261.4385,y:415.1436},0).wait(1).to({scaleY:3,rotation:16.235,x:-1207.229,y:397.7887},0).wait(1).to({scaleY:2.9999,rotation:15.5216,x:-1154.2727,y:380.8189},0).wait(1).to({rotation:14.824,x:-1102.5367,y:364.2254},0).wait(1).to({rotation:14.1428,x:-1052.0757,y:348.0275},0).wait(1).to({scaleY:3,rotation:13.4774,x:-1002.8278,y:332.2068},0).wait(1).to({rotation:12.828,x:-954.8184,y:316.7729},0).wait(1).to({scaleY:2.9999,rotation:12.1944,x:-908.0152,y:301.7167},0).wait(1).to({rotation:11.5773,x:-862.4728,y:287.0571},0).wait(1).to({rotation:10.9759,x:-818.1299,y:272.7753},0).wait(1).to({rotation:10.3906,x:-775.0123,y:258.8809},0).wait(1).to({rotation:9.8218,x:-733.1458,y:245.3831},0).wait(1).to({scaleY:3,rotation:9.2683,x:-692.4405,y:232.2538},0).wait(1).to({scaleY:2.9999,rotation:8.7313,x:-652.9804,y:219.5209},0).wait(1).to({rotation:8.21,x:-614.7047,y:207.1656},0).wait(1).to({rotation:7.7053,x:-577.6685,y:195.2063},0).wait(1).to({rotation:7.2162,x:-541.8113,y:183.6242},0).wait(1).to({scaleY:3,rotation:6.7432,x:-507.1595,y:172.4283},0).wait(1).to({scaleY:2.9999,rotation:6.286,x:-473.6818,y:161.609},0).wait(1).to({scaleY:3,rotation:5.8453,x:-441.4332,y:151.1846},0).wait(1).to({scaleY:2.9999,rotation:5.4202,x:-410.3541,y:141.1362},0).wait(1).to({scaleY:3,rotation:5.0117,x:-380.4996,y:131.482},0).wait(1).to({scaleY:2.9999,rotation:4.6189,x:-351.8101,y:122.203},0).wait(1).to({scaleY:3,rotation:4.2418,x:-324.2837,y:113.299},0).wait(1).to({rotation:3.8812,x:-297.9757,y:104.7881},0).wait(1).to({scaleY:2.9999,rotation:3.5363,x:-272.827,y:96.6513},0).wait(1).to({scaleY:3,rotation:3.2079,x:-248.893,y:88.9068},0).wait(1).to({rotation:2.8952,x:-226.1148,y:81.5358},0).wait(1).to({scaleY:2.9999,rotation:2.5986,x:-204.5194,y:74.547},0).wait(1).to({scaleY:3,rotation:2.3177,x:-184.0767,y:67.931},0).wait(1).to({rotation:2.0534,x:-164.8424,y:61.7057},0).wait(1).to({scaleY:2.9999,rotation:1.8047,x:-146.758,y:55.8524},0).wait(1).to({scaleY:3,rotation:1.5722,x:-129.8509,y:50.3799},0).wait(1).to({scaleX:3,rotation:1.3557,x:-114.1198,y:45.288},0).wait(1).to({scaleX:2.9999,scaleY:2.9999,rotation:1.1554,x:-99.5636,y:40.5763},0).wait(1).to({rotation:0.9711,x:-86.1814,y:36.2445},0).wait(1).to({rotation:0.8026,x:-73.9436,y:32.2832},0).wait(1).to({rotation:0.6506,x:-62.9065,y:28.7104},0).wait(1).to({scaleY:3,rotation:0.5143,x:-53.0122,y:25.5076},0).wait(1).to({rotation:0.3941,x:-44.2886,y:22.6838},0).wait(1).to({rotation:0.2896,x:-36.7065,y:20.2295},0).wait(1).to({scaleY:2.9999,rotation:0.2016,x:-30.3226,y:18.1629},0).wait(1).to({rotation:0.1293,x:-25.0792,y:16.4657},0).wait(1).to({rotation:0.0731,x:-21.0045,y:15.1467},0).wait(1).to({rotation:0.0331,x:-18.0983,y:14.2059},0).wait(1).to({rotation:0.0091,x:-16.3604,y:13.6434},0).wait(1).to({rotation:0.0009,x:-15.7621,y:13.4497},0).wait(1).to({regX:-113.9,regY:37.7,scaleX:2.9998,rotation:-0.0828,x:-358.05,y:125.9},0).wait(1).to({regX:0,regY:0,scaleX:2.9999,rotation:-0.203,x:-16.734,y:11.582},0).wait(1).to({scaleY:3,rotation:-0.3225,x:-16.9731,y:10.8704},0).wait(1).to({rotation:-0.442,x:-17.2138,y:10.1594},0).wait(1).to({scaleX:3,rotation:-0.5615,x:-17.4559,y:9.4488},0).wait(1).to({scaleX:2.9999,rotation:-0.681,x:-17.6995,y:8.7388},0).wait(1).to({scaleY:2.9999,rotation:-0.8005,x:-17.9446,y:8.0292},0).wait(1).to({rotation:-0.92,x:-18.1911,y:7.3202},0).wait(1).to({rotation:-1.0395,x:-18.4392,y:6.6117},0).wait(1).to({scaleX:3,scaleY:3,rotation:-1.159,x:-18.6887,y:5.9037},0).wait(1).to({rotation:-1.2785,x:-18.9397,y:5.1962},0).wait(1).to({scaleX:2.9999,rotation:-1.398,x:-19.1921,y:4.4892},0).wait(1).to({rotation:-1.5175,x:-19.4461,y:3.7828},0).wait(1).to({scaleY:2.9999,rotation:-1.637,x:-19.7015,y:3.0769},0).wait(1).to({rotation:-1.7565,x:-19.9584,y:2.3716},0).wait(1).to({rotation:-1.876,x:-20.2167,y:1.6668},0).wait(1).to({scaleY:3,rotation:-1.9955,x:-20.4765,y:0.9625},0).wait(1).to({rotation:-2.115,x:-20.7378,y:0.2587},0).wait(1).to({rotation:-2.2345,x:-21.0006,y:-0.4445},0).wait(1).to({scaleX:3,rotation:-2.354,x:-21.2648,y:-1.1471},0).wait(1).to({scaleX:2.9999,rotation:-2.4735,x:-21.5305,y:-1.8492},0).wait(1).to({scaleY:2.9999,rotation:-2.593,x:-21.7977,y:-2.5507},0).wait(1).to({rotation:-2.7125,x:-22.0663,y:-3.2517},0).wait(1).to({rotation:-2.832,x:-22.3364,y:-3.9521},0).to({_off:true},1).wait(86).to({_off:false,regX:-104.2,regY:40.2,scaleX:2.8913,scaleY:2.8914,rotation:30.7473,x:-310.35,y:160.15},0).wait(1).to({regX:0,regY:0,scaleX:2.8914,scaleY:2.8915,rotation:30.4754,x:11.8356,y:213.3625},0).wait(1).to({scaleX:2.8913,rotation:30.2032,x:15.6597,y:213.7126},0).wait(1).to({rotation:29.9309,x:19.4766,y:215.312},0).wait(1).to({scaleX:2.8914,rotation:29.6587,x:23.2864,y:218.1608},0).wait(1).to({scaleX:2.8913,scaleY:2.8914,rotation:29.3865,x:27.0889,y:222.243},0).wait(1).to({scaleX:2.8914,scaleY:2.8915,rotation:29.1143,x:30.8842,y:227.5747},0).wait(1).to({scaleX:2.8913,rotation:28.8421,x:34.6723,y:234.1559},0).wait(1).to({scaleY:2.8914,rotation:28.5699,x:38.4532,y:241.9786},0).wait(1).to({scaleX:2.8914,scaleY:2.8915,rotation:28.2976,x:42.2269,y:251.0429},0).wait(1).to({scaleX:2.8913,scaleY:2.8914,rotation:28.0254,x:45.9933,y:261.3488},0).wait(1).to({scaleX:2.8914,scaleY:2.8915,rotation:27.7532,x:49.7525,y:272.9044},0).wait(1).to({rotation:27.481,x:53.5044,y:285.7095},0).wait(1).to({scaleX:2.8913,rotation:27.2088,x:57.2492,y:299.7485},0).wait(1).to({scaleX:2.8914,rotation:26.9366,x:60.9866,y:315.0451},0).wait(1).to({scaleX:2.8913,rotation:26.6643,x:64.7169,y:331.5755},0).wait(1).to({scaleX:2.8914,rotation:26.3921,x:68.4398,y:349.3557},0).wait(1).to({rotation:26.1199,x:72.1555,y:368.3778},0).wait(1).to({scaleX:2.8913,scaleY:2.8914,rotation:25.8477,x:75.864,y:388.6497},0).wait(1).to({scaleX:2.8914,scaleY:2.8915,rotation:25.5755,x:79.5652,y:410.1636},0).wait(1).to({scaleX:2.8913,rotation:25.3032,x:83.2591,y:432.9194},0).wait(1).to({scaleY:2.8914,rotation:25.031,x:86.9458,y:456.9252},0).wait(1).to({scaleX:2.8914,scaleY:2.8915,rotation:24.7588,x:90.6252,y:482.173},0).wait(1).to({scaleX:2.8913,rotation:24.4866,x:94.2973,y:508.6708},0).wait(1).to({scaleX:2.8914,rotation:24.2144,x:97.9622,y:536.4107},0).wait(1).to({rotation:23.9422,x:101.6198,y:565.3928},0).wait(1).to({scaleX:2.8913,scaleY:2.8914,rotation:23.6699,x:105.2701,y:595.617},0).wait(1).to({scaleY:2.8915,rotation:23.3977,x:108.9131,y:627.0993},0).wait(1).to({scaleX:2.8914,rotation:23.1255,x:112.5488,y:581.2501},0).wait(1).to({scaleX:2.8913,scaleY:2.8914,rotation:22.8533,x:116.1773,y:542.2265},0).wait(1).to({scaleX:2.8914,scaleY:2.8915,rotation:22.5811,x:119.7984,y:510.0126},0).wait(1).to({rotation:22.3089,x:123.4123,y:484.6245},0).wait(1).to({scaleX:2.8913,rotation:22.0366,x:127.0189,y:466.0463},0).wait(1).to({scaleX:2.8914,rotation:21.7644,x:130.6183,y:454.2859},0).wait(1).to({rotation:21.4922,x:134.2103,y:449.3434},0).wait(1).to({scaleX:2.8913,rotation:21.22,x:137.795,y:451.2188},0).wait(1).to({scaleX:2.8914,rotation:20.9478,x:141.3725,y:459.9122},0).wait(1).to({rotation:20.6756,x:144.9427,y:475.4235},0).wait(1).to({scaleX:2.8913,rotation:20.4033,x:148.5056,y:497.7449},0).wait(1).to({scaleX:2.8914,rotation:20.1311,x:152.0612,y:526.8923},0).wait(1).to({scaleX:2.8913,rotation:19.8589,x:155.6095,y:562.8499},0).wait(1).to({scaleX:2.8914,rotation:19.5867,x:159.1505,y:605.6335},0).wait(1).to({rotation:19.3145,x:162.6843,y:579.8235},0).wait(1).to({scaleX:2.8913,rotation:19.0422,x:166.2108,y:560.083},0).wait(1).to({scaleX:2.8914,rotation:18.77,x:169.73,y:546.42},0).wait(1).to({rotation:18.4978,x:173.2419,y:538.8185},0).wait(1).to({scaleX:2.8913,scaleY:2.8914,rotation:18.2256,x:176.7465,y:537.2867},0).wait(1).to({scaleX:2.8914,scaleY:2.8915,rotation:17.9534,x:180.2438,y:541.8245},0).wait(1).to({rotation:17.6812,x:183.7339,y:552.424},0).wait(1).to({scaleX:2.8913,rotation:17.4089,x:187.2167,y:569.1012},0).wait(1).to({rotation:17.1367,x:190.6923,y:591.8481},0).wait(1).to({scaleX:2.8914,rotation:16.8645,x:194.1605,y:579.2472},0).wait(1).to({scaleX:2.8913,scaleY:2.8914,rotation:16.5923,x:197.6215,y:570.3346},0).wait(1).to({scaleX:2.8914,scaleY:2.8915,rotation:16.3201,x:201.0753,y:565.1183},0).wait(1).to({rotation:16.0479,x:204.5217,y:563.5904},0).wait(1).to({scaleX:2.8913,rotation:15.7756,x:207.9609,y:565.7508},0).wait(1).to({rotation:15.5034,x:211.3929,y:571.6077},0).wait(1).to({scaleX:2.8914,rotation:15.2312,x:214.8176,y:581.153},0).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(74).to({_off:false},0).wait(1).to({regX:0,regY:0,scaleX:2.9762,scaleY:2.9762,rotation:-2.8777,x:-24.5065,y:-0.1773},0).wait(1).to({scaleX:2.9535,scaleY:2.9535,rotation:-2.6503,x:-25.8257,y:1.7907},0).wait(1).to({scaleX:2.9319,scaleY:2.932,rotation:-2.256,x:-26.2263,y:4.5192},0).wait(1).to({scaleX:2.9113,scaleY:2.9113,rotation:-1.6875,x:-25.7451,y:8.0454},0).wait(1).to({scaleX:2.8916,scaleY:2.8917,rotation:-0.9329,x:-24.4136,y:12.4334},0).wait(1).to({scaleX:2.8729,scaleY:2.873,rotation:0.0196,x:-22.2882,y:17.754},0).wait(1).to({scaleX:2.8552,scaleY:2.8552,rotation:1.1773,x:-19.451,y:24.0569},0).wait(1).to({scaleX:2.8382,scaleY:2.8382,rotation:2.5506,x:-15.9946,y:31.4113},0).wait(1).to({scaleX:2.8221,scaleY:2.8222,rotation:4.1425,x:-12.039,y:39.8456},0).wait(1).to({scaleX:2.8068,scaleY:2.8069,rotation:5.9529,x:-7.7277,y:49.3731},0).wait(1).to({scaleX:2.7922,scaleY:2.7923,rotation:7.9789,x:-3.2213,y:59.988},0).wait(1).to({scaleX:2.7785,scaleY:2.7786,rotation:10.2072,x:1.3062,y:71.6206},0).wait(1).to({scaleX:2.7654,scaleY:2.7655,rotation:12.6157,x:5.6659,y:84.1465},0).wait(1).to({scaleX:2.753,scaleY:2.7531,rotation:15.1748,x:9.6885,y:97.3901},0).wait(1).to({scaleX:2.7412,scaleY:2.7413,rotation:17.8432,x:13.2228,y:111.1038},0).wait(1).to({scaleX:2.7299,scaleY:2.73,rotation:20.5736,x:16.1697,y:125.0012},0).wait(1).to({scaleX:2.7194,scaleY:2.7194,rotation:23.3143,x:18.4723,y:138.7761},0).wait(1).to({scaleX:2.7092,scaleY:2.7093,rotation:26.0137,x:20.1398,y:152.1271},0).wait(1).to({scaleX:2.6997,scaleY:2.6997,rotation:28.6215,x:21.2229,y:164.7776},0).wait(1).to({scaleX:2.6906,scaleY:2.6907,rotation:31.0964,x:21.8176,y:176.5142},0).wait(1).to({scaleX:2.6819,scaleY:2.682,rotation:33.406,x:22.0293,y:187.19},0).wait(1).to({scaleX:2.6736,scaleY:2.6737,rotation:35.5265,x:21.9712,y:196.7183},0).wait(1).to({scaleX:2.6656,scaleY:2.6657,rotation:37.4417,x:21.7436,y:205.063},0).wait(1).to({scaleX:2.6581,scaleY:2.6582,rotation:39.1473,x:21.4249,y:212.2536},0).wait(1).to({scaleX:2.6508,scaleY:2.6509,rotation:40.6388,x:21.0835,y:218.322},0).wait(1).to({scaleX:2.6438,scaleY:2.6439,rotation:41.9235,x:20.7455,y:223.3553},0).wait(1).to({scaleX:2.637,scaleY:2.6371,rotation:43.0059,x:20.4293,y:227.4246},0).wait(1).to({scaleX:2.6305,scaleY:2.6306,rotation:43.8948,x:20.1378,y:230.6119},0).wait(1).to({scaleX:2.624,scaleY:2.6241,rotation:44.5992,x:19.8566,y:232.9966},0).wait(1).to({scaleX:2.6178,scaleY:2.6179,rotation:45.1294,x:19.5609,y:234.6565},0).wait(1).to({scaleX:2.6116,scaleY:2.6117,rotation:45.4956,x:19.2165,y:235.6638},0).wait(1).to({scaleX:2.6055,scaleY:2.6056,rotation:45.7097,x:18.7879,y:236.0904},0).wait(1).to({scaleX:2.5994,scaleY:2.5995,rotation:45.7791,x:18.236,y:235.9833},0).wait(1).to({regX:-111.8,regY:38.2,scaleX:2.5827,scaleY:2.5828,rotation:45.2621,x:-254.15,y:93.1},0).wait(1).to({regX:0,regY:0,rotation:44.8868,x:20.2538,y:226.9607},0).wait(1).to({rotation:44.512,x:21.2896,y:225.1648},0).wait(1).to({rotation:44.1373,x:22.3137,y:223.3633},0).wait(1).to({rotation:43.7625,x:23.326,y:221.5562},0).wait(1).to({rotation:43.3877,x:24.3265,y:219.7436},0).wait(1).to({rotation:43.0129,x:25.315,y:217.9255},0).wait(1).to({rotation:42.6381,x:26.2917,y:216.1022},0).wait(1).to({rotation:42.2633,x:27.2564,y:214.2736},0).wait(1).to({rotation:41.8886,x:28.2092,y:212.4398},0).wait(1).to({rotation:41.5138,x:29.1499,y:210.6009},0).wait(1).to({rotation:41.139,x:30.0786,y:208.757},0).wait(1).to({regX:-109.9,regY:41.2,scaleX:2.5826,rotation:41.7128,x:-253.05,y:101.2},0).wait(1).to({regX:0,regY:0,scaleX:2.5827,rotation:43.2097,x:33.5605,y:218.914},0).wait(1).to({rotation:44.5765,x:39.6008,y:226.8067},0).wait(1).to({rotation:45.8146,x:47.4888,y:234.2558},0).wait(1).to({rotation:46.9225,x:56.771,y:241.1991},0).wait(1).to({rotation:47.9017,x:66.8947,y:247.5768},0).wait(1).to({rotation:48.7515,x:77.2114,y:253.3034},0).wait(1).to({rotation:49.471,x:87.0772,y:258.2935},0).wait(1).to({rotation:50.0618,x:95.8901,y:262.4786},0).wait(1).to({rotation:50.5224,x:103.1568,y:265.7888},0).wait(1).to({rotation:50.8543,x:108.5378,y:268.19},0).wait(1).to({scaleY:2.5829,rotation:51.0559,x:111.8201,y:269.6488},0).wait(1).to({scaleY:2.5828,rotation:51.1289,x:112.9097,y:270.1625},0).wait(1).to({regX:-109.9,regY:41,scaleX:2.5825,scaleY:2.5826,x:-147.85,y:116.15},0).wait(5).to({regX:-106.2,regY:43.1,scaleX:2.5827,scaleY:2.5828,rotation:50.9673,x:-145.05,y:128.15},0).wait(1).to({regX:0,regY:0,scaleX:2.5836,scaleY:2.5837,rotation:50.9038,x:113.8219,y:270.9978},0).wait(1).to({scaleX:2.5865,scaleY:2.5866,rotation:50.7059,x:112.7657,y:270.6737},0).wait(1).to({scaleX:2.5914,scaleY:2.5915,rotation:50.3615,x:110.8906,y:270.1083},0).wait(1).to({scaleX:2.5987,scaleY:2.5988,rotation:49.8571,x:108.1203,y:269.2628},0).wait(1).to({scaleX:2.6084,scaleY:2.6085,rotation:49.1819,x:104.3452,y:268.1044},0).wait(1).to({scaleX:2.6207,scaleY:2.6209,rotation:48.3233,x:99.4888,y:266.575},0).wait(1).to({scaleX:2.6359,scaleY:2.636,rotation:47.2746,x:93.5085,y:264.6129},0).wait(1).to({scaleX:2.6537,scaleY:2.6538,rotation:46.0338,x:86.4146,y:262.1471},0).wait(1).to({scaleX:2.6742,scaleY:2.6743,rotation:44.6087,x:78.3428,y:259.1},0).wait(1).to({scaleX:2.697,scaleY:2.6971,rotation:43.0236,x:69.5412,y:255.4236},0).wait(1).to({scaleX:2.7215,scaleY:2.7217,rotation:41.32,x:60.3858,y:251.1163},0).wait(1).to({scaleX:2.7469,scaleY:2.747,rotation:39.5573,x:51.3212,y:246.2559},0).wait(1).to({scaleX:2.7721,scaleY:2.7722,rotation:37.8101,x:42.7864,y:241.0281},0).wait(1).to({scaleX:2.7959,scaleY:2.796,rotation:36.1571,x:35.0862,y:235.7177},0).wait(1).to({scaleX:2.8173,scaleY:2.8174,rotation:34.666,x:28.4281,y:230.6331},0).wait(1).to({scaleX:2.8357,scaleY:2.8358,rotation:33.3864,x:22.892,y:226.058},0).wait(1).to({scaleX:2.8507,scaleY:2.8508,rotation:32.3464,x:18.5005,y:222.2002},0).wait(1).to({scaleX:2.8621,scaleY:2.8622,rotation:31.5558,x:15.2107,y:219.1878},0).wait(1).to({scaleX:2.8699,scaleY:2.87,rotation:31.0096,x:12.9647,y:217.0667},0).wait(1).to({scaleX:2.8744,scaleY:2.8745,rotation:30.6953,x:11.6759,y:215.8326},0).wait(1).to({scaleX:2.8759,scaleY:2.876,rotation:30.5944,x:11.2643,y:215.4341},0).to({_off:true},1).wait(58));
	...
	this.instance_6.setTransform(-358.85,114.8,2.9999,2.9999,-2.9509,0,0,-114.1,33);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(74).to({_off:false},0).wait(1).to({regX:0,regY:0,scaleX:2.9762,scaleY:2.9762,rotation:-2.8777,x:-24.3574,y:-0.3759},0).wait(1).to({scaleX:2.9535,scaleY:2.9535,rotation:-2.6503,x:-25.6771,y:1.5938},0).wait(1).to({scaleX:2.9319,scaleY:2.932,rotation:-2.256,x:-26.0777,y:4.3245},0).wait(1).to({scaleX:2.9113,scaleY:2.9113,rotation:-1.6875,x:-25.5959,y:7.8532},0).wait(1).to({scaleX:2.8916,scaleY:2.8917,rotation:-0.9329,x:-24.2634,y:12.244},0).wait(1).to({scaleX:2.8729,scaleY:2.873,rotation:0.0196,x:-22.1365,y:17.5679},0).wait(1).to({scaleX:2.8552,scaleY:2.8552,rotation:1.1773,x:-19.2974,y:23.8746},0).wait(1).to({scaleX:2.8382,scaleY:2.8382,rotation:2.5506,x:-15.8386,y:31.2333},0).wait(1).to({scaleX:2.8221,scaleY:2.8222,rotation:4.1425,x:-11.8801,y:39.6726},0).wait(1).to({scaleX:2.8068,scaleY:2.8069,rotation:5.9529,x:-7.5657,y:49.2056},0).wait(1).to({scaleX:2.7922,scaleY:2.7923,rotation:7.9789,x:-3.0557,y:59.8266},0).wait(1).to({scaleX:2.7785,scaleY:2.7786,rotation:10.2072,x:1.4755,y:71.466},0).wait(1).to({scaleX:2.7654,scaleY:2.7655,rotation:12.6157,x:5.839,y:83.9993},0).wait(1).to({scaleX:2.753,scaleY:2.7531,rotation:15.1748,x:9.8653,y:97.2508},0).wait(1).to({scaleX:2.7412,scaleY:2.7413,rotation:17.8432,x:13.4032,y:110.9728},0).wait(1).to({scaleX:2.7299,scaleY:2.73,rotation:20.5736,x:16.3534,y:124.8789},0).wait(1).to({scaleX:2.7194,scaleY:2.7194,rotation:23.3143,x:18.6589,y:138.6626},0).wait(1).to({scaleX:2.7092,scaleY:2.7093,rotation:26.0137,x:20.3289,y:152.0223},0).wait(1).to({scaleX:2.6997,scaleY:2.6997,rotation:28.6215,x:21.4139,y:164.6813},0).wait(1).to({scaleX:2.6906,scaleY:2.6907,rotation:31.0964,x:22.0102,y:176.426},0).wait(1).to({scaleX:2.6819,scaleY:2.682,rotation:33.406,x:22.223,y:187.1094},0).wait(1).to({scaleX:2.6736,scaleY:2.6737,rotation:35.5265,x:22.1656,y:196.6447},0).wait(1).to({scaleX:2.6656,scaleY:2.6657,rotation:37.4417,x:21.9384,y:204.9958},0).wait(1).to({scaleX:2.6581,scaleY:2.6582,rotation:39.1473,x:21.6198,y:212.1919},0).wait(1).to({scaleX:2.6508,scaleY:2.6509,rotation:40.6388,x:21.2784,y:218.2653},0).wait(1).to({scaleX:2.6438,scaleY:2.6439,rotation:41.9235,x:20.9401,y:223.3028},0).wait(1).to({scaleX:2.637,scaleY:2.6371,rotation:43.0059,x:20.6236,y:227.3756},0).wait(1).to({scaleX:2.6305,scaleY:2.6306,rotation:43.8948,x:20.3317,y:230.5658},0).wait(1).to({scaleX:2.624,scaleY:2.6241,rotation:44.5992,x:20.05,y:232.9528},0).wait(1).to({scaleX:2.6178,scaleY:2.6179,rotation:45.1294,x:19.7539,y:234.6144},0).wait(1).to({scaleX:2.6116,scaleY:2.6117,rotation:45.4956,x:19.4091,y:235.6229},0).wait(1).to({scaleX:2.6055,scaleY:2.6056,rotation:45.7097,x:18.9801,y:236.0502},0).wait(1).to({scaleX:2.5994,scaleY:2.5995,rotation:45.7791,x:18.4277,y:235.9433},0).wait(1).to({regX:-111.7,regY:38.2,scaleX:2.5827,scaleY:2.5828,rotation:45.2621,x:-254.1,y:93.2},0).wait(1).to({regX:0,regY:0,rotation:44.8868,x:20.1032,y:226.8613},0).wait(1).to({rotation:44.512,x:21.1384,y:225.066},0).wait(1).to({rotation:44.1373,x:22.1619,y:223.2651},0).wait(1).to({rotation:43.7625,x:23.1736,y:221.4586},0).wait(1).to({rotation:43.3877,x:24.1735,y:219.6466},0).wait(1).to({rotation:43.0129,x:25.1615,y:217.8292},0).wait(1).to({rotation:42.6381,x:26.1376,y:216.0064},0).wait(1).to({rotation:42.2633,x:27.1018,y:214.1784},0).wait(1).to({rotation:41.8886,x:28.0539,y:212.3453},0).wait(1).to({rotation:41.5138,x:28.9941,y:210.507},0).wait(1).to({rotation:41.139,x:29.9222,y:208.6637},0).wait(1).to({regX:-109.8,regY:41.2,scaleX:2.5826,rotation:41.7128,x:-253,y:101.2},0).wait(1).to({regX:0,regY:0,scaleX:2.5827,rotation:43.2097,x:33.4151,y:218.759},0).wait(1).to({rotation:44.5765,x:39.4596,y:226.6473},0).wait(1).to({rotation:45.8146,x:47.3515,y:234.0925},0).wait(1).to({rotation:46.9225,x:56.6374,y:241.0323},0).wait(1).to({rotation:47.9017,x:66.7643,y:247.407},0).wait(1).to({rotation:48.7515,x:77.0839,y:253.131},0).wait(1).to({rotation:49.471,x:86.9522,y:258.119},0).wait(1).to({rotation:50.0618,x:95.7671,y:262.3024},0).wait(1).to({rotation:50.5224,x:103.0354,y:265.6113},0).wait(1).to({rotation:50.8543,x:108.4175,y:268.0116},0).wait(1).to({scaleY:2.5829,rotation:51.0559,x:111.7006,y:269.4698},0).wait(1).to({scaleY:2.5828,rotation:51.1289,x:112.7904,y:269.9833},0).wait(1).to({regX:-109.9,regY:41,scaleX:2.5825,scaleY:2.5826,x:-147.85,y:116.15},0).wait(5).to({regX:-106.2,regY:43.1,scaleX:2.5827,scaleY:2.5828,rotation:50.9673,x:-145.1,y:128.1},0).wait(1).to({regX:0,regY:0,scaleX:2.5836,scaleY:2.5837,rotation:50.9038,x:113.7719,y:270.9478},0).wait(1).to({scaleX:2.5865,scaleY:2.5866,rotation:50.7059,x:112.7157,y:270.6237},0).wait(1).to({scaleX:2.5914,scaleY:2.5915,rotation:50.3615,x:110.8406,y:270.0583},0).wait(1).to({scaleX:2.5987,scaleY:2.5988,rotation:49.8571,x:108.0703,y:269.2128},0).wait(1).to({scaleX:2.6084,scaleY:2.6085,rotation:49.1819,x:104.2952,y:268.0544},0).wait(1).to({scaleX:2.6207,scaleY:2.6209,rotation:48.3233,x:99.4388,y:266.525},0).wait(1).to({scaleX:2.6359,scaleY:2.636,rotation:47.2746,x:93.4585,y:264.5629},0).wait(1).to({scaleX:2.6537,scaleY:2.6538,rotation:46.0338,x:86.3646,y:262.0971},0).wait(1).to({scaleX:2.6742,scaleY:2.6743,rotation:44.6087,x:78.2928,y:259.05},0).wait(1).to({scaleX:2.697,scaleY:2.6971,rotation:43.0236,x:69.4912,y:255.3736},0).wait(1).to({scaleX:2.7215,scaleY:2.7217,rotation:41.32,x:60.3358,y:251.0663},0).wait(1).to({scaleX:2.7469,scaleY:2.747,rotation:39.5573,x:51.2712,y:246.2059},0).wait(1).to({scaleX:2.7721,scaleY:2.7722,rotation:37.8101,x:42.7364,y:240.9781},0).wait(1).to({scaleX:2.7959,scaleY:2.796,rotation:36.1571,x:35.0362,y:235.6677},0).wait(1).to({scaleX:2.8173,scaleY:2.8174,rotation:34.666,x:28.3781,y:230.5831},0).wait(1).to({scaleX:2.8357,scaleY:2.8358,rotation:33.3864,x:22.842,y:226.008},0).wait(1).to({scaleX:2.8507,scaleY:2.8508,rotation:32.3464,x:18.4505,y:222.1502},0).wait(1).to({scaleX:2.8621,scaleY:2.8622,rotation:31.5558,x:15.1607,y:219.1378},0).wait(1).to({scaleX:2.8699,scaleY:2.87,rotation:31.0096,x:12.9147,y:217.0167},0).wait(1).to({scaleX:2.8744,scaleY:2.8745,rotation:30.6953,x:11.6259,y:215.7826},0).wait(1).to({scaleX:2.8759,scaleY:2.876,rotation:30.5944,x:11.2143,y:215.3841},0).to({_off:true},1).wait(58));
...
p.nominalBounds = new cjs.Rectangle(-1865.2,-540,2520.7,1453.3);
...
p.nominalBounds = new cjs.Rectangle(-609.4,-230.8,3536.2000000000003,1310.8);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		*/
		function animateInFrame1(){
			...
			gsap.to(self.logo, {duration:0.1, alpha:0, delay:0.2});
			gsap.to(self.whiteLogo, {duration:0.1, alpha:1, delay:0.2});
	...
	this.whiteLogo.setTransform(195.2,565.3,0.85,0.8499,0,0,0,88.5,13.3);
	...
	this.logo.name = "logo";
	this.logo.setTransform(121.4,554.8,1.0001,1,0,0,0,1.4,0.8);
	this.logo.alpha = 0;
	...
	this.promo.setTransform(215,241.3,1,1,0,0,0,5,-1.4);
	...
	this.crowbar.setTransform(68.75,354.85,0.225,0.225,0,0,0,903,540.8);
	...
	// stageBackground
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill().beginStroke("rgba(0,0,0,0)").setStrokeStyle(1,1,1,3,true).moveTo(-160,-310).lineTo(160,-310).lineTo(160,310).lineTo(-160,310).closePath();
	this.shape.setTransform(150,300);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-160,310).lineTo(-160,-310).lineTo(160,-310).lineTo(160,310).closePath();
...
p.nominalBounds = new cjs.Rectangle(-121.5,300,645.5,300);
// library properties:
lib.properties = {
