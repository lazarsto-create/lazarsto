...
if (reversed == null) { reversed = false; }
	...
	this.copyDo.setTransform(163,66.85,1,1,0,0,0,0,19.1);
	...
	this.copy2.name = "copy2";
	this.copy2.setTransform(162,40.75);
	...
	this.copy1.name = "copy1";
	this.copy1.setTransform(160,41);
	...
	this.ctaDo.setTransform(65.95,213.55,0.7185,0.7188,0,0,0,50,16.1);
	...
	this.cta.name = "cta";
	this.cta.setTransform(-166.05,202,0.7538,0.7541);
...
p.nominalBounds = new cjs.Rectangle(-10.4,-63.6,404.09999999999997,663.6);
// library properties:
lib.properties = {
