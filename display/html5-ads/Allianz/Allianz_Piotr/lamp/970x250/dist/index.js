...
if (reversed == null) { reversed = false; }
	...
	this.logoWhite.setTransform(-26.5,196.4,1.1945,1.1947,0,0,0,1.4,0.8);
...
p.nominalBounds = new cjs.Rectangle(-28.1,0,179.7,222.5);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		*/
		function animateInFrame1(){
			...
			gsap.to(self.largeshape, {scale:3.5,duration:0.8, ease:allianzEase});
	...
	this.copyDo.setTransform(211,109.85,1,1,0,0,0,0,19.1);
	...
	this.copy2.name = "copy2";
	this.copy2.setTransform(183,67.75);
	...
	this.copy1.name = "copy1";
	this.copy1.setTransform(182,83);
	...
	this.promo.setTransform(378.9,126.55,0.7752,0.7752,0,0,0,5,-1.4);
	...
	this.lamp.name = "lamp";
	this.lamp.setTransform(526.35,227.85,0.8398,0.8402,0,0,0,0.2,0);
	...
	this.crowbar.setTransform(481.4,123,0.206,0.2067,0,0,0,546.8,529.4);

	this.timeline.addTween(cjs.Tween.get(this.crowbar).wait(1));

	// tracks
	this.instance = new lib.tracks();
	this.instance.setTransform(427.95,153.2,0.25,0.25,0,0,0,281,724);
	...
	this.ctaDo.setTransform(-166.05,192);
	...
	this.cta.name = "cta";
	this.cta.setTransform(113.1,207.2,1,1,0,0,0,58.1,15.2);
...
p.nominalBounds = new cjs.Rectangle(302.5,-87.6,606.2,687.6);
// library properties:
lib.properties = {
