...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FDD25C").beginStroke().moveTo(-5.9,8.1).lineTo(-5.1,5.5).curveTo(-4.2,6.1,-3,6.4).curveTo(-1.9,6.7,-0.7,6.7).curveTo(1.5,6.7,2.7,5.7).curveTo(3.7,4.6,3.8,2.5).lineTo(3.8,1.9).curveTo(2.1,4,-0.6,4).curveTo(-2.3,4,-3.7,3.1).curveTo(-5.1,2.3,-5.9,0.7).curveTo(-6.6,-0.8,-6.7,-2.7).curveTo(-6.6,-4.7,-5.9,-6.2).curveTo(-5.1,-7.7,-3.7,-8.5).curveTo(-2.3,-9.4,-0.6,-9.4).curveTo(2.3,-9.4,3.9,-7.1).lineTo(3.9,-9.2).lineTo(6.6,-9.2).lineTo(6.6,2.7).curveTo(6.6,6,4.8,7.7).curveTo(2.9,9.4,-0.6,9.4).curveTo(-3.5,9.4,-5.9,8.1).closePath().moveTo(-2.7,-5.6).curveTo(-3.8,-4.5,-3.7,-2.7).curveTo(-3.8,-0.9,-2.7,0.1).curveTo(-1.6,1.3,0.1,1.3).curveTo(1.8,1.3,2.8,0.2).curveTo(3.8,-0.9,3.8,-2.7).curveTo(3.8,-4.6,2.8,-5.6).curveTo(1.8,-6.8,0.1,-6.7).curveTo(-1.6,-6.7,-2.7,-5.6).closePath();
	this.shape.setTransform(111.35,34);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FDD25C").beginStroke().moveTo(3.1,6.8).lineTo(3.1,-0.4).curveTo(3.1,-2.3,2.3,-3.2).curveTo(1.6,-4.1,0.1,-4.1).curveTo(-1.4,-4.1,-2.3,-3.2).curveTo(-3.1,-2.2,-3.1,-0.5).lineTo(-3.1,6.8).lineTo(-6,6.8).lineTo(-6,-6.6).lineTo(-3.3,-6.6).lineTo(-3.3,-4.5).curveTo(-2.7,-5.7,-1.6,-6.2).curveTo(-0.4,-6.8,0.9,-6.8).curveTo(3.3,-6.8,4.7,-5.3).curveTo(6,-3.7,6,-1).lineTo(6,6.8).closePath();
	this.shape_1.setTransform(96.125,31.425);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#FDD25C").beginStroke().moveTo(-1.5,9.8).lineTo(-1.5,-3.6).lineTo(1.4,-3.6).lineTo(1.4,9.8).closePath().moveTo(-1.4,-6.7).curveTo(-1.9,-7.2,-1.9,-8).curveTo(-1.9,-8.8,-1.4,-9.3).curveTo(-0.9,-9.8,-0,-9.8).curveTo(0.8,-9.8,1.3,-9.3).curveTo(1.9,-8.8,1.9,-8).curveTo(1.9,-7.2,1.3,-6.7).curveTo(0.8,-6.2,-0,-6.2).curveTo(-0.9,-6.2,-1.4,-6.7).closePath();
	this.shape_2.setTransform(84.925,28.425);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FDD25C").beginStroke().moveTo(-3.9,6.8).lineTo(-3.9,-6.6).lineTo(-1.2,-6.6).lineTo(-1.2,-4.3).curveTo(-0.2,-6.8,2.2,-6.8).curveTo(3.2,-6.8,3.9,-6.4).lineTo(3.6,-3.6).curveTo(2.8,-3.8,2.1,-3.8).curveTo(0.7,-3.8,-0.2,-2.8).curveTo(-1,-1.9,-1,0.1).lineTo(-1,6.8).closePath();
	this.shape_3.setTransform(77.35,31.45);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#FDD25C").beginStroke().moveTo(-2.9,6.1).curveTo(-4.5,5.3,-5.5,3.7).curveTo(-6.3,2.1,-6.4,-0).curveTo(-6.3,-2.1,-5.6,-3.6).curveTo(-4.7,-5.2,-3.3,-6.1).curveTo(-1.9,-7,0,-7).curveTo(1.8,-7,3.3,-6.1).curveTo(4.8,-5.3,5.5,-3.8).curveTo(6.3,-2.2,6.3,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(2,4.3,3.1,4).curveTo(4.2,3.7,5.1,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.2,7,0.7,7).curveTo(-1.3,7,-2.9,6.1).closePath().moveTo(3.4,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.1,-2.8,-3.4,-1.3).lineTo(3.4,-1.3).lineTo(3.4,-1.3).closePath();
	this.shape_4.setTransform(64.15,31.575);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FDD25C").beginStroke().moveTo(2.5,9.8).lineTo(-1.9,4.5).lineTo(-3.4,6).lineTo(-3.4,9.8).lineTo(-6.3,9.8).lineTo(-6.3,-9.8).lineTo(-3.4,-9.8).lineTo(-3.4,2.3).lineTo(2.2,-3.6).lineTo(5.9,-3.6).lineTo(0.1,2.5).lineTo(6.3,9.8).closePath();
	this.shape_5.setTransform(50.475,28.425);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#FDD25C").beginStroke().moveTo(-2.9,6.1).curveTo(-4.6,5.3,-5.4,3.7).curveTo(-6.4,2.1,-6.3,-0).curveTo(-6.4,-2.1,-5.5,-3.6).curveTo(-4.8,-5.2,-3.3,-6.1).curveTo(-1.8,-7,-0,-7).curveTo(1.9,-7,3.3,-6.1).curveTo(4.7,-5.3,5.5,-3.8).curveTo(6.4,-2.2,6.4,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(1.9,4.3,3.1,4).curveTo(4.2,3.7,5,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.2,7,0.8,7).curveTo(-1.4,7,-2.9,6.1).closePath().moveTo(3.5,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0.1,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.2,-2.8,-3.4,-1.3).lineTo(3.5,-1.3).lineTo(3.5,-1.3).closePath();
	this.shape_6.setTransform(34.95,31.575);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#FDD25C").beginStroke().moveTo(-5.5,6.7).lineTo(-5.5,4.4).lineTo(1.2,-3.9).lineTo(-5.2,-3.9).lineTo(-5.2,-6.7).lineTo(5.2,-6.7).lineTo(5.2,-4.4).lineTo(-1.5,4).lineTo(5.5,4).lineTo(5.5,6.7).closePath();
	this.shape_7.setTransform(21.175,31.55);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#FDD25C").beginStroke().moveTo(-4,6.8).lineTo(-4,-6.6).lineTo(-1.3,-6.6).lineTo(-1.3,-4.3).curveTo(-0.2,-6.8,2.2,-6.8).curveTo(3.1,-6.8,3.9,-6.4).lineTo(3.6,-3.6).curveTo(2.9,-3.8,2.1,-3.8).curveTo(0.7,-3.8,-0.2,-2.8).curveTo(-1.1,-1.9,-1.1,0.1).lineTo(-1.1,6.8).closePath();
	this.shape_8.setTransform(10.45,31.45);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#FDD25C").beginStroke().moveTo(-2.9,6.1).curveTo(-4.6,5.3,-5.4,3.7).curveTo(-6.4,2.1,-6.3,-0).curveTo(-6.4,-2.1,-5.5,-3.6).curveTo(-4.8,-5.2,-3.3,-6.1).curveTo(-1.8,-7,-0,-7).curveTo(1.9,-7,3.3,-6.1).curveTo(4.8,-5.3,5.5,-3.8).curveTo(6.4,-2.2,6.3,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(1.9,4.3,3.1,4).curveTo(4.2,3.7,5.1,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.2,7,0.8,7).curveTo(-1.4,7,-2.9,6.1).closePath().moveTo(3.5,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.2,-2.8,-3.4,-1.3).lineTo(3.5,-1.3).lineTo(3.5,-1.3).closePath();
	this.shape_9.setTransform(-2.75,31.575);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#FDD25C").beginStroke().moveTo(-1.5,6.7).lineTo(-6.9,-6.7).lineTo(-3.8,-6.7).lineTo(-0,3.4).lineTo(3.8,-6.7).lineTo(6.9,-6.7).lineTo(1.5,6.7).closePath();
	this.shape_10.setTransform(-17.075,31.55);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("#FDD25C").beginStroke().moveTo(-1.9,9).curveTo(-2.7,8.2,-2.7,6.2).lineTo(-2.7,-9.9).lineTo(0.2,-9.9).lineTo(0.2,5.7).curveTo(0.2,6.4,0.5,6.9).curveTo(0.8,7.2,1.5,7.2).curveTo(2.1,7.2,2.4,7).lineTo(2.7,9.6).curveTo(2,9.9,0.7,9.9).curveTo(-1.1,9.9,-1.9,9).closePath();
	this.shape_11.setTransform(-27.125,28.5);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#FDD25C").beginStroke().moveTo(-2.9,6.1).curveTo(-4.5,5.3,-5.5,3.7).curveTo(-6.4,2.1,-6.4,-0).curveTo(-6.4,-2.1,-5.5,-3.6).curveTo(-4.8,-5.2,-3.3,-6.1).curveTo(-1.9,-7,0,-7).curveTo(1.8,-7,3.3,-6.1).curveTo(4.8,-5.3,5.5,-3.8).curveTo(6.4,-2.2,6.3,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(1.9,4.3,3.1,4).curveTo(4.2,3.7,5.1,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.3,7,0.8,7).curveTo(-1.4,7,-2.9,6.1).closePath().moveTo(3.5,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.2,-2.8,-3.4,-1.3).lineTo(3.5,-1.3).lineTo(3.5,-1.3).closePath();
	this.shape_12.setTransform(-39.1,31.575);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.beginFill("#FDD25C").beginStroke().moveTo(-3.7,9.1).curveTo(-5.1,8.2,-5.9,6.6).curveTo(-6.7,5,-6.6,3).curveTo(-6.6,0.9,-5.9,-0.6).curveTo(-5.1,-2.2,-3.7,-3.1).curveTo(-2.3,-4,-0.6,-4).curveTo(2.1,-3.9,3.7,-1.9).lineTo(3.7,-9.9).lineTo(6.6,-9.9).lineTo(6.6,9.7).lineTo(3.9,9.7).lineTo(3.9,7.7).curveTo(2.3,9.9,-0.6,10).curveTo(-2.3,10,-3.7,9.1).closePath().moveTo(-2.7,-0).curveTo(-3.7,1.1,-3.7,3).curveTo(-3.7,4.9,-2.7,6.1).curveTo(-1.6,7.3,0.1,7.3).curveTo(1.8,7.3,2.8,6.1).curveTo(3.7,4.9,3.7,3).curveTo(3.7,1,2.8,-0.1).curveTo(1.8,-1.2,0.1,-1.2).curveTo(-1.6,-1.2,-2.7,-0).closePath();
	this.shape_13.setTransform(-54.95,28.55);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.beginFill("#FDD25C").beginStroke().moveTo(-2.9,6.1).curveTo(-4.6,5.3,-5.4,3.7).curveTo(-6.4,2.1,-6.3,-0).curveTo(-6.4,-2.1,-5.5,-3.6).curveTo(-4.8,-5.2,-3.3,-6.1).curveTo(-1.8,-7,-0,-7).curveTo(1.9,-7,3.3,-6.1).curveTo(4.7,-5.3,5.5,-3.8).curveTo(6.4,-2.2,6.4,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(1.9,4.3,3.1,4).curveTo(4.2,3.7,5,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.2,7,0.8,7).curveTo(-1.4,7,-2.9,6.1).closePath().moveTo(3.5,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0.1,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.2,-2.8,-3.4,-1.3).lineTo(3.5,-1.3).lineTo(3.5,-1.3).closePath();
	this.shape_14.setTransform(-69.9,31.575);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.beginFill("#FDD25C").beginStroke().moveTo(-3.5,6.1).curveTo(-5.1,5.2,-5.9,3.6).curveTo(-6.8,2,-6.8,-0).curveTo(-6.8,-2.1,-5.9,-3.6).curveTo(-5.1,-5.2,-3.5,-6.1).curveTo(-2,-7,-0,-7).curveTo(2,-7,3.5,-6.1).curveTo(5,-5.2,5.9,-3.6).curveTo(6.8,-2.1,6.8,-0).curveTo(6.8,2,5.9,3.6).curveTo(5,5.2,3.5,6.1).curveTo(2,7,-0,7).curveTo(-2,7,-3.5,6.1).closePath().moveTo(-2.8,-3.1).curveTo(-3.9,-1.9,-3.9,-0).curveTo(-3.9,1.9,-2.8,3).curveTo(-1.7,4.2,-0,4.2).curveTo(1.7,4.2,2.8,3).curveTo(3.8,1.9,3.8,-0).curveTo(3.8,-1.9,2.8,-3.1).curveTo(1.7,-4.2,-0,-4.2).curveTo(-1.7,-4.2,-2.8,-3.1).closePath();
	this.shape_15.setTransform(-84.925,31.575);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.beginFill("#FDD25C").beginStroke().moveTo(-4,7.7).lineTo(-4,9.7).lineTo(-6.7,9.7).lineTo(-6.7,-9.9).lineTo(-3.8,-9.9).lineTo(-3.8,-1.9).curveTo(-2,-3.9,0.6,-4).curveTo(2.4,-4,3.8,-3.1).curveTo(5.1,-2.2,5.9,-0.6).curveTo(6.6,0.9,6.6,3).curveTo(6.6,5,5.9,6.6).curveTo(5.1,8.2,3.8,9.1).curveTo(2.4,10,0.6,10).curveTo(-2.3,9.9,-4,7.7).closePath().moveTo(-2.7,-0.1).curveTo(-3.8,1,-3.8,3).curveTo(-3.8,4.9,-2.7,6.1).curveTo(-1.8,7.3,-0,7.3).curveTo(1.6,7.2,2.7,6).curveTo(3.8,4.9,3.8,3).curveTo(3.8,1.1,2.7,-0).curveTo(1.6,-1.2,-0,-1.2).curveTo(-1.8,-1.2,-2.7,-0.1).closePath();
	this.shape_16.setTransform(-100.25,28.55);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.beginFill("#FDD25C").beginStroke().moveTo(3.1,6.8).lineTo(3.1,-0.4).curveTo(3.1,-2.3,2.3,-3.2).curveTo(1.6,-4.1,0.1,-4.1).curveTo(-1.4,-4.1,-2.3,-3.2).curveTo(-3.1,-2.2,-3.1,-0.5).lineTo(-3.1,6.8).lineTo(-6,6.8).lineTo(-6,-6.6).lineTo(-3.3,-6.6).lineTo(-3.3,-4.5).curveTo(-2.7,-5.7,-1.6,-6.2).curveTo(-0.4,-6.8,0.9,-6.8).curveTo(3.3,-6.8,4.7,-5.3).curveTo(6,-3.7,6,-1).lineTo(6,6.8).closePath();
	this.shape_17.setTransform(-116.425,31.425);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.beginFill("#FDD25C").beginStroke().moveTo(-1.5,9.8).lineTo(-1.5,-3.6).lineTo(1.4,-3.6).lineTo(1.4,9.8).closePath().moveTo(-1.4,-6.7).curveTo(-1.9,-7.2,-1.9,-8).curveTo(-1.9,-8.8,-1.4,-9.3).curveTo(-0.9,-9.8,-0,-9.8).curveTo(0.8,-9.8,1.3,-9.3).curveTo(1.9,-8.8,1.9,-8).curveTo(1.9,-7.2,1.3,-6.7).curveTo(0.8,-6.2,-0,-6.2).curveTo(-0.9,-6.2,-1.4,-6.7).closePath();
	this.shape_18.setTransform(-127.625,28.425);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.copyDo_3, new cjs.Rectangle(-133,-50.8,266,99.3), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2.9,6.1).curveTo(-4.5,5.3,-5.5,3.7).curveTo(-6.4,2.1,-6.4,-0).curveTo(-6.4,-2.1,-5.5,-3.6).curveTo(-4.8,-5.2,-3.3,-6.1).curveTo(-1.9,-7,0,-7).curveTo(1.8,-7,3.3,-6.1).curveTo(4.8,-5.3,5.5,-3.8).curveTo(6.4,-2.2,6.3,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(1.9,4.3,3.1,4).curveTo(4.2,3.7,5.1,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.3,7,0.8,7).curveTo(-1.4,7,-2.9,6.1).closePath().moveTo(3.5,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.2,-2.8,-3.4,-1.3).lineTo(3.5,-1.3).lineTo(3.5,-1.3).closePath();
	this.shape.setTransform(73.4,3.225);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.7,9.1).curveTo(-5.1,8.2,-5.9,6.6).curveTo(-6.7,5,-6.6,3).curveTo(-6.6,0.9,-5.9,-0.6).curveTo(-5.1,-2.2,-3.7,-3.1).curveTo(-2.3,-4,-0.6,-4).curveTo(2.1,-3.9,3.7,-1.9).lineTo(3.7,-9.9).lineTo(6.6,-9.9).lineTo(6.6,9.7).lineTo(3.9,9.7).lineTo(3.9,7.7).curveTo(2.3,9.9,-0.6,10).curveTo(-2.3,10,-3.7,9.1).closePath().moveTo(-2.7,-0).curveTo(-3.7,1.2,-3.7,3).curveTo(-3.7,4.9,-2.7,6.1).curveTo(-1.6,7.3,0.1,7.3).curveTo(1.8,7.3,2.8,6.1).curveTo(3.7,4.9,3.7,3).curveTo(3.7,1,2.8,-0.1).curveTo(1.8,-1.2,0.1,-1.2).curveTo(-1.6,-1.2,-2.7,-0).closePath();
	this.shape_1.setTransform(57.55,0.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#FFFFFF").beginStroke().moveTo(3.1,6.8).lineTo(3.1,-0.4).curveTo(3.1,-2.3,2.3,-3.2).curveTo(1.6,-4.1,0.1,-4.1).curveTo(-1.4,-4.1,-2.3,-3.2).curveTo(-3.1,-2.2,-3.1,-0.5).lineTo(-3.1,6.8).lineTo(-6,6.8).lineTo(-6,-6.6).lineTo(-3.3,-6.6).lineTo(-3.3,-4.5).curveTo(-2.7,-5.7,-1.6,-6.2).curveTo(-0.4,-6.8,0.9,-6.8).curveTo(3.3,-6.8,4.7,-5.3).curveTo(6,-3.7,6,-1).lineTo(6,6.8).closePath();
	this.shape_2.setTransform(42.325,3.075);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-2.9,6.1).curveTo(-4.5,5.3,-5.4,3.7).curveTo(-6.4,2.1,-6.4,-0).curveTo(-6.4,-2.1,-5.5,-3.6).curveTo(-4.8,-5.2,-3.3,-6.1).curveTo(-1.9,-7,0,-7).curveTo(1.8,-7,3.3,-6.1).curveTo(4.8,-5.3,5.5,-3.8).curveTo(6.4,-2.2,6.3,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(1.9,4.3,3.1,4).curveTo(4.2,3.7,5.1,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.3,7,0.8,7).curveTo(-1.4,7,-2.9,6.1).closePath().moveTo(3.5,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.2,-2.8,-3.4,-1.3).lineTo(3.5,-1.3).lineTo(3.5,-1.3).closePath();
	this.shape_3.setTransform(27.05,3.225);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.1,6).lineTo(-4.4,3.3).curveTo(-2.6,4.3,-0.6,4.3).curveTo(0.7,4.3,1.4,3.9).curveTo(2.2,3.5,2.1,2.8).curveTo(2.1,2.2,1.6,1.9).curveTo(0.9,1.6,-0.3,1.2).lineTo(-2.6,0.5).curveTo(-3.5,0.1,-4.1,-0.8).curveTo(-4.8,-1.6,-4.7,-3).curveTo(-4.7,-4.9,-3.5,-6).curveTo(-2.2,-7,0.2,-7).curveTo(1.4,-7,2.6,-6.7).curveTo(3.6,-6.5,4.6,-6.1).lineTo(3.8,-3.5).curveTo(2.2,-4.4,0.3,-4.4).curveTo(-0.8,-4.4,-1.3,-4).curveTo(-1.9,-3.7,-1.8,-3).curveTo(-1.8,-2.3,-1.2,-2).curveTo(-0.6,-1.7,0.8,-1.3).curveTo(2.1,-0.9,2.9,-0.5).curveTo(3.8,-0.2,4.5,0.6).curveTo(5,1.4,5,2.7).curveTo(5,4.7,3.6,5.9).curveTo(2.1,7,-0.6,7).curveTo(-3.1,7,-5.1,6).closePath();
	this.shape_4.setTransform(13.8,3.225);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5.1,6).lineTo(-4.4,3.3).curveTo(-2.6,4.3,-0.6,4.3).curveTo(0.7,4.3,1.4,3.9).curveTo(2.2,3.5,2.1,2.8).curveTo(2.1,2.2,1.6,1.9).curveTo(0.9,1.6,-0.3,1.2).lineTo(-2.6,0.5).curveTo(-3.5,0.1,-4.1,-0.8).curveTo(-4.8,-1.6,-4.7,-3).curveTo(-4.7,-4.9,-3.5,-6).curveTo(-2.2,-7,0.2,-7).curveTo(1.4,-7,2.6,-6.7).curveTo(3.6,-6.5,4.6,-6.1).lineTo(3.8,-3.5).curveTo(2.2,-4.4,0.3,-4.4).curveTo(-0.8,-4.4,-1.3,-4).curveTo(-1.9,-3.7,-1.8,-3).curveTo(-1.8,-2.3,-1.2,-2).curveTo(-0.6,-1.7,0.8,-1.3).curveTo(2.1,-0.9,2.9,-0.5).curveTo(3.8,-0.2,4.5,0.6).curveTo(5,1.4,5,2.7).curveTo(5,4.7,3.6,5.9).curveTo(2.1,7,-0.6,7).curveTo(-3.1,7,-5.1,6).closePath();
	this.shape_5.setTransform(2.1,3.225);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.7,6.1).curveTo(-5.1,5.2,-5.9,3.6).curveTo(-6.7,2,-6.6,0).curveTo(-6.6,-2.1,-5.9,-3.6).curveTo(-5.1,-5.2,-3.7,-6.1).curveTo(-2.3,-7,-0.6,-7).curveTo(2.3,-7,3.9,-4.6).lineTo(3.9,-6.7).lineTo(6.6,-6.7).lineTo(6.6,6.7).lineTo(3.9,6.7).lineTo(3.9,4.7).curveTo(2.3,6.9,-0.6,7).curveTo(-2.3,7,-3.7,6.1).closePath().moveTo(-2.7,-3).curveTo(-3.7,-1.8,-3.7,0).curveTo(-3.7,1.9,-2.7,3.1).curveTo(-1.6,4.3,0.1,4.3).curveTo(1.8,4.3,2.8,3.1).curveTo(3.7,1.9,3.7,0).curveTo(3.7,-2,2.8,-3.1).curveTo(1.8,-4.2,0.1,-4.2).curveTo(-1.6,-4.2,-2.7,-3).closePath();
	this.shape_6.setTransform(-12.2,3.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-6.6,9.3).lineTo(-6.6,-9).lineTo(-3.9,-9).lineTo(-3.9,-7).curveTo(-2.3,-9.3,0.6,-9.3).curveTo(2.4,-9.3,3.7,-8.4).curveTo(5.1,-7.5,5.9,-5.9).curveTo(6.7,-4.4,6.6,-2.3).curveTo(6.7,-0.3,5.9,1.3).curveTo(5.1,2.9,3.7,3.8).curveTo(2.4,4.6,0.6,4.6).curveTo(-2.1,4.6,-3.7,2.6).lineTo(-3.7,9.3).closePath().moveTo(-2.8,-5.4).curveTo(-3.8,-4.3,-3.7,-2.3).curveTo(-3.8,-0.4,-2.8,0.8).curveTo(-1.7,1.9,-0.1,1.9).curveTo(1.6,1.9,2.7,0.7).curveTo(3.7,-0.4,3.7,-2.3).curveTo(3.7,-4.2,2.7,-5.4).curveTo(1.6,-6.5,-0.1,-6.5).curveTo(-1.7,-6.5,-2.8,-5.4).closePath();
	this.shape_7.setTransform(-27.4,5.525);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.3,7.5).curveTo(-2.4,6.5,-2.4,4.4).lineTo(-2.4,-2.1).lineTo(-4.2,-2.1).lineTo(-4.2,-4.9).lineTo(-2.4,-4.9).lineTo(-2.4,-8.1).lineTo(0.5,-8.7).lineTo(0.5,-4.9).lineTo(4.1,-4.9).lineTo(4.1,-2.1).lineTo(0.5,-2.1).lineTo(0.5,4).curveTo(0.5,5.9,2.3,6).curveTo(3,6,3.8,5.6).lineTo(4.2,8.2).curveTo(3.1,8.7,1.7,8.7).curveTo(-0.3,8.7,-1.3,7.5).closePath();
	this.shape_8.setTransform(-46.925,1.4);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-5,6).lineTo(-4.4,3.3).curveTo(-2.6,4.3,-0.5,4.3).curveTo(0.7,4.3,1.5,3.9).curveTo(2.1,3.5,2.2,2.8).curveTo(2.1,2.2,1.6,1.9).curveTo(0.9,1.6,-0.3,1.2).lineTo(-2.6,0.5).curveTo(-3.5,0.1,-4.1,-0.8).curveTo(-4.7,-1.6,-4.7,-3).curveTo(-4.8,-4.9,-3.5,-6).curveTo(-2.1,-7,0.2,-7).curveTo(1.4,-7,2.5,-6.7).curveTo(3.7,-6.5,4.5,-6.1).lineTo(3.8,-3.5).curveTo(2.2,-4.4,0.3,-4.4).curveTo(-0.7,-4.4,-1.3,-4).curveTo(-1.8,-3.7,-1.9,-3).curveTo(-1.8,-2.3,-1.2,-2).curveTo(-0.6,-1.7,0.7,-1.3).curveTo(2.1,-0.9,2.9,-0.5).curveTo(3.8,-0.2,4.4,0.6).curveTo(5.1,1.4,5.1,2.7).curveTo(5,4.7,3.5,5.9).curveTo(2,7,-0.5,7).curveTo(-3.1,7,-5,6).closePath();
	this.shape_9.setTransform(-57.45,3.225);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3,6.1).curveTo(-4.6,5.3,-5.4,3.7).curveTo(-6.3,2.1,-6.3,-0).curveTo(-6.3,-2.1,-5.6,-3.6).curveTo(-4.8,-5.2,-3.3,-6.1).curveTo(-1.8,-7,-0,-7).curveTo(1.8,-7,3.3,-6.1).curveTo(4.7,-5.3,5.6,-3.8).curveTo(6.3,-2.2,6.4,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.1,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(2,4.3,3.1,4).curveTo(4.2,3.7,5,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.3,7,0.7,7).curveTo(-1.3,7,-3,6.1).closePath().moveTo(3.4,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0.1,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.1,-2.8,-3.4,-1.3).lineTo(3.4,-1.3).lineTo(3.4,-1.3).closePath();
	this.shape_10.setTransform(-70.55,3.225);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.9,7.7).lineTo(-3.9,9.7).lineTo(-6.6,9.7).lineTo(-6.6,-9.9).lineTo(-3.7,-9.9).lineTo(-3.7,-1.9).curveTo(-2.1,-3.9,0.6,-4).curveTo(2.4,-4,3.7,-3.1).curveTo(5.1,-2.2,5.9,-0.6).curveTo(6.7,0.9,6.6,3).curveTo(6.7,5,5.9,6.6).curveTo(5.1,8.2,3.7,9.1).curveTo(2.4,10,0.6,10).curveTo(-2.3,9.9,-3.9,7.7).closePath().moveTo(-2.8,-0.1).curveTo(-3.8,1,-3.7,3).curveTo(-3.8,4.9,-2.8,6.1).curveTo(-1.7,7.3,-0.1,7.3).curveTo(1.6,7.2,2.7,6).curveTo(3.7,4.9,3.7,3).curveTo(3.7,1.2,2.7,-0).curveTo(1.6,-1.2,-0.1,-1.2).curveTo(-1.7,-1.2,-2.8,-0.1).closePath();
	this.shape_11.setTransform(-85.45,0.2);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3,6.1).curveTo(-4.5,5.3,-5.5,3.7).curveTo(-6.3,2.1,-6.4,-0).curveTo(-6.3,-2.1,-5.6,-3.6).curveTo(-4.7,-5.2,-3.3,-6.1).curveTo(-1.8,-7,-0,-7).curveTo(1.8,-7,3.3,-6.1).curveTo(4.7,-5.3,5.6,-3.8).curveTo(6.3,-2.2,6.4,-0.3).lineTo(6.3,1).lineTo(-3.4,1).curveTo(-3.2,2.6,-2,3.4).curveTo(-0.9,4.3,0.9,4.3).curveTo(2,4.3,3.1,4).curveTo(4.2,3.7,5,3.1).lineTo(5.9,5.5).curveTo(4.9,6.2,3.6,6.6).curveTo(2.2,7,0.7,7).curveTo(-1.4,7,-3,6.1).closePath().moveTo(3.4,-1.3).curveTo(3.3,-2.8,2.4,-3.6).curveTo(1.5,-4.4,0.1,-4.4).curveTo(-1.3,-4.4,-2.2,-3.6).curveTo(-3.2,-2.8,-3.4,-1.3).lineTo(3.4,-1.3).lineTo(3.4,-1.3).closePath();
	this.shape_12.setTransform(-107.55,3.225);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.7,9.1).curveTo(-5.1,8.2,-5.9,6.6).curveTo(-6.6,5,-6.7,3).curveTo(-6.7,0.9,-5.8,-0.6).curveTo(-5.1,-2.2,-3.7,-3.1).curveTo(-2.3,-4,-0.5,-4).curveTo(2.1,-3.9,3.8,-1.9).lineTo(3.8,-9.9).lineTo(6.7,-9.9).lineTo(6.7,9.7).lineTo(4,9.7).lineTo(4,7.7).curveTo(2.3,9.9,-0.5,10).curveTo(-2.3,10,-3.7,9.1).closePath().moveTo(-2.7,-0).curveTo(-3.8,1.2,-3.8,3).curveTo(-3.8,4.9,-2.7,6.1).curveTo(-1.6,7.3,0.1,7.3).curveTo(1.8,7.3,2.8,6.1).curveTo(3.8,4.9,3.8,3).curveTo(3.8,1,2.8,-0.1).curveTo(1.8,-1.2,0.1,-1.2).curveTo(-1.6,-1.2,-2.7,-0).closePath();
	this.shape_13.setTransform(-123.4,0.2);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4.7,5.3).curveTo(-6,3.7,-6,1).lineTo(-6,-6.8).lineTo(-3.1,-6.8).lineTo(-3.1,0.4).curveTo(-3.1,2.3,-2.3,3.2).curveTo(-1.6,4.1,-0.1,4.1).curveTo(1.4,4.1,2.2,3.2).curveTo(3.1,2.2,3.1,0.5).lineTo(3.1,-6.8).lineTo(6,-6.8).lineTo(6,6.6).lineTo(3.2,6.6).lineTo(3.2,4.5).curveTo(2.7,5.7,1.5,6.3).curveTo(0.4,6.8,-1,6.8).curveTo(-3.4,6.8,-4.7,5.3).closePath();
	this.shape.setTransform(-35.1,-26.925);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.5,6.1).curveTo(-5.1,5.2,-5.9,3.6).curveTo(-6.8,2,-6.8,-0).curveTo(-6.8,-2.1,-5.9,-3.6).curveTo(-5.1,-5.2,-3.5,-6.1).curveTo(-2,-7,-0,-7).curveTo(2,-7,3.5,-6.1).curveTo(5,-5.2,5.9,-3.6).curveTo(6.8,-2.1,6.8,-0).curveTo(6.8,2,5.9,3.6).curveTo(5,5.2,3.5,6.1).curveTo(2,7,-0,7).curveTo(-2,7,-3.5,6.1).closePath().moveTo(-2.8,-3.1).curveTo(-3.9,-1.9,-3.9,-0).curveTo(-3.9,1.9,-2.8,3).curveTo(-1.7,4.2,-0,4.2).curveTo(1.7,4.2,2.8,3).curveTo(3.8,1.9,3.8,-0).curveTo(3.8,-1.9,2.8,-3.1).curveTo(1.7,-4.2,-0,-4.2).curveTo(-1.7,-4.2,-2.8,-3.1).closePath();
	this.shape_1.setTransform(-50.475,-27.025);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.2,12.2).lineTo(-3,9.6).lineTo(-2.2,9.6).curveTo(-1.2,9.6,-0.7,9).curveTo(-0.1,8.4,-0.1,6.9).lineTo(-0.1,-6.1).lineTo(2.8,-6.1).lineTo(2.8,7.2).curveTo(2.8,9.6,1.6,11).curveTo(0.5,12.3,-1.8,12.3).curveTo(-2.7,12.3,-3.2,12.2).closePath().moveTo(0,-9.2).curveTo(-0.5,-9.7,-0.5,-10.5).curveTo(-0.5,-11.3,0,-11.8).curveTo(0.5,-12.3,1.4,-12.3).curveTo(2.1,-12.3,2.7,-11.8).curveTo(3.2,-11.3,3.3,-10.5).curveTo(3.2,-9.7,2.7,-9.2).curveTo(2.1,-8.7,1.4,-8.7).curveTo(0.5,-8.7,0,-9.2).closePath();
	this.shape_2.setTransform(-62.85,-27.675);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-4,6.8).lineTo(-4,-6.6).lineTo(-1.3,-6.6).lineTo(-1.3,-4.3).curveTo(-0.2,-6.8,2.3,-6.8).curveTo(3.2,-6.8,4,-6.4).lineTo(3.5,-3.6).curveTo(2.8,-3.8,2.2,-3.8).curveTo(0.6,-3.8,-0.2,-2.8).curveTo(-1.1,-1.9,-1.1,0.1).lineTo(-1.1,6.8).closePath();
	this.shape_3.setTransform(-75.25,-27.15);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.5,6.1).curveTo(-5.1,5.2,-5.9,3.6).curveTo(-6.8,2,-6.8,-0).curveTo(-6.8,-2.1,-5.9,-3.6).curveTo(-5.1,-5.2,-3.5,-6.1).curveTo(-2,-7,-0,-7).curveTo(2,-7,3.5,-6.1).curveTo(5,-5.2,5.9,-3.6).curveTo(6.8,-2.1,6.8,-0).curveTo(6.8,2,5.9,3.6).curveTo(5,5.2,3.5,6.1).curveTo(2,7,-0,7).curveTo(-2,7,-3.5,6.1).closePath().moveTo(-2.8,-3.1).curveTo(-3.9,-1.9,-3.9,-0).curveTo(-3.9,1.9,-2.8,3).curveTo(-1.7,4.2,-0,4.2).curveTo(1.7,4.2,2.8,3).curveTo(3.8,1.9,3.8,-0).curveTo(3.8,-1.9,2.8,-3.1).curveTo(1.7,-4.2,-0,-4.2).curveTo(-1.7,-4.2,-2.8,-3.1).closePath();
	this.shape_4.setTransform(-88.825,-27.025);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-3.5,6.1).curveTo(-5.1,5.2,-5.9,3.6).curveTo(-6.8,2,-6.8,-0).curveTo(-6.8,-2.1,-5.9,-3.6).curveTo(-5.1,-5.2,-3.5,-6.1).curveTo(-2,-7,-0,-7).curveTo(2,-7,3.5,-6.1).curveTo(5,-5.2,5.9,-3.6).curveTo(6.8,-2.1,6.8,-0).curveTo(6.8,2,5.9,3.6).curveTo(5,5.2,3.5,6.1).curveTo(2,7,-0,7).curveTo(-2,7,-3.5,6.1).closePath().moveTo(-2.8,-3.1).curveTo(-3.9,-1.9,-3.9,-0).curveTo(-3.9,1.9,-2.8,3).curveTo(-1.7,4.2,-0,4.2).curveTo(1.7,4.2,2.8,3).curveTo(3.8,1.9,3.8,-0).curveTo(3.8,-1.9,2.8,-3.1).curveTo(1.7,-4.2,-0,-4.2).curveTo(-1.7,-4.2,-2.8,-3.1).closePath();
	this.shape_5.setTransform(-104.275,-27.025);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.beginFill("#FFFFFF").beginStroke().moveTo(-1.6,9.4).lineTo(-9.4,-9.4).lineTo(-5.9,-9.4).lineTo(-0,5.9).lineTo(5.9,-9.4).lineTo(9.4,-9.4).lineTo(1.6,9.4).closePath();
	this.shape_6.setTransform(-121.5,-29.7);
...
if (reversed == null) { reversed = false; }
	...
	mask_2._off = true;
	mask_2.graphics.moveTo(-130,24.5).lineTo(-130,-5.5).lineTo(130,-5.5).lineTo(130,24.5).closePath();
	mask_2.setTransform(-1.9791,24.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1791.75,463.35,2.9999,2.9999,19.2486,0,0,-114,37.7);

	this.instance_1 = new lib.crowbar_front("synched",0);
	this.instance_1.setTransform(-358.75,115.1,2.9999,2.9999,-2.9509,0,0,-114,33);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regX:0,regY:0,scaleY:3,rotation:18.4717,x:-1373.6352,y:450.8559},0).wait(1).to({scaleY:2.9999,rotation:17.71,x:-1316.9091,y:432.7319},0).wait(1).to({rotation:16.9645,x:-1261.4442,y:414.9918},0).wait(1).to({scaleY:3,rotation:16.235,x:-1207.2365,y:397.6363},0).wait(1).to({scaleY:2.9999,rotation:15.5216,x:-1154.282,y:380.6659},0).wait(1).to({rotation:14.824,x:-1102.5478,y:364.072},0).wait(1).to({rotation:14.1428,x:-1052.0885,y:347.8737},0).wait(1).to({scaleY:3,rotation:13.4774,x:-1002.8423,y:332.0526},0).wait(1).to({rotation:12.828,x:-954.8346,y:316.6183},0).wait(1).to({scaleY:2.9999,rotation:12.1944,x:-908.033,y:301.5617},0).wait(1).to({rotation:11.5773,x:-862.4922,y:286.9017},0).wait(1).to({rotation:10.9759,x:-818.1508,y:272.6197},0).wait(1).to({rotation:10.3906,x:-775.0347,y:258.725},0).wait(1).to({rotation:9.8218,x:-733.1696,y:245.2269},0).wait(1).to({scaleY:3,rotation:9.2683,x:-692.4658,y:232.0974},0).wait(1).to({scaleY:2.9999,rotation:8.7313,x:-653.0071,y:219.3643},0).wait(1).to({rotation:8.21,x:-614.7328,y:207.0088},0).wait(1).to({rotation:7.7053,x:-577.6978,y:195.0493},0).wait(1).to({rotation:7.2162,x:-541.8419,y:183.467},0).wait(1).to({scaleY:3,rotation:6.7432,x:-507.1914,y:172.2709},0).wait(1).to({scaleY:2.9999,rotation:6.286,x:-473.7148,y:161.4515},0).wait(1).to({scaleY:3,rotation:5.8453,x:-441.4674,y:151.027},0).wait(1).to({scaleY:2.9999,rotation:5.4202,x:-410.3894,y:140.9785},0).wait(1).to({scaleY:3,rotation:5.0117,x:-380.5359,y:131.3242},0).wait(1).to({scaleY:2.9999,rotation:4.6189,x:-351.8475,y:122.0451},0).wait(1).to({scaleY:3,rotation:4.2418,x:-324.322,y:113.141},0).wait(1).to({rotation:3.8812,x:-298.015,y:104.63},0).wait(1).to({scaleY:2.9999,rotation:3.5363,x:-272.8672,y:96.4932},0).wait(1).to({scaleY:3,rotation:3.2079,x:-248.934,y:88.7487},0).wait(1).to({rotation:2.8952,x:-226.1566,y:81.3776},0).wait(1).to({scaleY:2.9999,rotation:2.5986,x:-204.562,y:74.3888},0).wait(1).to({scaleY:3,rotation:2.3177,x:-184.12,y:67.7727},0).wait(1).to({rotation:2.0534,x:-164.8865,y:61.5474},0).wait(1).to({scaleY:2.9999,rotation:1.8047,x:-146.8028,y:55.694},0).wait(1).to({scaleY:3,rotation:1.5722,x:-129.8962,y:50.2216},0).wait(1).to({scaleX:3,rotation:1.3557,x:-114.1657,y:45.1296},0).wait(1).to({scaleX:2.9999,scaleY:2.9999,rotation:1.1554,x:-99.6101,y:40.4179},0).wait(1).to({rotation:0.9711,x:-86.2283,y:36.0862},0).wait(1).to({rotation:0.8026,x:-73.991,y:32.1248},0).wait(1).to({rotation:0.6506,x:-62.9542,y:28.5521},0).wait(1).to({scaleY:3,rotation:0.5143,x:-53.0603,y:25.3493},0).wait(1).to({rotation:0.3941,x:-44.337,y:22.5254},0).wait(1).to({rotation:0.2896,x:-36.7552,y:20.0711},0).wait(1).to({scaleY:2.9999,rotation:0.2016,x:-30.3715,y:18.0046},0).wait(1).to({rotation:0.1293,x:-25.1283,y:16.3073},0).wait(1).to({rotation:0.0731,x:-21.0538,y:14.9883},0).wait(1).to({rotation:0.0331,x:-18.1477,y:14.0476},0).wait(1).to({rotation:0.0091,x:-16.4098,y:13.485},0).wait(1).to({rotation:0.0009,x:-15.8115,y:13.2913},0).wait(1).to({regX:-113.9,regY:37.7,scaleX:2.9998,rotation:-0.0828,x:-358.1,y:125.85},0).wait(1).to({regX:0,regY:0,scaleX:2.9999,rotation:-0.203,x:-16.784,y:11.532},0).wait(1).to({scaleY:3,rotation:-0.3225,x:-17.0231,y:10.8204},0).wait(1).to({rotation:-0.442,x:-17.2638,y:10.1094},0).wait(1).to({scaleX:3,rotation:-0.5615,x:-17.5059,y:9.3988},0).wait(1).to({scaleX:2.9999,rotation:-0.681,x:-17.7495,y:8.6888},0).wait(1).to({scaleY:2.9999,rotation:-0.8005,x:-17.9946,y:7.9792},0).wait(1).to({rotation:-0.92,x:-18.2411,y:7.2702},0).wait(1).to({rotation:-1.0395,x:-18.4892,y:6.5617},0).wait(1).to({scaleX:3,scaleY:3,rotation:-1.159,x:-18.7387,y:5.8537},0).wait(1).to({rotation:-1.2785,x:-18.9897,y:5.1462},0).wait(1).to({scaleX:2.9999,rotation:-1.398,x:-19.2421,y:4.4392},0).wait(1).to({rotation:-1.5175,x:-19.4961,y:3.7328},0).wait(1).to({scaleY:2.9999,rotation:-1.637,x:-19.7515,y:3.0269},0).wait(1).to({rotation:-1.7565,x:-20.0084,y:2.3216},0).wait(1).to({rotation:-1.876,x:-20.2667,y:1.6168},0).wait(1).to({scaleY:3,rotation:-1.9955,x:-20.5265,y:0.9125},0).wait(1).to({rotation:-2.115,x:-20.7878,y:0.2087},0).wait(1).to({rotation:-2.2345,x:-21.0506,y:-0.4945},0).wait(1).to({scaleX:3,rotation:-2.354,x:-21.3148,y:-1.1971},0).wait(1).to({scaleX:2.9999,rotation:-2.4735,x:-21.5805,y:-1.8992},0).wait(1).to({scaleY:2.9999,rotation:-2.593,x:-21.8477,y:-2.6007},0).wait(1).to({rotation:-2.7125,x:-22.1163,y:-3.3017},0).wait(1).to({rotation:-2.832,x:-22.3864,y:-4.0021},0).to({_off:true},1).wait(86).to({_off:false,regX:-104,regY:40.2,scaleX:2.8913,scaleY:2.8914,rotation:30.7473,x:-310.05,y:160.3},0).wait(1).to({regX:0,regY:0,scaleX:2.8914,scaleY:2.8915,rotation:30.4754,x:11.6349,y:213.2637},0).wait(1).to({scaleX:2.8913,rotation:30.2032,x:15.4583,y:213.6149},0).wait(1).to({rotation:29.9309,x:19.2746,y:215.2155},0).wait(1).to({scaleX:2.8914,rotation:29.6587,x:23.0836,y:218.0655},0).wait(1).to({scaleX:2.8913,scaleY:2.8914,rotation:29.3865,x:26.8855,y:222.149},0).wait(1).to({scaleX:2.8914,scaleY:2.8915,rotation:29.1143,x:30.6801,y:227.4819},0).wait(1).to({scaleX:2.8913,rotation:28.8421,x:34.4675,y:234.0642},0).wait(1).to({scaleY:2.8914,rotation:28.5699,x:38.2478,y:241.8882},0).wait(1).to({scaleX:2.8914,scaleY:2.8915,rotation:28.2976,x:42.0208,y:250.9537},0).wait(1).to({scaleX:2.8913,scaleY:2.8914,rotation:28.0254,x:45.7866,y:261.2608},0).wait(1).to({scaleX:2.8914,scaleY:2.8915,rotation:27.7532,x:49.5451,y:272.8175},0).wait(1).to({rotation:27.481,x:53.2964,y:285.6239},0).wait(1).to({scaleX:2.8913,rotation:27.2088,x:57.0405,y:299.6641},0).wait(1).to({scaleX:2.8914,rotation:26.9366,x:60.7774,y:314.9619},0).wait(1).to({scaleX:2.8913,rotation:26.6643,x:64.507,y:331.4936},0).wait(1).to({scaleX:2.8914,rotation:26.3921,x:68.2293,y:349.275},0).wait(1).to({rotation:26.1199,x:71.9444,y:368.2983},0).wait(1).to({scaleX:2.8913,scaleY:2.8914,rotation:25.8477,x:75.6523,y:388.5715},0).wait(1).to({scaleX:2.8914,scaleY:2.8915,rotation:25.5755,x:79.3529,y:410.0866},0).wait(1).to({scaleX:2.8913,rotation:25.3032,x:83.0462,y:432.8436},0).wait(1).to({scaleY:2.8914,rotation:25.031,x:86.7323,y:456.8507},0).wait(1).to({scaleX:2.8914,scaleY:2.8915,rotation:24.7588,x:90.4111,y:482.0997},0).wait(1).to({scaleX:2.8913,rotation:24.4866,x:94.0827,y:508.5988},0).wait(1).to({scaleX:2.8914,rotation:24.2144,x:97.747,y:536.3399},0).wait(1).to({rotation:23.9422,x:101.404,y:565.3232},0).wait(1).to({scaleX:2.8913,scaleY:2.8914,rotation:23.6699,x:105.0537,y:595.5487},0).wait(1).to({scaleY:2.8915,rotation:23.3977,x:108.6962,y:627.0323},0).wait(1).to({scaleX:2.8914,rotation:23.1255,x:112.3314,y:581.1843},0).wait(1).to({scaleX:2.8913,scaleY:2.8914,rotation:22.8533,x:115.9593,y:542.162},0).wait(1).to({scaleX:2.8914,scaleY:2.8915,rotation:22.5811,x:119.58,y:509.9494},0).wait(1).to({rotation:22.3089,x:123.1933,y:484.5626},0).wait(1).to({scaleX:2.8913,rotation:22.0366,x:126.7994,y:465.9856},0).wait(1).to({scaleX:2.8914,rotation:21.7644,x:130.3982,y:454.2265},0).wait(1).to({rotation:21.4922,x:133.9898,y:449.2853},0).wait(1).to({scaleX:2.8913,rotation:21.22,x:137.574,y:451.162},0).wait(1).to({scaleX:2.8914,rotation:20.9478,x:141.151,y:459.8566},0).wait(1).to({rotation:20.6756,x:144.7207,y:475.3692},0).wait(1).to({scaleX:2.8913,rotation:20.4033,x:148.2831,y:497.6919},0).wait(1).to({scaleX:2.8914,rotation:20.1311,x:151.8382,y:526.8406},0).wait(1).to({scaleX:2.8913,rotation:19.8589,x:155.3861,y:562.7995},0).wait(1).to({scaleX:2.8914,rotation:19.5867,x:158.9266,y:605.5844},0).wait(1).to({rotation:19.3145,x:162.4599,y:579.7757},0).wait(1).to({scaleX:2.8913,rotation:19.0422,x:165.9859,y:560.0365},0).wait(1).to({scaleX:2.8914,rotation:18.77,x:169.5047,y:546.3748},0).wait(1).to({rotation:18.4978,x:173.0162,y:538.7746},0).wait(1).to({scaleX:2.8913,scaleY:2.8914,rotation:18.2256,x:176.5203,y:537.2441},0).wait(1).to({scaleX:2.8914,scaleY:2.8915,rotation:17.9534,x:180.0173,y:541.7832},0).wait(1).to({rotation:17.6812,x:183.5069,y:552.384},0).wait(1).to({scaleX:2.8913,rotation:17.4089,x:186.9893,y:569.0625},0).wait(1).to({rotation:17.1367,x:190.4644,y:591.8107},0).wait(1).to({scaleX:2.8914,rotation:16.8645,x:193.9323,y:579.2111},0).wait(1).to({scaleX:2.8913,scaleY:2.8914,rotation:16.5923,x:197.3929,y:570.2999},0).wait(1).to({scaleX:2.8914,scaleY:2.8915,rotation:16.3201,x:200.8463,y:565.0849},0).wait(1).to({rotation:16.0479,x:204.2923,y:563.5583},0).wait(1).to({scaleX:2.8913,rotation:15.7756,x:207.7312,y:565.72},0).wait(1).to({rotation:15.5034,x:211.1628,y:571.5782},0).wait(1).to({scaleX:2.8914,rotation:15.2312,x:214.5871,y:581.1249},0).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(74).to({_off:false},0).wait(1).to({regX:0,regY:0,scaleX:2.9762,scaleY:2.9762,rotation:-2.8777,x:-24.5568,y:-0.0785},0).wait(1).to({scaleX:2.9535,scaleY:2.9535,rotation:-2.6503,x:-25.8766,y:1.8884},0).wait(1).to({scaleX:2.9319,scaleY:2.932,rotation:-2.256,x:-26.2783,y:4.6159},0).wait(1).to({scaleX:2.9113,scaleY:2.9113,rotation:-1.6875,x:-25.7985,y:8.1411},0).wait(1).to({scaleX:2.8916,scaleY:2.8917,rotation:-0.9329,x:-24.4689,y:12.5282},0).wait(1).to({scaleX:2.8729,scaleY:2.873,rotation:0.0196,x:-22.3459,y:17.8478},0).wait(1).to({scaleX:2.8552,scaleY:2.8552,rotation:1.1773,x:-19.5117,y:24.1498},0).wait(1).to({scaleX:2.8382,scaleY:2.8382,rotation:2.5506,x:-16.0587,y:31.5033},0).wait(1).to({scaleX:2.8221,scaleY:2.8222,rotation:4.1425,x:-12.1069,y:39.9366},0).wait(1).to({scaleX:2.8068,scaleY:2.8069,rotation:5.9529,x:-7.8,y:49.4629},0).wait(1).to({scaleX:2.7922,scaleY:2.7923,rotation:7.9789,x:-3.2984,y:60.0765},0).wait(1).to({scaleX:2.7785,scaleY:2.7786,rotation:10.2072,x:1.2239,y:71.7075},0).wait(1).to({scaleX:2.7654,scaleY:2.7655,rotation:12.6157,x:5.578,y:84.2316},0).wait(1).to({scaleX:2.753,scaleY:2.7531,rotation:15.1748,x:9.5947,y:97.4731},0).wait(1).to({scaleX:2.7412,scaleY:2.7413,rotation:17.8432,x:13.1231,y:111.1844},0).wait(1).to({scaleX:2.7299,scaleY:2.73,rotation:20.5736,x:16.064,y:125.0792},0).wait(1).to({scaleX:2.7194,scaleY:2.7194,rotation:23.3143,x:18.3608,y:138.8512},0).wait(1).to({scaleX:2.7092,scaleY:2.7093,rotation:26.0137,x:20.0227,y:152.1991},0).wait(1).to({scaleX:2.6997,scaleY:2.6997,rotation:28.6215,x:21.1005,y:164.8463},0).wait(1).to({scaleX:2.6906,scaleY:2.6907,rotation:31.0964,x:21.6904,y:176.5796},0).wait(1).to({scaleX:2.6819,scaleY:2.682,rotation:33.406,x:21.8978,y:187.2521},0).wait(1).to({scaleX:2.6736,scaleY:2.6737,rotation:35.5265,x:21.8358,y:196.7773},0).wait(1).to({scaleX:2.6656,scaleY:2.6657,rotation:37.4417,x:21.6049,y:205.1191},0).wait(1).to({scaleX:2.6581,scaleY:2.6582,rotation:39.1473,x:21.2833,y:212.3069},0).wait(1).to({scaleX:2.6508,scaleY:2.6509,rotation:40.6388,x:20.9395,y:218.3728},0).wait(1).to({scaleX:2.6438,scaleY:2.6439,rotation:41.9235,x:20.5994,y:223.4039},0).wait(1).to({scaleX:2.637,scaleY:2.6371,rotation:43.0059,x:20.2816,y:227.4712},0).wait(1).to({scaleX:2.6305,scaleY:2.6306,rotation:43.8948,x:19.9889,y:230.6569},0).wait(1).to({scaleX:2.624,scaleY:2.6241,rotation:44.5992,x:19.7067,y:233.0402},0).wait(1).to({scaleX:2.6178,scaleY:2.6179,rotation:45.1294,x:19.4104,y:234.699},0).wait(1).to({scaleX:2.6116,scaleY:2.6117,rotation:45.4956,x:19.0656,y:235.7055},0).wait(1).to({scaleX:2.6055,scaleY:2.6056,rotation:45.7097,x:18.6369,y:236.1315},0).wait(1).to({scaleX:2.5994,scaleY:2.5995,rotation:45.7791,x:18.0851,y:236.0241},0).wait(1).to({regX:-111.7,regY:38.2,scaleX:2.5827,scaleY:2.5828,rotation:45.2621,x:-254.1,y:93.2},0).wait(1).to({regX:0,regY:0,rotation:44.8868,x:20.1032,y:226.8613},0).wait(1).to({rotation:44.512,x:21.1384,y:225.066},0).wait(1).to({rotation:44.1373,x:22.1619,y:223.2651},0).wait(1).to({rotation:43.7625,x:23.1736,y:221.4586},0).wait(1).to({rotation:43.3877,x:24.1735,y:219.6466},0).wait(1).to({rotation:43.0129,x:25.1615,y:217.8292},0).wait(1).to({rotation:42.6381,x:26.1376,y:216.0064},0).wait(1).to({rotation:42.2633,x:27.1018,y:214.1784},0).wait(1).to({rotation:41.8886,x:28.0539,y:212.3453},0).wait(1).to({rotation:41.5138,x:28.9941,y:210.507},0).wait(1).to({rotation:41.139,x:29.9222,y:208.6637},0).wait(1).to({regX:-109.8,regY:41.2,scaleX:2.5826,rotation:41.7128,x:-253,y:101.2},0).wait(1).to({regX:0,regY:0,scaleX:2.5827,rotation:43.2097,x:33.4151,y:218.759},0).wait(1).to({rotation:44.5765,x:39.4596,y:226.6473},0).wait(1).to({rotation:45.8146,x:47.3515,y:234.0925},0).wait(1).to({rotation:46.9225,x:56.6374,y:241.0323},0).wait(1).to({rotation:47.9017,x:66.7643,y:247.407},0).wait(1).to({rotation:48.7515,x:77.0839,y:253.131},0).wait(1).to({rotation:49.471,x:86.9522,y:258.119},0).wait(1).to({rotation:50.0618,x:95.7671,y:262.3024},0).wait(1).to({rotation:50.5224,x:103.0354,y:265.6113},0).wait(1).to({rotation:50.8543,x:108.4175,y:268.0116},0).wait(1).to({scaleY:2.5829,rotation:51.0559,x:111.7006,y:269.4698},0).wait(1).to({scaleY:2.5828,rotation:51.1289,x:112.7904,y:269.9833},0).wait(1).to({regX:-109.9,regY:41,scaleX:2.5825,scaleY:2.5826,x:-147.85,y:116.15},0).wait(5).to({regX:-106.2,regY:43.1,scaleX:2.5827,scaleY:2.5828,rotation:50.9673,x:-145.1,y:128.1},0).wait(1).to({regX:0,regY:0,scaleX:2.5836,scaleY:2.5837,rotation:50.9038,x:113.7719,y:270.9478},0).wait(1).to({scaleX:2.5865,scaleY:2.5866,rotation:50.7059,x:112.7157,y:270.6237},0).wait(1).to({scaleX:2.5914,scaleY:2.5915,rotation:50.3615,x:110.8406,y:270.0583},0).wait(1).to({scaleX:2.5987,scaleY:2.5988,rotation:49.8571,x:108.0703,y:269.2128},0).wait(1).to({scaleX:2.6084,scaleY:2.6085,rotation:49.1819,x:104.2952,y:268.0544},0).wait(1).to({scaleX:2.6207,scaleY:2.6209,rotation:48.3233,x:99.4388,y:266.525},0).wait(1).to({scaleX:2.6359,scaleY:2.636,rotation:47.2746,x:93.4585,y:264.5629},0).wait(1).to({scaleX:2.6537,scaleY:2.6538,rotation:46.0338,x:86.3646,y:262.0971},0).wait(1).to({scaleX:2.6742,scaleY:2.6743,rotation:44.6087,x:78.2928,y:259.05},0).wait(1).to({scaleX:2.697,scaleY:2.6971,rotation:43.0236,x:69.4912,y:255.3736},0).wait(1).to({scaleX:2.7215,scaleY:2.7217,rotation:41.32,x:60.3358,y:251.0663},0).wait(1).to({scaleX:2.7469,scaleY:2.747,rotation:39.5573,x:51.2712,y:246.2059},0).wait(1).to({scaleX:2.7721,scaleY:2.7722,rotation:37.8101,x:42.7364,y:240.9781},0).wait(1).to({scaleX:2.7959,scaleY:2.796,rotation:36.1571,x:35.0362,y:235.6677},0).wait(1).to({scaleX:2.8173,scaleY:2.8174,rotation:34.666,x:28.3781,y:230.5831},0).wait(1).to({scaleX:2.8357,scaleY:2.8358,rotation:33.3864,x:22.842,y:226.008},0).wait(1).to({scaleX:2.8507,scaleY:2.8508,rotation:32.3464,x:18.4505,y:222.1502},0).wait(1).to({scaleX:2.8621,scaleY:2.8622,rotation:31.5558,x:15.1607,y:219.1378},0).wait(1).to({scaleX:2.8699,scaleY:2.87,rotation:31.0096,x:12.9147,y:217.0167},0).wait(1).to({scaleX:2.8744,scaleY:2.8745,rotation:30.6953,x:11.6259,y:215.7826},0).wait(1).to({scaleX:2.8759,scaleY:2.876,rotation:30.5944,x:11.2143,y:215.3841},0).to({_off:true},1).wait(58));
	...
	this.instance_6.setTransform(-358.65,114.9,2.9999,2.9999,-2.9509,0,0,-114,33);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(74).to({_off:false},0).wait(1).to({regX:0,regY:0,scaleX:2.9762,scaleY:2.9762,rotation:-2.8777,x:-24.4565,y:-0.2773},0).wait(1).to({scaleX:2.9535,scaleY:2.9535,rotation:-2.6503,x:-25.7757,y:1.6907},0).wait(1).to({scaleX:2.9319,scaleY:2.932,rotation:-2.256,x:-26.1763,y:4.4192},0).wait(1).to({scaleX:2.9113,scaleY:2.9113,rotation:-1.6875,x:-25.6951,y:7.9454},0).wait(1).to({scaleX:2.8916,scaleY:2.8917,rotation:-0.9329,x:-24.3636,y:12.3334},0).wait(1).to({scaleX:2.8729,scaleY:2.873,rotation:0.0196,x:-22.2382,y:17.654},0).wait(1).to({scaleX:2.8552,scaleY:2.8552,rotation:1.1773,x:-19.401,y:23.9569},0).wait(1).to({scaleX:2.8382,scaleY:2.8382,rotation:2.5506,x:-15.9446,y:31.3113},0).wait(1).to({scaleX:2.8221,scaleY:2.8222,rotation:4.1425,x:-11.989,y:39.7456},0).wait(1).to({scaleX:2.8068,scaleY:2.8069,rotation:5.9529,x:-7.6777,y:49.2731},0).wait(1).to({scaleX:2.7922,scaleY:2.7923,rotation:7.9789,x:-3.1713,y:59.888},0).wait(1).to({scaleX:2.7785,scaleY:2.7786,rotation:10.2072,x:1.3562,y:71.5206},0).wait(1).to({scaleX:2.7654,scaleY:2.7655,rotation:12.6157,x:5.7159,y:84.0465},0).wait(1).to({scaleX:2.753,scaleY:2.7531,rotation:15.1748,x:9.7385,y:97.2901},0).wait(1).to({scaleX:2.7412,scaleY:2.7413,rotation:17.8432,x:13.2728,y:111.0038},0).wait(1).to({scaleX:2.7299,scaleY:2.73,rotation:20.5736,x:16.2197,y:124.9012},0).wait(1).to({scaleX:2.7194,scaleY:2.7194,rotation:23.3143,x:18.5223,y:138.6761},0).wait(1).to({scaleX:2.7092,scaleY:2.7093,rotation:26.0137,x:20.1898,y:152.0271},0).wait(1).to({scaleX:2.6997,scaleY:2.6997,rotation:28.6215,x:21.2729,y:164.6776},0).wait(1).to({scaleX:2.6906,scaleY:2.6907,rotation:31.0964,x:21.8676,y:176.4142},0).wait(1).to({scaleX:2.6819,scaleY:2.682,rotation:33.406,x:22.0793,y:187.09},0).wait(1).to({scaleX:2.6736,scaleY:2.6737,rotation:35.5265,x:22.0212,y:196.6183},0).wait(1).to({scaleX:2.6656,scaleY:2.6657,rotation:37.4417,x:21.7936,y:204.963},0).wait(1).to({scaleX:2.6581,scaleY:2.6582,rotation:39.1473,x:21.4749,y:212.1536},0).wait(1).to({scaleX:2.6508,scaleY:2.6509,rotation:40.6388,x:21.1335,y:218.222},0).wait(1).to({scaleX:2.6438,scaleY:2.6439,rotation:41.9235,x:20.7955,y:223.2553},0).wait(1).to({scaleX:2.637,scaleY:2.6371,rotation:43.0059,x:20.4793,y:227.3246},0).wait(1).to({scaleX:2.6305,scaleY:2.6306,rotation:43.8948,x:20.1878,y:230.5119},0).wait(1).to({scaleX:2.624,scaleY:2.6241,rotation:44.5992,x:19.9066,y:232.8966},0).wait(1).to({scaleX:2.6178,scaleY:2.6179,rotation:45.1294,x:19.6109,y:234.5565},0).wait(1).to({scaleX:2.6116,scaleY:2.6117,rotation:45.4956,x:19.2665,y:235.5638},0).wait(1).to({scaleX:2.6055,scaleY:2.6056,rotation:45.7097,x:18.8379,y:235.9904},0).wait(1).to({scaleX:2.5994,scaleY:2.5995,rotation:45.7791,x:18.286,y:235.8833},0).wait(1).to({regX:-111.7,regY:38.2,scaleX:2.5827,scaleY:2.5828,rotation:45.2621,x:-254.1,y:93.05},0).wait(1).to({regX:0,regY:0,rotation:44.8868,x:20.102,y:226.7113},0).wait(1).to({rotation:44.512,x:21.136,y:224.916},0).wait(1).to({rotation:44.1373,x:22.1583,y:223.1151},0).wait(1).to({rotation:43.7625,x:23.1689,y:221.3086},0).wait(1).to({rotation:43.3877,x:24.1675,y:219.4966},0).wait(1).to({rotation:43.0129,x:25.1543,y:217.6793},0).wait(1).to({rotation:42.6381,x:26.1292,y:215.8566},0).wait(1).to({rotation:42.2633,x:27.0922,y:214.0286},0).wait(1).to({rotation:41.8886,x:28.0432,y:212.1955},0).wait(1).to({rotation:41.5138,x:28.9822,y:210.3573},0).wait(1).to({rotation:41.139,x:29.9091,y:208.5141},0).wait(1).to({regX:-109.7,regY:41.2,scaleX:2.5826,rotation:41.7128,x:-252.9,y:101.25},0).wait(1).to({regX:0,regY:0,scaleX:2.5827,rotation:43.2097,x:33.3174,y:218.6065},0).wait(1).to({rotation:44.5765,x:39.364,y:226.4926},0).wait(1).to({rotation:45.8146,x:47.2579,y:233.9358},0).wait(1).to({rotation:46.9225,x:56.5456,y:240.8739},0).wait(1).to({rotation:47.9017,x:66.6742,y:247.2471},0).wait(1).to({rotation:48.7515,x:76.9952,y:252.9699},0).wait(1).to({rotation:49.471,x:86.8647,y:257.9568},0).wait(1).to({rotation:50.0618,x:95.6806,y:262.1393},0).wait(1).to({rotation:50.5224,x:102.9497,y:265.4476},0).wait(1).to({rotation:50.8543,x:108.3324,y:267.8473},0).wait(1).to({scaleY:2.5829,rotation:51.0559,x:111.6158,y:269.3053},0).wait(1).to({scaleY:2.5828,rotation:51.1289,x:112.7058,y:269.8187},0).wait(1).to({regX:-109.9,regY:41,scaleX:2.5825,scaleY:2.5826,x:-147.85,y:116.15},0).wait(5).to({regX:-106.2,regY:43,scaleX:2.5827,scaleY:2.5828,rotation:50.9673,x:-145.05,y:127.85},0).wait(1).to({regX:0,regY:0,scaleX:2.5836,scaleY:2.5837,rotation:50.9038,x:113.6218,y:270.848},0).wait(1).to({scaleX:2.5865,scaleY:2.5866,rotation:50.7059,x:112.5653,y:270.5245},0).wait(1).to({scaleX:2.5914,scaleY:2.5915,rotation:50.3615,x:110.6898,y:269.9601},0).wait(1).to({scaleX:2.5987,scaleY:2.5988,rotation:49.8571,x:107.9188,y:269.1162},0).wait(1).to({scaleX:2.6084,scaleY:2.6085,rotation:49.1819,x:104.1429,y:267.96},0).wait(1).to({scaleX:2.6207,scaleY:2.6209,rotation:48.3233,x:99.2855,y:266.4332},0).wait(1).to({scaleX:2.6359,scaleY:2.636,rotation:47.2746,x:93.3039,y:264.4745},0).wait(1).to({scaleX:2.6537,scaleY:2.6538,rotation:46.0338,x:86.2086,y:262.0127},0).wait(1).to({scaleX:2.6742,scaleY:2.6743,rotation:44.6087,x:78.1353,y:258.9702},0).wait(1).to({scaleX:2.697,scaleY:2.6971,rotation:43.0236,x:69.3322,y:255.2991},0).wait(1).to({scaleX:2.7215,scaleY:2.7217,rotation:41.32,x:60.1754,y:250.9976},0).wait(1).to({scaleX:2.7469,scaleY:2.747,rotation:39.5573,x:51.1095,y:246.1433},0).wait(1).to({scaleX:2.7721,scaleY:2.7722,rotation:37.8101,x:42.5735,y:240.9216},0).wait(1).to({scaleX:2.7959,scaleY:2.796,rotation:36.1571,x:34.8725,y:235.6171},0).wait(1).to({scaleX:2.8173,scaleY:2.8174,rotation:34.666,x:28.2137,y:230.5378},0).wait(1).to({scaleX:2.8357,scaleY:2.8358,rotation:33.3864,x:22.6772,y:225.9674},0).wait(1).to({scaleX:2.8507,scaleY:2.8508,rotation:32.3464,x:18.2855,y:222.1133},0).wait(1).to({scaleX:2.8621,scaleY:2.8622,rotation:31.5558,x:14.9955,y:219.1039},0).wait(1).to({scaleX:2.8699,scaleY:2.87,rotation:31.0096,x:12.7494,y:216.9848},0).wait(1).to({scaleX:2.8744,scaleY:2.8745,rotation:30.6953,x:11.4605,y:215.7518},0).wait(1).to({scaleX:2.8759,scaleY:2.876,rotation:30.5944,x:11.0489,y:215.3537},0).to({_off:true},1).wait(58));
...
p.nominalBounds = new cjs.Rectangle(-1865.2,-540,2520.7,1453.2);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"./Breaking.jpg?1614342838768", id:"Breaking"},
		{src:"./crowbar.png?1614342838768", id:"crowbar"},
		{src:"./schadow.png?1614342838768", id:"schadow"}
	],
	preloads: []
};
