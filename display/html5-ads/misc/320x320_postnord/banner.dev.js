...
bannerboy.main = function() {
	...
	// banner container
	var banner = bannerboy.createElement({width: width, height: height, backgroundColor: "black", overflow: "hidden", cursor: "pointer", parent: document.body});
	...
	bannerboy.preloadImages(images, function() {
		...
		// create elements
		bg = bannerboy.createElement({id: "bg", backgroundColor: "#fff", width: width, height: height, parent: banner});
		copy1 = bannerboy.createElement({backgroundImage: copy1Asset, top: 32, retina: true, parent: banner});
		copy2 = bannerboy.createElement({backgroundImage: copy2Asset, top: 255, retina: true, parent: banner});
		border = bannerboy.createElement({id: "border", width: width, height: height, parent: banner});
		
		// box elements
		boxOuter = bannerboy.createElement({width: boxWidth, height: boxHeight, parent: banner});
		boxInner = bannerboy.createElement({width: boxWidth, height: boxHeight, top: 0, parent: boxOuter});

		boxWallLeft = bannerboy.createElement({backgroundColor: "#0099ba", width: boxHeight, height: boxHeight,
			left: 0,
			rotationY: 90,
			rotationZ: 0,
		...
		boxWallRight = bannerboy.createElement({backgroundColor: "#0099ba", width: boxHeight, height: boxHeight,
			right: 0,
			rotationY: -90,
			rotationZ: 0,
		...
		boxWallBack = bannerboy.createElement({backgroundColor: "#0099ba", width: boxWidth, height: boxHeight,
			rotationX: 0,
			rotationZ: 0,
			z: -boxHeight,
		...
		boxWallTop = bannerboy.createElement({backgroundColor: "#0099ba", width: boxWidth, height: boxHeight * 0.9, top: -boxHeight * 0.89,
			rotationX: 0,
			rotationZ: 0,
			transformOrigin: "center bottom",
		...
		product = bannerboy.createElement({backgroundImage: productAsset, left: productLeft, top: productTop, parent: boxInner});

		boxWallFront = bannerboy.createElement({backgroundColor: "#0099ba", width: boxWidth, height: boxHeight,
			rotationX: 0,
			rotationZ: 0,
			transformOrigin: "center bottom",
		...
		logo = bannerboy.createElement({backgroundImage: logoAsset, retina: true, parent: boxWallFront});
