...
bannerboy.main = function() {
	...
	var width = 300;
	var height = 250;
	var banner = bannerboy.createElement({id: "banner", width: width, height: height, backgroundColor: "#f0e9d8", border:"1px solid #da8753", boxSizing: "border-box", overflow: "hidden", cursor: "pointer", parent: document.body});
	...
	bannerboy.preloadImages(images, function(){
		...
		var svg_container = bannerboy.createElement({id: "svg_container", innerHTML: svg.txt_2, width: width, height: height, parent: banner});
		...
		var box = bannerboy.createElement({backgroundImage: "box.png", left: -50, top: 150, retina: true, parent: banner});
		var txt_1 = bannerboy.createElement({left: 24, top: 19, width: 131, height: 121, parent: banner});
			var txt_1_5 = bannerboy.createElement({backgroundImage: "txt_1_5.png", left: 18, top: 109, retina: true, parent: txt_1});
			var txt_1_4 = bannerboy.createElement({backgroundImage: "txt_1_4.png", left: 22, top: 74, retina: true, parent: txt_1});
			var txt_1_3 = bannerboy.createElement({backgroundImage: "txt_1_3.png", left: 10, top: 55, retina: true, parent: txt_1});
			var txt_1_2 = bannerboy.createElement({backgroundImage: "txt_1_2.png", top: 20, retina: true, parent: txt_1});
			var txt_1_1 = bannerboy.createElement({backgroundImage: "txt_1_1.png", left: 26, retina: true, parent: txt_1});
		var wheel_logo = bannerboy.createElement({backgroundImage: "wheel_logo.png", left: 255, top: 111, retina: true, parent: banner});
		var offer_frame = bannerboy.createElement({width: width, height: height, backgroundColor: "#8aba40", left: 176, parent: banner});
		var cta = bannerboy.createElement({backgroundImage: "cta.png", left: 5, top: 182, retina: true, parent: offer_frame});
		var txt_3 = bannerboy.createElement({left: 27, top: 28, width: 74, height: 140, parent: offer_frame});
			var txt_3_2 = bannerboy.createElement({backgroundImage: "txt_3_2.png", top: 105, retina: true, parent: txt_3});
			var txt_3_1 = bannerboy.createElement({left: 4, width: 63, height: 96, parent: txt_3});
				var txt_3_1_1 = bannerboy.createElement({backgroundImage: "txt_3_1_1.png", retina: true, parent: txt_3_1});
				var txt_3_1_2 = bannerboy.createElement({backgroundImage: "txt_3_1_2.png", retina: true, parent: txt_3_1});
				var txt_3_1_3 = bannerboy.createElement({backgroundImage: "txt_3_1_3.png", retina: true, parent: txt_3_1});
				var txt_3_1_4 = bannerboy.createElement({backgroundImage: "txt_3_1_4.png", retina: true, parent: txt_3_1});
		var logo = bannerboy.createElement({backgroundImage: "logo.png", left: 40, top: 155, retina: true, parent: banner});
		var marker = wheel.marker = bannerboy.createElement({backgroundImage: "marker.png", left: 157, top: 124, retina: true, parent: banner});
	...
	function Wheel(parameters, indexes){
		...
		function update(){
			...
			if(current_index != prevIndex) {
				// Marker animation
				var click_speed = bannerboy.utils.clamp(.1 / Math.abs(this.speed), 0, .5);
				this.marker.to(click_speed, {rotation: bannerboy.utils.clamp(-this.speed * 10, 25, 60), overwrite: "concurrent", ease: Power4.easeOut})
