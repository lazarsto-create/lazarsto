...
if (reversed == null) { reversed = false; }
	...
	this.copy2.name = "copy2";
	this.copy2.setTransform(162,50.75);
	...
	this.copy1.name = "copy1";
	this.copy1.setTransform(160,51);
	...
	this.whiteLogo.setTransform(234.2,29.4);
	...
	this.logo.name = "logo";
	this.logo.setTransform(206.85,225.55,0.6192,0.6195,0,0,0,1.4,0.9);
	this.logo.alpha = 0;
	...
	this.promo.setTransform(110.35,135.95,0.4651,0.4651,0,0,0,5,-1.4);
	...
	this.lamp.name = "lamp";
	this.lamp.setTransform(193.4,195.9,0.4685,0.4691,0,0,0,0.2,0.5);
	...
	this.crowbar.setTransform(173.2,133.85,0.117,0.1175,0,0,0,546.7,529.5);

	this.timeline.addTween(cjs.Tween.get(this.crowbar).wait(1));

	// tracks
	this.instance = new lib.tracks();
	this.instance.setTransform(140.65,154.7,0.1246,0.1246,0,0,0,280.9,723.6);
	...
	this.cta.name = "cta";
	this.cta.setTransform(73.8,213.45,0.7538,0.7541,0,0,0,58.1,15.2);
...
p.nominalBounds = new cjs.Rectangle(-14.6,-63.6,408.3,663.6);
// library properties:
lib.properties = {
