...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		var self = this,
			...
			TURK = "#00CAC6",
			special_char = "^",
			CO = { fs: 22, widt: 160, widt2: 230, fs2: 18, xx: 12, yy: 12 },
			LAB = { siz: 70, xx: W - MRG, yy: MRG },
			CTA = { fs: 12, hei: 32, toY: 196, xx: 12, yy: 13, rd: 6 },
	...
	this.logo.name = "logo";
	this.logo.setTransform(253.05,317.5,0.7168,0.7153,0,0,0,76.8,14.8);
...
p.nominalBounds = new cjs.Rectangle(-140,270,448,58);
// library properties:
lib.properties = {
