...
lib.ssMetadata = [
		...
		{name:"index_atlas_NP_1", frames: [[0,0,300,600]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.logo.name = "logo";
	this.logo.setTransform(150.1,37,1.1458,1.1437,0,0,0,48.1,16.6);
	...
	this.copy1_1.setTransform(150,146,1,1,0,0,0,150,125);

	this.copy1_2 = new lib.copy12();
	this.copy1_2.name = "copy1_2";
	this.copy1_2.setTransform(150,146,1,1,0,0,0,150,125);

	this.note2 = new lib.copy13();
	this.note2.name = "note2";
	this.note2.setTransform(39.2,80.4,1,1,0,0,0,39.2,59.4);
	...
	this.copy3_1.setTransform(150,146,1,1,0,0,0,150,125);
	...
	this.over.name = "over";
	this.over.setTransform(70.95,168.45,0.55,0.55,0,0,0,67.2,77.2);
	...
	this.copy2_2.setTransform(136.8,158.8,1,1,0,0,0,136.8,137.8);

	this.copy2_1 = new lib.copy21();
	this.copy2_1.name = "copy2_1";
	this.copy2_1.setTransform(64.2,158.8,1,1,0,0,0,64.2,137.8);
	...
	this.food.name = "food";
	this.food.setTransform(164,456,1,1,0,0,0,126,90);

	this.dish4 = new lib.dish4();
	this.dish4.name = "dish4";
	this.dish4.setTransform(448.2,286.55,1.8347,1.8389,0,0,0,60.6,65);

	this.dish1 = new lib.dish1();
	this.dish1.name = "dish1";
	this.dish1.setTransform(453.15,265,1.7808,1.7848,0,0,0,73.1,65);

	this.dish2 = new lib.dish2();
	this.dish2.name = "dish2";
	this.dish2.setTransform(455.3,281.5,1.8333,1.8333,0,0,0,63.1,63);

	this.dish3 = new lib.dish3_1();
	this.dish3.name = "dish3";
	this.dish3.setTransform(458.25,289.5,2.3762,2.3644,0,0,0,50.6,59);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.dish3},{t:this.dish2},{t:this.dish1},{t:this.dish4},{t:this.food}]}).wait(1));

	// copyright
	this.copyr = new lib.copyright();
	this.copyr.name = "copyr";
	this.copyr.setTransform(86,555);
...
p.nominalBounds = new cjs.Rectangle(150,300,433,300);
// library properties:
lib.properties = {
