...
bannerboy.main = function() {
	...
	var width = 300;
	var height = 250;
	var clickArea = bannerboy.createElement({width: width, height: height, overflow: "hidden", cursor: "pointer", parent: document.body});
	var banner = bannerboy.createElement({width: width, height: height, backgroundColor: "#c8102e", overflow: "hidden", cursor: "pointer", parent:clickArea});
	...
	bannerboy.preloadImages(images, function() {
		...
		// var guide = bannerboy.createElement({backgroundImage:"guide.jpg", opacity:0.5, parent:banner});
		...
		var products = bannerboy.createElement({right:117, bottom:113, width:20, height:20, backgroundColor:"none", parent:banner})
			var drop1 = bannerboy.createElement({backgroundColor: "#edd682", left: 30+20, top: 42, alpha:0, width:2, height:2, borderRadius: 1, parent: products});
			var drop2 = bannerboy.createElement({backgroundColor: "#edd682", left: 26+20, top: 46, alpha:0, width:2, height:2, borderRadius: 1, parent: products});
			var drop3 = bannerboy.createElement({backgroundColor: "#edd682", left: 36+20, top: 44, alpha:0, width:2, height:2, borderRadius: 1, parent: products});
			var bottle = bannerboy.createElement({backgroundImage:"bottle.png", left:66, top:-107, retina:true, parent:products});
			var glassContainer = bannerboy.createElement({left:-16, top:39, parent:products});
				var glassSplash = bannerboy.createElement({backgroundImage:"glassSplash.png", left:48+16, top:35-39, retina:true, parent:glassContainer});
				var glassSplash2 = bannerboy.createElement({backgroundImage:"glassSplash2.png", left:20+16, top:37-39, retina:true, parent:glassContainer});
				var glass = bannerboy.createElement({backgroundImage:"glass.png", retina:true, parent:glassContainer});
			var lime = bannerboy.createElement({backgroundImage:"lime.png", left:0, top:1, retina:true, parent:products});
			//edd682
		...
		// if(bannerboy.scrubber) bannerboy.scrubber({"products":products.tl});
		// return;

		// var flare = bannerboy.createElement({backgroundImage: "flare.png", left: 28, top: 94, alpha:0.7, parent: banner, retina: true});


		var legal = bannerboy.createElement({backgroundImage: "legal.png", left:14, bottom: 4, parent: banner, retina: true});
		// legal.centerHorizontal();

		var txt_3 = bannerboy.createElement({backgroundImage: "txt_3.png", left: 14, top: 43, parent: banner, retina: true});

		var logoCm = bannerboy.createElement({left: 35, top: 155, parent: banner});
			var swordRight = bannerboy.createElement({backgroundImage: "swordRight.png", left: 105-105, top: 113-112, parent: logoCm, retina: true});
			var swordLeft = bannerboy.createElement({backgroundImage: "swordLeft.png", left: 109-105, top: 113-112, parent: logoCm, retina: true});
			var logoCenter = bannerboy.createElement({backgroundImage: "logoCenter.png", left: 136-105, top: 114-112, parent: logoCm, retina: true});

		var logo = bannerboy.createElement({backgroundImage: "logo.png", left: 31, top: 8, parent: banner, retina: true});

		var txt_1_2 = bannerboy.createElement({backgroundImage: "txt_1_2.png", top: 129, parent: banner, retina: true, transformOrigin: "center top"});
		var txt_1_1 = bannerboy.createElement({backgroundImage: "txt_1_1.png", top: 81, parent: banner, retina: true, transformOrigin: "center bottom"});

		var txt_2_2 = bannerboy.createElement({backgroundImage: "txt_2_2.png", top: 129, parent: banner, retina: true, transformOrigin: "center top"});
		var txt_2_1 = bannerboy.createElement({backgroundImage: "txt_2_1.png", top: 81, parent: banner, retina: true, transformOrigin: "center bottom"});

		txt_1_1.centerHorizontal();
		txt_1_2.centerHorizontal();
		txt_2_1.centerHorizontal();
		txt_2_2.centerHorizontal();
		var ctaMask = bannerboy.createElement({width: 100, height: 50, left: 40, top: 190, parent: banner, overflow: "hidden"});
			var cta = bannerboy.createElement({backgroundImage: "cta.png", parent: ctaMask, retina: true});
		...
		// timeline debugger
		// if(bannerboy.scrubber) bannerboy.scrubber({"banner":tl});
