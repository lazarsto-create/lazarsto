...
}).prototype = getMCSymbolPrototype(lib.logo, new cjs.Rectangle(0.1,0.1,60,29.799999999999997), null);
...
(lib.master = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#009900").s().p("A6PV4MAAAgrvMA0fAAAMAAAArvg");
...
}).prototype = getMCSymbolPrototype(lib.master, new cjs.Rectangle(-761,-472,2176,923.6), null);
...
if (reversed == null) { reversed = false; }
	...
	// master
	this.instance = new lib.master();
	this.instance.setTransform(150.1,125,0.8929,0.8929,0,0,0,168.1,140);
...
p.nominalBounds = new cjs.Rectangle(59,-296.4,1204.4,699.5999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/back1.jpg?1655208851600", id:"back1"},
		{src:"images/back2.jpg?1655208851600", id:"back2"},
		{src:"images/Bitmap21.png?1655208851600", id:"Bitmap21"},
		{src:"images/Bitmap22.png?1655208851600", id:"Bitmap22"},
		{src:"images/deviceA.png?1655208851600", id:"deviceA"},
		{src:"images/deviceB.png?1655208851600", id:"deviceB"},
		{src:"images/im1.png?1655208851600", id:"im1"}
	],
	preloads: []
};
