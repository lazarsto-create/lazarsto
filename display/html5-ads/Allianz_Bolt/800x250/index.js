...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[174,438,142,36],[0,437,172,36],[202,400,174,36],[378,400,99,36],[0,399,200,36],[0,361,245,36],[184,246,78,36],[286,0,192,198],[286,200,192,198],[0,0,284,244],[0,246,182,113],[318,438,175,10]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#003781").s().p("AgjAPIAAgeIBHAAIAAAeg");
	this.shape.setTransform(270.95,22.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#003781").s().p("Ag1BAIAHgcQATAKAWAAQAMAAAIgEQAHgEABgIQAAgHgHgDQgGgDgNgEIgYgIQgJgEgIgJQgGgJAAgOQAAgVANgLQAOgLAZAAQANAAAMADQAMADAJAEIgIAcQgRgJgUAAQgLgBgFAEQgHAEAAAGQAAAIAIAEQAGADANAEQAPAEAKAEQAJAFAGAHQAHAIAAAOQAAAWgQAMQgRAMgaAAQgcAAgUgLg");
	this.shape_1.setTransform(260,23.35);
	...
	this.shape_2.setTransform(244.675,25.925);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#003781").s().p("AAhBJIAAhMQAAgUgIgKQgJgKgPAAQgPAAgJAKQgJAKgBATIAABNIgeAAIAAiOIAdAAIAAAWQAGgMANgHQALgGAOAAQAaAAAOAQQAPARAAAeIAABSg");
	this.shape_3.setTransform(228.35,23.175);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#003781").s().p("AgxA5QgPgRAAgeIAAhSIAgAAIAABMQgBAUAJAKQAIAKAQAAQAPAAAJgKQAJgKAAgSIAAhOIAgAAIAACOIgeAAIAAgWQgHANgMAGQgMAGgOAAQgZAAgOgQg");
	this.shape_4.setTransform(211.4,23.475);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#003781").s().p("AgOBRQgLgMAAgVIAAhGIgTAAIAAgeIATAAIAAgiIAegGIAAAoIAmAAIAAAeIgmAAIAABBQAAAVATAAQAIAAAJgEIAEAcQgMAFgPAAQgUAAgMgMg");
	this.shape_5.setTransform(198.125,21.4);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#003781").s().p("Ag1BAIAHgcQASAKAXAAQANAAAHgEQAIgEAAgIQgBgHgFgDQgHgDgNgEIgYgIQgJgEgIgJQgGgJgBgOQAAgVAOgLQAOgLAZAAQANAAAMADQAMADAJAEIgIAcQgQgJgWAAQgJgBgGAEQgHAEABAGQgBAIAIAEQAGADANAEQAPAEAKAEQAIAFAHAHQAHAIAAAOQAAAWgQAMQgQAMgbAAQgcAAgUgLg");
	this.shape_6.setTransform(186.9,23.35);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#003781").s().p("AgPBpIAAiOIAfAAIAACOgAgOhGQgFgGAAgJQAAgIAFgGQAGgFAIAAQAJAAAFAFQAGAGAAAIQAAAJgGAFQgFAGgJAAQgIAAgGgFg");
	this.shape_7.setTransform(177.15,19.975);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#003781").s().p("AgfBCQgRgJgJgRQgKgRAAgXQAAgVAJgRQAIgRAQgJQAPgKATAAQAUAAAPAJQAQAKAIAPQAJARAAAVIgBAMIhnAAQADARAMAKQAMAJASAAQAMAAAMgDQAMgEAJgGIAJAaQgKAIgPAEQgOAEgQAAQgVAAgSgJgAAlgOQgCgPgJgIQgKgJgPAAQgOgBgKAJQgKAJgCAPIBIAAIAAAAg");
	this.shape_8.setTransform(165.675,23.35);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#003781").s().p("Ag7BkIAAjHIAiAAIAACoIBUAAIAAAfg");
	this.shape_9.setTransform(151.5,20.5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#003781").s().p("AgjAPIAAgeIBHAAIAAAeg");
	this.shape_10.setTransform(138.5,22.7);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#003781").s().p("Ag1BAIAHgcQASAKAXAAQAMAAAIgEQAHgEAAgIQAAgHgFgDQgHgDgNgEIgYgIQgKgEgGgJQgIgJABgOQAAgVAOgLQAOgLAYAAQANAAAMADQAMADAJAEIgIAcQgRgJgUAAQgKgBgHAEQgFAEgBAGQABAIAGAEQAHADAOAEQAOAEAJAEQAKAFAGAHQAHAIAAAOQAAAWgQAMQgQAMgbAAQgcAAgUgLg");
	this.shape_11.setTransform(127.55,23.35);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#003781").s().p("AgOBpIAAiOIAdAAIAACOgAgNhGQgGgGAAgJQAAgIAGgGQAFgFAIAAQAJAAAGAFQAFAGAAAIQAAAJgFAFQgGAGgJAAQgIAAgFgFg");
	this.shape_12.setTransform(117.8,19.975);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#003781").s().p("AgfBCQgRgJgJgRQgKgRAAgXQAAgVAJgRQAIgRAQgJQAPgKATAAQAUAAAPAJQAQAKAIAPQAJARAAAVIgBAMIhnAAQADARAMAKQAMAJASAAQAMAAAMgDQAMgEAJgGIAJAaQgKAIgPAEQgOAEgQAAQgVAAgSgJgAAlgOQgCgPgJgIQgKgJgPAAQgOgBgKAJQgKAJgCAPIBIAAIAAAAg");
	this.shape_13.setTransform(106.325,23.35);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#003781").s().p("AgpBJIAAiPIAdAAIAAAZQALgbAZAAQAKAAAIAEIgEAeQgHgCgIAAQgQAAgIAKQgJALAAAUIAABIg");
	this.shape_14.setTransform(93.975,23.225);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#003781").s().p("AhKBkIAAjHIBPAAQAVAAAQAIQAQAIAJAOQAIAOAAATQAAATgIAOQgJAOgQAHQgQAJgVgBIguAAIAABKgAgpgEIAuAAQARAAAKgIQAKgKAAgOQAAgOgKgJQgKgJgRABIguAAg");
	this.shape_15.setTransform(79.275,20.5);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#003781").s().p("AgOBRQgLgMAAgVIAAhGIgTAAIAAgeIATAAIAAgiIAegGIAAAoIAmAAIAAAeIgmAAIAABBQAAAVATAAQAIAAAJgEIAEAcQgMAFgPAAQgUAAgMgMg");
	this.shape_16.setTransform(57.625,21.4);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#003781").s().p("Ag6BIIAAgZIBHhZIhEAAIAAgdIBvAAIAAAZIhHBZIBKAAIAAAdg");
	this.shape_17.setTransform(45.725,23.325);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#003781").s().p("AgOBRQgLgMAAgVIAAhGIgTAAIAAgeIATAAIAAgiIAegGIAAAoIAmAAIAAAeIgmAAIAABBQAAAVATAAQAIAAAJgEIAEAcQgMAFgPAAQgUAAgMgMg");
	this.shape_18.setTransform(33.675,21.4);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#003781").s().p("AgfBCQgRgJgJgRQgKgRAAgXQAAgVAJgRQAIgRAQgJQAPgKATAAQAUAAAPAJQAQAKAIAPQAJARAAAVIgBAMIhnAAQADARAMAKQAMAJASAAQAMAAAMgDQAMgEAJgGIAJAaQgKAIgPAEQgOAEgQAAQgVAAgSgJgAAlgOQgCgPgJgIQgKgJgPAAQgOgBgKAJQgKAJgCAPIBIAAIAAAAg");
	this.shape_19.setTransform(20.875,23.35);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#003781").s().p("AgqBiIAFgfQAKADAJAAQAOAAAHgHQAHgHAAgQIAAiMIAhAAIAACQQAAAcgPAPQgPAOgbAAQgPAAgNgDg");
	this.shape_20.setTransform(6.5,20.625);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.t33, new cjs.Rectangle(0,0,277.8,41.3), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#F86200").s().p("AgOBgQgGgGAAgKQAAgJAGgGQAGgGAIAAQAJAAAGAGQAGAGAAAJQAAAKgGAGQgGAGgJAAQgIAAgGgGgAgMAlIgEiKIAhAAIgDCKg");
	this.shape.setTransform(209.775,20.675);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#F86200").s().p("AAhBJIAAhMQAAgUgIgKQgIgKgQAAQgPAAgJAKQgKAKAAATIAABNIgeAAIAAiOIAdAAIAAAWQAGgMAMgHQAMgGAOAAQAZAAAPAQQAOARABAeIAABSg");
	this.shape_1.setTransform(197.85,23.175);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#F86200").s().p("AgpBJIAAiPIAdAAIAAAZQALgbAZAAQAKAAAIAEIgEAeQgHgCgIAAQgQAAgIAKQgJALAAAUIAABIg");
	this.shape_2.setTransform(184.825,23.225);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F86200").s().p("AgfBCQgRgJgJgRQgKgRAAgXQAAgVAJgRQAIgRAQgJQAPgKATAAQAUAAAPAJQAQAKAIAPQAJARAAAVIgBAMIhnAAQADARAMAKQAMAJASAAQAMAAAMgDQAMgEAJgGIAJAaQgKAIgPAEQgOAEgQAAQgVAAgSgJgAAlgOQgCgPgJgIQgKgJgPAAQgOgBgKAJQgKAJgCAPIBIAAIAAAAg");
	this.shape_3.setTransform(170.675,23.35);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#F86200").s().p("AAhBpIAAhNQAAgUgIgJQgJgKgPAAQgPAAgJAKQgJAJAAATIAABOIggAAIAAjRIAgAAIAABVQAGgKAMgGQAMgFAMAAQAZAAAPAQQAPARAAAdIAABTg");
	this.shape_4.setTransform(154.7,19.975);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#F86200").s().p("AgXBBQgRgIgJgSQgIgRgBgWQABgVAIgRQAJgRARgJQAQgKAUAAQANAAAMADQALAEAJAHIgIAcQgHgGgKgDQgJgDgKAAQgSgBgLAMQgLANAAAUQAAAVALAMQALAMASAAQAKAAAJgDQAKgDAHgGIAIAcQgIAGgMAEQgMAEgNAAQgUAAgQgKg");
	this.shape_5.setTransform(139.7,23.35);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#F86200").s().p("AgOBpIAAiOIAdAAIAACOgAgNhGQgGgGAAgJQAAgIAGgGQAFgFAIAAQAJAAAFAFQAGAGAAAIQAAAJgGAFQgFAGgJAAQgIAAgFgFg");
	this.shape_6.setTransform(129.25,19.975);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#F86200").s().p("Ag1BAIAHgcQATAKAWAAQAMAAAIgEQAHgEAAgIQABgHgHgDQgGgDgNgEIgYgIQgKgEgGgJQgIgJABgOQgBgVAOgLQAOgLAZAAQANAAAMADQAMADAJAEIgIAcQgRgJgUAAQgLgBgFAEQgGAEgBAGQABAIAGAEQAHADANAEQAPAEAJAEQAKAFAGAHQAHAIAAAOQAAAWgQAMQgRAMgaAAQgcAAgUgLg");
	this.shape_7.setTransform(119.35,23.35);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#003781").s().p("AgpBJIAAiPIAdAAIAAAZQALgbAZAAQAKAAAIAEIgEAeQgHgCgIAAQgQAAgIAKQgJALAAAUIAABIg");
	this.shape_8.setTransform(101.975,23.225);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#003781").s().p("AgfBCQgRgJgJgRQgKgRAAgXQAAgVAJgRQAIgRAQgJQAPgKATAAQAUAAAPAJQAQAKAIAPQAJARAAAVIgBAMIhnAAQADARAMAKQAMAJASAAQAMAAAMgDQAMgEAJgGIAJAaQgKAIgPAEQgOAEgQAAQgVAAgSgJgAAlgOQgCgPgJgIQgKgJgPAAQgOgBgKAJQgKAJgCAPIBIAAIAAAAg");
	this.shape_9.setTransform(87.825,23.35);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#003781").s().p("AAhBpIAAhNQAAgUgIgJQgIgKgQAAQgPAAgJAKQgKAJAAATIAABOIgeAAIAAjRIAeAAIAABVQAIgKALgGQAMgFAMAAQAZAAAPAQQAOARAAAdIAABTg");
	this.shape_10.setTransform(71.85,19.975);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#003781").s().p("AgXBBQgRgIgIgSQgJgRAAgWQAAgVAJgRQAIgRARgJQAQgKAUAAQANAAALADQAMAEAKAHIgIAcQgIgGgJgDQgKgDgJAAQgTgBgMAMQgKANgBAUQABAVAKAMQAMAMATAAQAJAAAKgDQAJgDAIgGIAIAcQgKAGgMAEQgLAEgNAAQgUAAgQgKg");
	this.shape_11.setTransform(56.85,23.35);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#003781").s().p("AgnBBQgPgJgIgRQgIgRAAgWQAAgVAIgRQAIgRAPgJQAPgKATAAQAdAAASAZIAAgWIAdAAIAACPIgdAAIAAgWQgSAZgdAAQgTAAgPgKgAgcggQgLANAAATQAAAUALANQALAMASAAQASAAAKgMQALgMAAgVQAAgUgLgMQgKgMgSAAQgSAAgLAMg");
	this.shape_12.setTransform(40.825,23.325);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#003781").s().p("AgpBJIAAiPIAdAAIAAAZQALgbAZAAQAKAAAIAEIgEAeQgHgCgIAAQgQAAgIAKQgJALAAAUIAABIg");
	this.shape_13.setTransform(28.125,23.225);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#003781").s().p("AArBkIhHhWIgYAXIAAA/IghAAIAAjHIAhAAIAABcIBZhcIAsAAIhYBbIBdBsg");
	this.shape_14.setTransform(13,20.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.t32, new cjs.Rectangle(0,0,215.8,41.3), null);
...
}).prototype = getMCSymbolPrototype(lib.t24, new cjs.Rectangle(0,0,99,36), null);
...
}).prototype = getMCSymbolPrototype(lib.t23, new cjs.Rectangle(0,0,200,36), null);
...
}).prototype = getMCSymbolPrototype(lib.t22, new cjs.Rectangle(0,0,245,36), null);
...
}).prototype = getMCSymbolPrototype(lib.t21, new cjs.Rectangle(0,0,78,36), null);
...
}).prototype = getMCSymbolPrototype(lib.t13, new cjs.Rectangle(0,0,174,36), null);
...
}).prototype = getMCSymbolPrototype(lib.t12, new cjs.Rectangle(0,0,172,36), null);
...
}).prototype = getMCSymbolPrototype(lib.t11, new cjs.Rectangle(0,0,142,36), null);
...
}).prototype = getMCSymbolPrototype(lib.mc_shadow, new cjs.Rectangle(0,0,175,10), null);
...
}).prototype = getMCSymbolPrototype(lib.mc_car, new cjs.Rectangle(-91,-57,182,113), null);
...
}).prototype = getMCSymbolPrototype(lib.mc_bolimg, new cjs.Rectangle(0,0,284,244), null);
...
}).prototype = getMCSymbolPrototype(lib.mc_bd2, new cjs.Rectangle(0,0,192,198), null);
...
}).prototype = getMCSymbolPrototype(lib.mc_bd1, new cjs.Rectangle(0,0,192,198), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#003781").s().p("");
	this.shape.setTransform(113.9945,17.3275,0.7599,0.7598);
...
p.nominalBounds = new cjs.Rectangle(0,0,228,34.7);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#F86200").s().p("AiLCWQgUAAAAgUIAAkDQAAgUAUAAIEXAAQAUAAAAAUIAAEDQAAAUgUAAg");
...
}).prototype = getMCSymbolPrototype(lib.ctaBackB, new cjs.Rectangle(0,0,32,30), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#F86200").s().p("ArCLDQklklAAmeQAAmdElklQElklGdAAQGeAAElElQElElAAGdQAAGeklElQklElmeAAQmdAAklklg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.circle_yellow, new cjs.Rectangle(-100,-100,200,200), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#96DCFA").s().p("EgxuAxsQ0l0lAA9HQAA9GUl0oQUo0ldGAAQdHAAUlUlQUoUoAAdGQAAdH0oUlQ0lUo9HAAQ9GAA0o0og");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.circle_white, new cjs.Rectangle(-450,-450,900,900), null);
...
if (reversed == null) { reversed = false; }
	...
	this.t32.name = "t32";
	this.t32.setTransform(0,31.5,1,1,0,0,0,0,0.5);

	this.t33 = new lib.t33();
	this.t33.name = "t33";

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.t33},{t:this.t32}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mc_txt3, new cjs.Rectangle(0,0,277.8,72.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.t24.name = "t24";
	this.t24.setTransform(0,78);

	this.t23 = new lib.t23();
	this.t23.name = "t23";
	this.t23.setTransform(0,52);

	this.t22 = new lib.t22();
	this.t22.name = "t22";
	this.t22.setTransform(0,26.5,1,1,0,0,0,0,0.5);
...
}).prototype = getMCSymbolPrototype(lib.mc_txt2, new cjs.Rectangle(0,0,245,114), null);
...
if (reversed == null) { reversed = false; }
	...
	this.t13.name = "t13";
	this.t13.setTransform(0,52);

	this.t12 = new lib.t12();
	this.t12.name = "t12";
	this.t12.setTransform(0,26.5,1,1,0,0,0,0,0.5);
...
}).prototype = getMCSymbolPrototype(lib.mc_txt1, new cjs.Rectangle(0,0,174,88), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(2100,0);

	this.instance_1 = new lib.gr_line("synched",0);
	this.instance_1.setTransform(1680,0);

	this.instance_2 = new lib.gr_line("synched",0);
	this.instance_2.setTransform(1260,0);

	this.instance_3 = new lib.gr_line("synched",0);
	this.instance_3.setTransform(840,0);

	this.instance_4 = new lib.gr_line("synched",0);
	this.instance_4.setTransform(420,0);

	this.instance_5 = new lib.gr_line("synched",0);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mc_line, new cjs.Rectangle(0,0,2505,15), null);
...
if (reversed == null) { reversed = false; }
	...
	this.phone.setTransform(215,81,0.83,0.83);

	this.num = new lib.mc_number();
	this.num.name = "num";
	this.num.setTransform(214,103,0.83,0.83);
...
}).prototype = getMCSymbolPrototype(lib.mc_boltend, new cjs.Rectangle(0,0,284,244), null);
...
}).prototype = getMCSymbolPrototype(lib.mc_bolt_drive, new cjs.Rectangle(0,0,217,322), null);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("AiLCWQgUAAAAgUIAAkDQAAgUAUAAIEXAAQAUAAAAAUIAAEDQAAAUgUAAg");
	mask.setTransform(16,15);

	// aLeft
	this.aLeft = new lib.arr();
	this.aLeft.name = "aLeft";
	this.aLeft.setTransform(-20,11);
...
}).prototype = getMCSymbolPrototype(lib.ctaB, new cjs.Rectangle(0,0,32,30), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Ap9TUQjJjJg/kDIpWAAMAAAgkBMAu3AAAMAAAAkBInKAAQg/EDjLDJQkkEmmeAAQmdAAkmkmg");
	mask.setTransform(93,47);

	// bolt
	this.boltphone = new lib.mc_boltend();
	this.boltphone.name = "boltphone";
	this.boltphone.setTransform(-46,-43);
	...
	this.l2.name = "l2";
	this.l2.setTransform(38.05,-20,0.07,1,0,0,0,0.7,0);

	this.l1 = new lib.mc_Hammer();
	this.l1.name = "l1";
	this.l1.setTransform(13.05,-20,0.07,1,0,0,0,0.7,0);
	...
	this.circ.name = "circ";
	this.circ.setTransform(100,100);

	this.timeline.addTween(cjs.Tween.get(this.circ).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.mc_circleend, new cjs.Rectangle(-46,-43,284,263), null);


// stage content:
(lib._800x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_0 = function() {
		...
		function animateInCreative_GSAP_TIMELINE() {
			...
			/////frame_1
			tl.to(self.line, {duration:0.5, x:-850, ease:"expo.out"}, d);
			tl.from([self.bd, self.shadow], {duration:1.0, x:"+=600", ease:"expo.out"}, d);
			tl.from(self.txt1.children, {duration:1.0, x:"-=500", ease:"expo.out", stagger:0.1}, d);
			tl.from(self.rects.children, {duration:1.0, x:"-=750", ease:"expo.out", stagger:0.1}, d);
			
			d += 0.25;
			tl.to(self.line, {duration:7.0, x:1000, ease:"none"}, d);
			
			d += 0.25;
			tl.to([self.cta, self.ctaB], {x:25}, d);
			tl.from(self.logo, {duration:0.5, x:1000, ease:"expo.out"}, d);
		
			tl.to(self.bd, {duration:0.3, y:"-=10", ease:"sine.inOut", repeat:30, yoyo:true}, d);//repeatDelay:0.4,
			tl.to(self.shadow, {duration:0.3, scale:1.3, ease:"sine.inOut", repeat:30, yoyo:true}, d);
		
			d += 2.0;
			tl.to(self.txt1, {duration:0.5, x:"-=500", ease:"expo.in"}, d);
		
			d += 0.3;
			tl.from(self.award,1, {scale:0.75, alpha:0}, d);
			tl.from([self.award.st1, self.award.st2], 1,{scaleY:0, ease:"circ", stagger:0.2}, d+0.1);
			tl.from(self.txt2.children, {duration:1.0, x:"-=500", ease:"expo.out", stagger:0.1}, d);
			...
			d += 0.25;
			tl.to(self.txt2, {duration:1.0, x:"-=500", ease:"expo.in"}, d);
			tl.to([self.bd, self.shadow], {duration:1.0, x:"-=600", ease:"expo.in"}, d);
			tl.to(self.rects.children, {duration:1.0, x:"+=1000", ease:"expo.in", stagger:0.1}, d);
		    tl.to(self.award, 1,{x:"+=400", ease:"expo.in"}, d);
			d += 1.0;
			tl.from(self.txt3.children, {duration:1.0, x:"-=500", ease:"expo.out", stagger:0.1}, d);
			...
			d += 0.25;
			tl.from(self.circleY.l1, {duration:1.0, scaleX:1, x:"+=700", ease:"power4.out"}, d);
			tl.from(self.circleY.l2, {duration:1.0, scaleX:1, x:"+=700", ease:"power4.out"}, d+0.2);
		
			d += 0.25;
			tl.from(self.circleY.boltphone, {duration:1.0, y:"+=300", ease:"power4.out"}, d);
		
			d += 0.3;
			tl.from(self.car, {duration:1.0, x:300, y:300, scale:0, ease:"sine.inOut"}, d);
			...
			d += 0.6;
			//tl.from(self.award, {duration:1.0, x:1000, ease:"expo.out"}, d);
		
			tl.set(self.cta, {y:195}, d);
			tl.set(self.ctaB, {y:395}, d);
			...
			d += 0.5;
			//tl.from(self.txt4.children, {duration:1.0, x:"-=500", ease:"expo.out", stagger:0.1}, d);
		...
		self.txt1.t11.cache(0, 0, 400, 50, cacheScale);
		self.txt1.t12.cache(0, 0, 400, 50, cacheScale);
		self.txt1.t13.cache(0, 0, 400, 50, cacheScale);
		self.txt2.t21.cache(0, 0, 400, 50, cacheScale);
		self.txt2.t22.cache(0, 0, 400, 50, cacheScale);
		self.txt2.t23.cache(0, 0, 400, 50, cacheScale);
		self.txt2.t24.cache(0, 0, 400, 50, cacheScale);
		self.txt3.t32.cache(0, 0, 400, 50, cacheScale);
		self.txt3.t33.cache(0, 0, 400, 50, cacheScale);
		//self.txt4.t41.cache(0, 0, 400, 50, cacheScale);
		//self.txt4.t42.cache(0, 0, 400, 50, cacheScale);
	...
	this.cta.name = "cta";
	this.cta.setTransform(-75,395);

	this.ctaB = new lib.ctaB();
	this.ctaB.name = "ctaB";
	this.ctaB.setTransform(-75,195);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.ctaB},{t:this.cta}]}).wait(1));

	// logo
	this.logo = new lib.logo1();
	this.logo.name = "logo";
	this.logo.setTransform(546,197);
	...
	this.txt3.name = "txt3";
	this.txt3.setTransform(22.5,21.9,1,1,0,0,0,-0.5,-0.1);
	...
	this.award.setTransform(460,184.95,0.7272,0.7272);
	...
	this.car.name = "car";
	this.car.setTransform(367,204.5,1,1,0,0,0,0,0.5);
	...
	this.circleY.setTransform(300.1,25.2,1,1,0,0,0,0.1,0.2);
	...
	this.circleW.setTransform(400,125);
	...
	this.txt2.name = "txt2";
	this.txt2.setTransform(22.5,22.9,1,1,0,0,0,-0.5,-0.1);
	...
	this.txt1.name = "txt1";
	this.txt1.setTransform(22.5,22.9,1,1,0,0,0,-0.5,-0.1);
	...
	this.bd.name = "bd";
	this.bd.setTransform(449,202,1,1,0,0,0,157,162);
	...
	this.shadow.setTransform(441,235,1,1,0,0,0,88,5);
	...
	this.rects.setTransform(400.6,124.6,0.83,0.83,0,0,0,120,120);
	...
	this.line.name = "line";
	this.line.setTransform(-1850,236,0.7333,0.7333);

	this.timeline.addTween(cjs.Tween.get(this.line).wait(1));

	// bg
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FDD25C").s().p("Eg+fATiMAAAgnDMB8/AAAMAAAAnDg");
...
p.nominalBounds = new cjs.Rectangle(-1450,-200,2300,775);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/index_atlas_1.png?1648728307217", id:"index_atlas_1"}
	],
	preloads: []
};
