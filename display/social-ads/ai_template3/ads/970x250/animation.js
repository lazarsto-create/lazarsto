...
(async function loadFeedAndImages(){
  try{
    ...
    const gap = 970; // Gap between slides
    ...
    // Set carousel width to fit all slides
...
function updateAdUrl(){
  ...
  if(adClickArea && selectedItems[currentIndex]) {
    ...
    mediaContainer.addEventListener('touchstart', dragStart);
    ...
    // Initial slide in animation for the whole ad
